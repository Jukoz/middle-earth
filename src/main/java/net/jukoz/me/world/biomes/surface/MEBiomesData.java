...
public class MEBiomesData {
    ...
    // Expansion weights
    private static byte[] RIVER_WEIGHT = {2, 3};
    private static byte[] OCEAN_WEIGHT = {2, 4};
    private static byte[] LAND_WEIGHT = {1, 6};
    private static byte[] EDGE_WEIGHT = {1, 6};
    ...
    public static void loadBiomes() {
        ...
        addBiome(new Color(200, 209, 255), new MEBiome(90, MEBiomeKeys.BLUE_MOUNTAINS, LAND_WEIGHT, MOUNTAIN_NOISE_MODIFIER, MOUNTAIN_HEIGHT_MODIFIER, StoneBlockSets.GONLUIN.base(), StoneBlockSets.GONLUIN.base(), StoneBlockSets.GONLUIN.base(), Blocks.STONE));
        addBiome(new Color(178, 183, 210), new MEBiome(45, MEBiomeKeys.BLUE_MOUNTAINS_FOOTHILLS, EDGE_WEIGHT, MOUNTAIN_NOISE_MODIFIER, MOUNTAIN_HEIGHT_MODIFIER, StoneBlockSets.GONLUIN.base(), StoneBlockSets.GONLUIN.base(), StoneBlockSets.GONLUIN.base(), Blocks.STONE));
        ...
        addBiome(new Color(132, 137, 124), new MEBiome(35, MEBiomeKeys.DUNLAND_FOOTHILLS, EDGE_WEIGHT, FOOTHILL_NOISE_MODIFIER, FOOTHILL_HEIGHT_MODIFIER, Blocks.STONE, Blocks.STONE, Blocks.STONE));
        ...
        addBiome(new Color(185, 185, 187), new MEBiome(52, MEBiomeKeys.LONELY_MOUNTAIN_BASE, LAND_WEIGHT, MOUNTAIN_NOISE_MODIFIER, MOUNTAIN_HEIGHT_MODIFIER, Blocks.STONE, Blocks.STONE, Blocks.STONE));
        addBiome(new Color(168, 168, 170), new MEBiome(70, MEBiomeKeys.LONELY_MOUNTAIN, LAND_WEIGHT, MOUNTAIN_NOISE_MODIFIER, MOUNTAIN_HEIGHT_MODIFIER, Blocks.STONE, Blocks.STONE, Blocks.STONE));
        addBiome(new Color(151, 151, 153), new MEBiome(94, MEBiomeKeys.LONELY_MOUNTAIN_PEAKS, LAND_WEIGHT, MOUNTAIN_PEAKS_NOISE_MODIFIER, MOUNTAIN_PEAKS_HEIGHT_MODIFIER, Blocks.STONE, Blocks.STONE, Blocks.STONE));
        ...
        addBiome(new Color(156, 187, 94), new MEBiome(35, MEBiomeKeys.HILLS_OF_ELVENDIM, LAND_WEIGHT,FOOTHILL_NOISE_MODIFIER, FOOTHILL_HEIGHT_MODIFIER, Blocks.GRASS_BLOCK, Blocks.STONE, Blocks.STONE));
        ...
        addBiome(new Color(189, 170, 168), new MEBiome(35, MEBiomeKeys.IRON_HILLS_BASE, LAND_WEIGHT, MOUNTAIN_NOISE_MODIFIER, MOUNTAIN_HEIGHT_MODIFIER, Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.STONE));
        addBiome(new Color(174, 144, 141), new MEBiome(50, MEBiomeKeys.IRON_HILLS, LAND_WEIGHT, MOUNTAIN_NOISE_MODIFIER, MOUNTAIN_HEIGHT_MODIFIER, Blocks.STONE, Blocks.STONE, Blocks.STONE));
        addBiome(new Color(173, 130, 127), new MEBiome(80, MEBiomeKeys.IRON_HILLS_PEAKS, LAND_WEIGHT, MOUNTAIN_NOISE_MODIFIER, MOUNTAIN_PEAKS_HEIGHT_MODIFIER, Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.STONE));
        ...
        addBiome(new Color(74, 107, 78), new MEBiome(24, MEBiomeKeys.MIRKWOOD_FOOTHILLS, EDGE_WEIGHT, FOOTHILL_NOISE_MODIFIER, FOOTHILL_HEIGHT_MODIFIER, Blocks.GRASS_BLOCK, Blocks.DIRT, Blocks.STONE));
        addBiome(new Color(76, 85, 77), new MEBiome(42, MEBiomeKeys.MIRKWOOD_MOUNTAINS, LAND_WEIGHT, MOUNTAIN_NOISE_MODIFIER, MOUNTAIN_HEIGHT_MODIFIER, Blocks.STONE, Blocks.STONE, Blocks.STONE));
        addBiome(new Color(129, 131, 125), new MEBiome(48, MEBiomeKeys.MISTY_FOOTHILLS, EDGE_WEIGHT, FOOTHILL_NOISE_MODIFIER, FOOTHILL_HEIGHT_MODIFIER, Blocks.STONE, Blocks.STONE, Blocks.STONE, CaveType.MISTIES));
        addBiome(new Color(121, 121, 121), new MEBiome(90, MEBiomeKeys.MISTY_MOUNTAINS, LAND_WEIGHT, MOUNTAIN_NOISE_MODIFIER, MOUNTAIN_HEIGHT_MODIFIER, Blocks.SNOW_BLOCK, Blocks.STONE, Blocks.STONE, CaveType.MISTIES));
        ...
        addBiome(new Color(47, 42, 42), new MEBiome(30, MEBiomeKeys.MORDOR_MOUNTAINS_FOOTHILLS, EDGE_WEIGHT, FOOTHILL_NOISE_MODIFIER, FOOTHILL_HEIGHT_MODIFIER, StoneBlockSets.ASHEN_STONE.base(), StoneBlockSets.ASHEN_STONE.base(), StoneBlockSets.ASHEN_STONE.base(), CaveType.ASHEN));
        ...
        addBiome(new Color(76, 202, 95), new MEBiome(5, MEBiomeKeys.RIVENDELL, LAND_WEIGHT, FOOTHILL_NOISE_MODIFIER, FOOTHILL_HEIGHT_MODIFIER, Blocks.GRASS_BLOCK, Blocks.DIRT, StoneBlockSets.LIMESTONE.base(), Blocks.STONE));
        addBiome(new Color(137, 171, 142), new MEBiome(31, MEBiomeKeys.RIVENDELL_FOOTHILLS, EDGE_WEIGHT, FOOTHILL_NOISE_MODIFIER, FOOTHILL_HEIGHT_MODIFIER, Blocks.STONE, Blocks.STONE, Blocks.STONE));
