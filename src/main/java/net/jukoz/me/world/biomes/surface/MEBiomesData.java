...
public class MEBiomesData {
    ...
    public static void loadBiomes() {
        ...
        oceanCoast = new MEBiome(-9, MEBiomeKeys.OCEAN_COAST, MEBiomeDataConfigs.oceanModifier, MEBiomeDataConfigs.ocean, MEBiomeDataConfigs.stoneLayers);
        // Ponds
        ...
        pond = new MEBiome(-10, MEBiomeKeys.POND, MEBiomeDataConfigs.riverModifier, MEBiomeDataConfigs.pond, MEBiomeDataConfigs.stoneLayers);
        mirkwoodSwamp = new MEBiome(-10, MEBiomeKeys.MIRKWOOD_SWAMP, MEBiomeDataConfigs.riverModifier, MEBiomeDataConfigs.mud, MEBiomeDataConfigs.stoneLayers);
        ...
        addBiome(new Color(72, 109, 114), new MEBiome(-7, MEBiomeKeys.MORGUL_RIVER, MEBiomeDataConfigs.riverModifier, MEBiomeDataConfigs.ashenDirt, MEBiomeDataConfigs.ashenStoneLayers));
        ...
        // Land Biomes :
        addBiome(new Color(156, 207, 113), new MEBiome(5, MEBiomeKeys.ANDUIN_VALES, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.stoneLayers));
        addBiome(new Color(133, 178, 95), new MEBiome(6, MEBiomeKeys.ANDUIN_VALES_FOREST, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.stoneLayers));
        addBiome(new Color(111, 191, 101), new MEBiome(0, MEBiomeKeys.ANORIEN_RIVERSIDE, MEBiomeDataConfigs.plainsModifier.heightModifier(0.98f).noiseModifier(0.1f), MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.gondorLayers));
        ...
        addBiome(new Color(108, 214, 157), new MEBiome(5, MEBiomeKeys.BELERIAND_ISLAND, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.stoneLayers));
        ...
        addBiome(new Color(65, 148, 60), new MEBiome(4, MEBiomeKeys.BLACKROOT_VALE, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.gondorLayers));
        ...
        addBiome(new Color(180, 136, 119), new MEBiome(56, MEBiomeKeys.CARADHRAS_BASE, MEBiomeDataConfigs.mountainModifier.heightModifier(0.24f).noiseModifier(1.21f), MEBiomeDataConfigs.caradhras, MEBiomeDataConfigs.mistyMountainsLayers, CaveType.MISTIES));
        addBiome(new Color(206, 156, 138), new MEBiome(79, MEBiomeKeys.CARADHRAS, MEBiomeDataConfigs.mountainModifier.heightModifier(0.34f), MEBiomeDataConfigs.caradhras, MEBiomeDataConfigs.mistyMountainsLayers, CaveType.MISTIES));
        addBiome(new Color(237, 179, 158), new MEBiome(106, MEBiomeKeys.CARADHRAS_PEAKS, MEBiomeDataConfigs.mountainModifier.heightModifier(0.39f), MEBiomeDataConfigs.caradhrasPeaks, MEBiomeDataConfigs.mistyMountainsLayers, CaveType.MISTIES));
        addBiome(new Color(180, 173, 178), new MEBiome(54, MEBiomeKeys.CELEBDIL_BASE, MEBiomeDataConfigs.mountainModifier.heightModifier(0.24f).noiseModifier(1.21f), MEBiomeDataConfigs.celebdil, MEBiomeDataConfigs.mistyMountainsLayers, CaveType.MISTIES));
        addBiome(new Color(189, 185, 189), new MEBiome(78, MEBiomeKeys.CELEBDIL, MEBiomeDataConfigs.mountainModifier.heightModifier(0.34f), MEBiomeDataConfigs.celebdil, MEBiomeDataConfigs.mistyMountainsLayers, CaveType.MISTIES));
        addBiome(new Color(205, 205, 205), new MEBiome(104, MEBiomeKeys.CELEBDIL_PEAKS, MEBiomeDataConfigs.mountainModifier.heightModifier(0.39f), MEBiomeDataConfigs.celebdilPeaks, MEBiomeDataConfigs.mistyMountainsLayers, CaveType.MISTIES));
        ...
        addBiome(new Color(166, 151, 130), new MEBiome(51, MEBiomeKeys.FANUIDHOL_BASE, MEBiomeDataConfigs.mountainModifier.heightModifier(0.24f).noiseModifier(1.21f), MEBiomeDataConfigs.fanuidhol, MEBiomeDataConfigs.mistyMountainsLayers, CaveType.MISTIES));
        addBiome(new Color(176, 162, 136), new MEBiome(78, MEBiomeKeys.FANUIDHOL, MEBiomeDataConfigs.mountainModifier.heightModifier(0.34f), MEBiomeDataConfigs.fanuidhol, MEBiomeDataConfigs.mistyMountainsLayers, CaveType.MISTIES));
        addBiome(new Color(196, 180, 153), new MEBiome(102, MEBiomeKeys.FANUIDHOL_PEAKS, MEBiomeDataConfigs.mountainModifier.heightModifier(0.39f), MEBiomeDataConfigs.fanuidholPeaks, MEBiomeDataConfigs.mistyMountainsLayers, CaveType.MISTIES));
        ...
        addBiome(new Color(74, 213, 138), new MEBiome(30, MEBiomeKeys.GULF_OF_LHUN_CLIFFS, MEBiomeDataConfigs.landModifier.heightModifier(0.76f), MEBiomeDataConfigs.grassPlains , MEBiomeDataConfigs.limeStoneLayers));
        addBiome(new Color(222, 227, 191), new MEBiome(0, MEBiomeKeys.GULF_OF_LHUN_SHORES, MEBiomeDataConfigs.landModifier.heightModifier(0.97f).heightModifier(0.1f).noiseModifier(0.05f), MEBiomeDataConfigs.gulfOfLhunShoresLayers, MEBiomeDataConfigs.limeStoneLayers));
        ...
        addBiome(new Color(127, 214, 101), new MEBiome(0, MEBiomeKeys.LEBENNIN_SHORES, MEBiomeDataConfigs.plainsModifier.heightModifier(0.98f).noiseModifier(0.1f), MEBiomeDataConfigs.sandShores, MEBiomeDataConfigs.gondorLayers));
        ...
        addBiome(new Color(72, 196, 64), new MEBiome(4, MEBiomeKeys.LOSSARNACH, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.gondorLayers));
        addBiome(new Color(107, 195, 92), new MEBiome(7, MEBiomeKeys.LOSSARNACH_VALLEY, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.gondorLayers));
        ...
        addBiome(new Color(26, 23, 23), new MEBiome(93, MEBiomeKeys.MORDOR_MOUNTAINS_PEAKS, MEBiomeDataConfigs.mordorMountainModifier.heightModifier(0.38f), MEBiomeDataConfigs.mordorMountainsPeaks, MEBiomeDataConfigs.ashenStoneLayers, CaveType.ASHEN));
        ...
        addBiome(new Color(45, 58, 44), new MEBiome(3, MEBiomeKeys.MORGUL_VALE, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.mordorGrass, MEBiomeDataConfigs.ashenStoneLayers, CaveType.ASHEN));
        ...
        addBiome(new Color(177, 188, 154), new MEBiome(41, MEBiomeKeys.NORTH_DOWNS, MEBiomeDataConfigs.foothillModifier.noiseModifier(1.8f), MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.stoneLayers));
        ...
        addBiome(new Color(73, 82, 53), new MEBiome(6, MEBiomeKeys.OLD_ANGMAR, MEBiomeDataConfigs.landModifier.noiseModifier(0.6f), MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.stoneLayers));
        addBiome(new Color(77, 87, 54), new MEBiome(7, MEBiomeKeys.OLD_ANGMAR_FOREST, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.stoneLayers));
        addBiome(new Color(83, 93, 64), new MEBiome(17, MEBiomeKeys.OLD_ANGMAR_COLD_HILL, MEBiomeDataConfigs.landModifier.noiseModifier(0.5f), MEBiomeDataConfigs.greyMountains, MEBiomeDataConfigs.stoneLayers));
        addBiome(new Color(106, 114, 89), new MEBiome(25, MEBiomeKeys.OLD_ANGMAR_FROZEN_HILL, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.greyMountains, MEBiomeDataConfigs.stoneLayers));
        ...
        addBiome(new Color(164, 196, 102), new MEBiome(5, MEBiomeKeys.OLD_ARTHEDAIN_FOREST, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.stoneLayers));
        ...
        addBiome(new Color(97, 115, 60), new MEBiome(6, MEBiomeKeys.OLD_RHUDAUR_FOREST, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.stoneLayers));
        addBiome(new Color(113, 131, 77), new MEBiome(28, MEBiomeKeys.OLD_RHUDAUR_HILL, MEBiomeDataConfigs.landModifier, MEBiomeDataConfigs.stoneHills, MEBiomeDataConfigs.stoneLayers));
        ...
        addBiome(new Color(39, 37, 37), new MEBiome(71, MEBiomeKeys.SOUTHERN_EPHEL_DUATH, MEBiomeDataConfigs.mordorMountainModifier, MEBiomeDataConfigs.southernMordorMountainsPeaks, MEBiomeDataConfigs.ashenStoneLayers, CaveType.ASHEN));
        ...
        addBiome(new Color(28, 26, 26), new MEBiome(91, MEBiomeKeys.SOUTHERN_EPHEL_DUATH_PEAKS, MEBiomeDataConfigs.mordorMountainModifier.heightModifier(0.38f), MEBiomeDataConfigs.southernMordorMountainsPeaks, MEBiomeDataConfigs.ashenStoneLayers, CaveType.ASHEN));
        ...
        addBiome(new Color(168, 215, 163), new MEBiome(33, MEBiomeKeys.THE_WHITE_DOWNS, MEBiomeDataConfigs.foothillModifier.noiseModifier(1.3f), MEBiomeDataConfigs.grassPlains, MEBiomeDataConfigs.stoneLayers));
        ...
        addBiome(new Color(198, 237, 192), new MEBiome(47, MEBiomeKeys.WHITE_MOUNTAINS_BASE, MEBiomeDataConfigs.mountainModifier.noiseModifier(0.9f).heightModifier(0.27f), MEBiomeDataConfigs.whiteMountains, MEBiomeDataConfigs.gondorLayers));
        addBiome(new Color(219, 245, 215), new MEBiome(68, MEBiomeKeys.WHITE_MOUNTAINS, MEBiomeDataConfigs.mountainModifier.noiseModifier(1.05f).heightModifier(0.46f), MEBiomeDataConfigs.whiteMountains, MEBiomeDataConfigs.gondorLayers));
        addBiome(new Color(242, 255, 240), new MEBiome(89, MEBiomeKeys.WHITE_MOUNTAINS_PEAKS, MEBiomeDataConfigs.mountainModifier.heightModifier(0.57f), MEBiomeDataConfigs.whitePeaks, MEBiomeDataConfigs.gondorLayers));
