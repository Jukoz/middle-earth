    ...
    public MiddleEarthChunkGenerator(RegistryEntryLookup<Biome> biomeRegistry) {
        super(new ModBiomeSource(
                new ArrayList<>(Arrays.asList(
                    ...
                    biomeRegistry.getOrThrow(MEBiomeKeys.FALLS_OF_RAUROS_PEAKS),
                    ...
                    biomeRegistry.getOrThrow(MEBiomeKeys.NORTHERN_BROWN_LANDS),
                    biomeRegistry.getOrThrow(MEBiomeKeys.NORTHERN_DUNLAND),
                    biomeRegistry.getOrThrow(MEBiomeKeys.NORTHERN_FANGORN),
                    ...
                    biomeRegistry.getOrThrow(MEBiomeKeys.THE_NORTHERN_WOLD),
