    ...
    public MiddleEarthChunkGenerator(RegistryEntryLookup<Biome> biomeRegistry) {
        super(new ModBiomeSource(
                new ArrayList<>(Arrays.asList(
                    ...
                    biomeRegistry.getOrThrow(MEBiomeKeys.EREBOR),
                    biomeRegistry.getOrThrow(MEBiomeKeys.EREBOR_FOOTHILLS),
                    biomeRegistry.getOrThrow(MEBiomeKeys.EREBOR_PEAKS),
                    ...
                    biomeRegistry.getOrThrow(MEBiomeKeys.MISTY_FOOTHILLS),
                    ...
                    biomeRegistry.getOrThrow(MEBiomeKeys.WHITE_MOUNTAINS_FOOTHILLS),
