...
public class CavesPlacedFeatures {
    ...
    public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
        ...
        PlacedFeatures.register(featureRegisterable, ORE_GOLD, goldOre, modifiersWithCount(3, HeightRangePlacementModifier.trapezoid(YOffset.fixed(-44), YOffset.fixed(-20))));
