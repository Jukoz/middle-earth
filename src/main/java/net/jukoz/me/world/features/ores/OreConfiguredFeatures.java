...
public class OreConfiguredFeatures {
    ...
    public static final RegistryKey<ConfiguredFeature<?, ?>> MIRKWOOD_PODZOL_ORE = registerKey("mirkwood_podzol_disk");
    public static final RegistryKey<ConfiguredFeature<?, ?>> MUD_ORE = registerKey("mud_disk");
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        ConfiguredFeatures.register(featureRegisterable, MIRKWOOD_PODZOL_ORE, Feature.ORE,
                new OreFeatureConfig(grassTest, ModNatureBlocks.MIRKWOOD_PODZOL.getDefaultState(), 64, 0.4f));
