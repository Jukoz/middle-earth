...
import net.jukoz.me.entity.humanoid_npc.HumanoidNpcEntity;
...
public class ShireHobbitNpcEntity extends HumanoidNpcEntity implements RangedAttackMob {
    private static float FLEE_DISTANCE = 8f;
    private static float FLEE_SPEED_MIN = 0.8f;
    private static float FLEE_SPEED_MAX = 1.2f;

    public ShireHobbitNpcEntity(EntityType<? extends HumanoidNpcEntity> entityType, World world) {
    ...
    protected void pushWorldProfiler(){
        this.getWorld().getProfiler().push("hobbitNpcBrain");
    }
