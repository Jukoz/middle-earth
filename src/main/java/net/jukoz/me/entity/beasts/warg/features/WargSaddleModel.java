...
public class WargSaddleModel extends SinglePartEntityModel<WargEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData saddle = body.addChild("saddle", ModelPartBuilder.create(), ModelTransform.pivot(1.0F, -4.0F, -4.0F));

        ModelPartData mat_r1 = saddle.addChild("mat_r1", ModelPartBuilder.create().uv(0, 68).cuboid(-2.5F, -1.2F, -6.0F, 9.0F, 16.0F, 12.0F, new Dilation(0.3F))
