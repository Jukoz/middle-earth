...
public class HillTrollModel extends SinglePartEntityModel<HillTrollEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData Nose_r1 = head.addChild("Nose_r1", ModelPartBuilder.create().uv(62, 0).cuboid(-2.5F, -1.5F, -3.0F, 5.0F, 5.0F, 4.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, -3.1306F, -4.7491F, -0.3054F, 0.0F, 0.0F));
        ...
        ModelPartData hair_r1 = hair.addChild("hair_r1", ModelPartBuilder.create().uv(204, 105).cuboid(-6.3F, -22.2272F, -5.9945F, 13.0F, 19.0F, 12.0F, new Dilation(0.1F)), ModelTransform.of(-26.7F, -37.5249F, 16.9945F, 0.5236F, 0.0F, 0.0F));
