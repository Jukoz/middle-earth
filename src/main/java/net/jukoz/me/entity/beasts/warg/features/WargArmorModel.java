...
public WargArmorModel(ModelPart root) {
        ...
        this.head = this.warg.getChild(EntityModelPartNames.BODY).getChild(EntityModelPartNames.HEAD);
        }
        public static TexturedModelData getTexturedModelData() {
                ModelData modelData = new ModelData();
                ModelPartData modelPartData = modelData.getRoot();
                ModelPartData warg = modelPartData.addChild("warg", ModelPartBuilder.create(), ModelTransform.of(-1.0F, 6.0F, -2.0F, 0.0F, 1.5708F, 0.0F));
                ...
                ModelPartData snout = headArmor.addChild("snout", ModelPartBuilder.create().uv(83, 22).cuboid(-6.2076F, 0.1044F, 2.1F, 13.0F, 5.0F, 3.0F, new Dilation(0.1F)), ModelTransform.of(7.3218F, -2.3967F, 3.1F, -3.1416F, 0.0F, 3.1416F));
                ...
                ModelPartData bodyArmor = lowerBody.addChild("bodyArmor", ModelPartBuilder.create(), ModelTransform.pivot(-11.9F, 6.0F, 4.1F));

                ModelPartData cube = bodyArmor.addChild("cube", ModelPartBuilder.create().uv(0, 0).cuboid(-26.8F, -12.0F, -1.9F, 28.0F, 13.0F, 10.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, -3.1416F, 0.0F, 3.1416F));
