...
public class BroadhoofGoatArmorModel extends SinglePartEntityModel<BroadhoofGoatEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head_armor = head.addChild("head_armor", ModelPartBuilder.create(), ModelTransform.pivot(2.0F, 0.0F, -8.0F));

        ModelPartData head_armor_r1 = head_armor.addChild("head_armor_r1", ModelPartBuilder.create().uv(44, 0).cuboid(-5.0F, -7.0F, -1.0F, 6.0F, 7.0F, 11.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, 0.0F, 0.0F, 0.7854F, 0.0F, 0.0F));

        ModelPartData neck_armor_r1 = head_armor.addChild("neck_armor_r1", ModelPartBuilder.create().uv(46, 52).cuboid(-5.0F, -6.0F, -1.0F, 6.0F, 6.0F, 8.0F, new Dilation(0.1F)), ModelTransform.of(0.0F, 2.1213F, 6.364F, 0.7854F, 0.0F, 0.0F));

        ModelPartData body_armor = body.addChild("body_armor", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, -3.0F, -20.0F, 12.0F, 11.0F, 20.0F, new Dilation(0.1F))
                .uv(0, 31).cuboid(-7.0F, -5.0F, -21.0F, 14.0F, 16.0F, 13.0F, new Dilation(0.1F)), ModelTransform.pivot(0.0F, -6.0F, 9.0F));
