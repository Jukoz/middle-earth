...
public class SnailModel extends SinglePartEntityModel<SnailEntity> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData snail = modelPartData.addChild("snail", ModelPartBuilder.create().uv(0, 0).cuboid(-2.0F, -7.0F, -2.0F, 4.0F, 5.0F, 5.0F, new Dilation(0.0F))
				.uv(0, 10).cuboid(-2.0F, -7.0F, -2.0F, 4.0F, 5.0F, 5.0F, new Dilation(0.4F)), ModelTransform.pivot(0.0F, 24.0F, 0.0F));
		...
		ModelPartData body = snail.addChild("body", ModelPartBuilder.create().uv(12, 22).cuboid(-1.0F, -2.0F, -4.0F, 2.0F, 2.0F, 8.0F, new Dilation(0.0F))
				...
				.uv(0, -1).mirrored().cuboid(1.0F, -4.0F, -4.0F, 0.0F, 2.0F, 1.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.pivot(0.0F, 0.0F, 0.0F));
