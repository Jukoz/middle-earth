...
public class MistyUrukEntity extends HostileEntity {
    public MistyUrukEntity(EntityType<? extends HostileEntity> entityType, World world) {
    ...
    public MistyUrukVariant getVariant() {
        return MistyUrukVariant.byId(this.getId());
    }
}
