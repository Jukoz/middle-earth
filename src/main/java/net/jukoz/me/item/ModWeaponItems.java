...
public class ModWeaponItems {
    ...
    public static final Item ANDUIN_BATTLEAXE = registerItemWithModel("anduin_battleaxe",
            new CustomAxeWeaponItem(ModToolMaterials.STEEL, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".anduin"), new Item.Settings().attributeModifiers(AxeItem.createAttributeModifiers(ModToolMaterials.STEEL, BATTLEAXE_DAMAGE, BATTLEAXE_ATTACKS_SPEED))), true);
    public static final Item ANDUIN_POLEARM = registerItemWithModel("anduin_polearm",
            new ReachWeaponItem(ModToolMaterials.STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".anduin"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, BATTLEAXE_DAMAGE, POLEARM_ATTACKS_SPEED))), true);
    public static final Item ANDUIN_SPEAR = registerItemWithModel("anduin_spear",
            new ReachWeaponItem(ModToolMaterials.STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".anduin"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, SPEAR_DAMAGE, SPEAR_ATTACKS_SPEED))), true);
    public static final Item ANDUIN_PIKE = registerItemWithModel("anduin_pike",
            new ReachWeaponItem(ModToolMaterials.STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".anduin"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, PIKE_DAMAGE, PIKE_ATTACKS_SPEED))), true);
    ...
    public static final Item BRONZE_DAGGER = registerItemWithModel("bronze_dagger",
            new ReachWeaponItem(ModToolMaterials.BRONZE, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".generic"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.BRONZE, SWORD_DAMAGE, SWORD_ATTACKS_SPEED))), false);
    public static final Item BRONZE_SPEAR = registerItemWithModel("bronze_spear",
            new ReachWeaponItem(ModToolMaterials.BRONZE, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".generic"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.BRONZE, SWORD_DAMAGE, SWORD_ATTACKS_SPEED))), true);
    public static final Item BRONZE_PIKE = registerItemWithModel("bronze_pike",
            new ReachWeaponItem(ModToolMaterials.BRONZE, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".generic"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.BRONZE, SWORD_DAMAGE, SWORD_ATTACKS_SPEED))), true);
    ...
    public static final Item DALISH_DAGGER = registerItemWithModel("dalish_dagger",
            new ReachWeaponItem(ModToolMaterials.STEEL, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".dale"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, SWORD_DAMAGE, SWORD_ATTACKS_SPEED))), false);
    public static final Item DALISH_POLEARM = registerItemWithModel("dalish_polearm",
            new ReachWeaponItem(ModToolMaterials.STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".dale"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, BATTLEAXE_DAMAGE, POLEARM_ATTACKS_SPEED))), true);
    public static final Item DALISH_SPEAR = registerItemWithModel("dalish_spear",
            new ReachWeaponItem(ModToolMaterials.STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".dale"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, SPEAR_DAMAGE, SPEAR_ATTACKS_SPEED))), true);
    ...
    public static final Item DALISH_PIKE = registerItemWithModel("dalish_pike",
            new ReachWeaponItem(ModToolMaterials.STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".dale"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, PIKE_DAMAGE, PIKE_ATTACKS_SPEED))), true);
    ...
    public static final Item DUNLAND_DAGGER = registerItemWithModel("dunland_dagger",
            new ReachWeaponItem(ModToolMaterials.STEEL, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".dunland"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, DAGGER_DAMAGE, DAGGER_ATTACKS_SPEED))), false);
    public static final Item DUNLAND_SPEAR = registerItemWithModel("dunland_spear",
            new ReachWeaponItem(ModToolMaterials.STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".dunland"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, SPEAR_DAMAGE, SPEAR_ATTACKS_SPEED))), true);
    ...
    public static final Item DUNLAND_PIKE = registerItemWithModel("dunland_pike",
            new ReachWeaponItem(ModToolMaterials.STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".dunland"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, PIKE_DAMAGE, PIKE_ATTACKS_SPEED))), true);
    ...
    public static final Item LONGBEARD_DAGGER = registerItemWithModel("longbeard_dagger",
            new ReachWeaponItem(ModToolMaterials.DWARVEN_STEEL, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".longbeards"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.DWARVEN_STEEL, DAGGER_DAMAGE, DAGGER_ATTACKS_SPEED))), false);
    public static final Item LONGBEARD_BATTLEAXE = registerItemWithModel("longbeard_battleaxe",
            new CustomAxeWeaponItem(ModToolMaterials.DWARVEN_STEEL, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".longbeards"), new Item.Settings().attributeModifiers(AxeItem.createAttributeModifiers(ModToolMaterials.DWARVEN_STEEL, BATTLEAXE_DAMAGE, BATTLEAXE_ATTACKS_SPEED))), true);
    public static final Item LONGBEARD_SPEAR = registerItemWithModel("longbeard_spear",
            new ReachWeaponItem(ModToolMaterials.DWARVEN_STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".longbeards"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.DWARVEN_STEEL, SPEAR_DAMAGE, SPEAR_ATTACKS_SPEED))), true);
    public static final Item LONGBEARD_PIKE = registerItemWithModel("longbeard_pike",
            new ReachWeaponItem(ModToolMaterials.DWARVEN_STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".longbeards"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.DWARVEN_STEEL, PIKE_DAMAGE, PIKE_ATTACKS_SPEED))), true);
    ...
    public static final Item GONDOR_LONGSWORD = registerItemWithModel("gondorian_longsword",
            new ReachWeaponItem(ModToolMaterials.STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".gondor"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, SWORD_DAMAGE, SWORD_ATTACKS_SPEED - 0.2f))), true);
    public static final Item GONDOR_DAGGER = registerItemWithModel("gondorian_dagger",
            new ReachWeaponItem(ModToolMaterials.STEEL, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".gondor"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, DAGGER_DAMAGE, DAGGER_ATTACKS_SPEED))), false);
    public static final Item GONDOR_BATTLEAXE = registerItemWithModel("gondorian_battleaxe",
            new CustomAxeWeaponItem(ModToolMaterials.STEEL, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".gondor"), new Item.Settings().attributeModifiers(AxeItem.createAttributeModifiers(ModToolMaterials.STEEL, BATTLEAXE_DAMAGE, BATTLEAXE_ATTACKS_SPEED))), true);
    public static final Item GONDOR_SPEAR = registerItemWithModel("gondorian_spear",
            new ReachWeaponItem(ModToolMaterials.STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".gondor"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, SPEAR_DAMAGE, SPEAR_ATTACKS_SPEED))), true);
    public static final Item GONDOR_PIKE = registerItemWithModel("gondorian_pike",
            new ReachWeaponItem(ModToolMaterials.STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".gondor"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, PIKE_DAMAGE, PIKE_ATTACKS_SPEED))), true);
    ...
    public static final Item GUNDABAD_DAGGER = registerItemWithModel("gundabad_dagger",
            new ReachWeaponItem(ModToolMaterials.ORC_STEEL, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".misty_orcs"), Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".gundabad"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.ORC_STEEL, DAGGER_DAMAGE, DAGGER_ATTACKS_SPEED))), false);
    public static final Item GUNDABAD_SPEAR = registerItemWithModel("gundabad_spear",
            new ReachWeaponItem(ModToolMaterials.ORC_STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".misty_orcs"), Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".gundabad"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.ORC_STEEL, SPEAR_DAMAGE, SPEAR_ATTACKS_SPEED))), true);
    public static final Item GUNDABAD_BARDICHE = registerItemWithModel("gundabad_bardiche",
            new ReachWeaponItem(ModToolMaterials.ORC_STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".misty_orcs"), Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".gundabad"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.ORC_STEEL, BATTLEAXE_DAMAGE, POLEARM_ATTACKS_SPEED))), true);
    ...
    public static final Item LORIEN_LONGSWORD = registerItemWithModel("lorien_longsword",
            new ReachWeaponItem(ModToolMaterials.ELVEN_STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".lothlorien"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.ELVEN_STEEL, SWORD_DAMAGE, SWORD_ATTACKS_SPEED - 0.2f))), true);
    public static final Item LORIEN_DAGGER = registerItemWithModel("lorien_dagger",
            new ReachWeaponItem(ModToolMaterials.ELVEN_STEEL, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".lothlorien"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.ELVEN_STEEL, DAGGER_DAMAGE, DAGGER_ATTACKS_SPEED))), false);
    public static final Item LORIEN_SPEAR = registerItemWithModel("lorien_spear",
            new ReachWeaponItem(ModToolMaterials.ELVEN_STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".lothlorien"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.ELVEN_STEEL, SPEAR_DAMAGE, SPEAR_ATTACKS_SPEED))), true);
    public static final Item LORIEN_BATTLESTAFF = registerItemWithModel("lorien_battlestaff",
            new ReachWeaponItem(ModToolMaterials.ELVEN_STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".lothlorien"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.ELVEN_STEEL, 0, SPEAR_ATTACKS_SPEED))), true);
    public static final Item LORIEN_PIKE = registerItemWithModel("lorien_pike",
            new ReachWeaponItem(ModToolMaterials.ELVEN_STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".lothlorien"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.ELVEN_STEEL, PIKE_DAMAGE, PIKE_ATTACKS_SPEED))), true);
    ...
    public static final Item MORDOR_ORC_DAGGER = registerItemWithModel("mordor_orc_dagger",
            new ReachWeaponItem(ModToolMaterials.ORC_STEEL, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".mordor"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.ORC_STEEL, DAGGER_DAMAGE, DAGGER_ATTACKS_SPEED))), false);
    ...
    public static final Item ROHIRRIC_LONGSWORD = registerItemWithModel("rohirric_longsword",
            new ReachWeaponItem(ModToolMaterials.STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".rohan"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, SWORD_DAMAGE, SWORD_ATTACKS_SPEED - 0.2f))), true);
    public static final Item ROHIRRIC_DAGGER = registerItemWithModel("rohirric_dagger",
            new ReachWeaponItem(ModToolMaterials.STEEL, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".rohan"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, DAGGER_DAMAGE, DAGGER_ATTACKS_SPEED))), false);
    public static final Item ROHIRRIC_BATTLEAXE = registerItemWithModel("rohirric_battleaxe",
            new CustomAxeWeaponItem(ModToolMaterials.STEEL, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".rohan"), new Item.Settings().attributeModifiers(AxeItem.createAttributeModifiers(ModToolMaterials.STEEL, BATTLEAXE_DAMAGE, BATTLEAXE_ATTACKS_SPEED))), true);
    public static final Item ROHIRRIC_SPEAR = registerItemWithModel("rohirric_spear",
            new ReachWeaponItem(ModToolMaterials.STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".rohan"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, SPEAR_DAMAGE, SPEAR_ATTACKS_SPEED))), true);
    public static final Item ROHIRRIC_PIKE = registerItemWithModel("rohirric_pike",
            new ReachWeaponItem(ModToolMaterials.STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".rohan"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, PIKE_DAMAGE, PIKE_ATTACKS_SPEED))), true);
    ...
    public static final Item UMBAR_DAGGER = registerItemWithModel("umbar_dagger",
            new ReachWeaponItem(ModToolMaterials.STEEL, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".umbar"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, DAGGER_DAMAGE, DAGGER_ATTACKS_SPEED))), false);
    public static final Item UMBAR_MACE = registerItemWithModel("umbar_mace",
            new ReachWeaponItem(ModToolMaterials.STEEL, 5, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".umbar"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, BATTLEAXE_DAMAGE, BATTLEAXE_ATTACKS_SPEED))), false);
    public static final Item UMBAR_SPEAR = registerItemWithModel("umbar_spear",
            new ReachWeaponItem(ModToolMaterials.STEEL, TWO_HAND_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".umbar"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, SPEAR_DAMAGE, SPEAR_ATTACKS_SPEED))), true);
    public static final Item UMBAR_PIKE = registerItemWithModel("umbar_pike",
        new ReachWeaponItem(ModToolMaterials.STEEL, PIKE_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".umbar"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.STEEL, PIKE_DAMAGE, PIKE_ATTACKS_SPEED))), true);
    ...
    public static final Item STING = registerItemWithModel("sting",
            new ReachWeaponItem(ModToolMaterials.ELVEN_STEEL, DAGGER_REACH, new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ModToolMaterials.ELVEN_STEEL, SWORD_DAMAGE, SWORD_ATTACKS_SPEED + 1))), false);

    public static final Item IRON_DAGGER = registerItemWithModel("iron_dagger",
            new ReachWeaponItem(ToolMaterials.IRON, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".generic"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.IRON, DAGGER_DAMAGE , DAGGER_ATTACKS_SPEED -0.1f))), false);
    public static final Item STONE_DAGGER = registerItemWithModel("stone_dagger",
            new ReachWeaponItem(ToolMaterials.STONE, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".generic"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.STONE, DAGGER_DAMAGE, DAGGER_ATTACKS_SPEED))), false);
    public static final Item WOODEN_DAGGER = registerItemWithModel("wooden_dagger",
            new ReachWeaponItem(ToolMaterials.WOOD, DAGGER_REACH, Text.translatable("tooltip." + MiddleEarth.MOD_ID + ".generic"), new Item.Settings().attributeModifiers(SwordItem.createAttributeModifiers(ToolMaterials.WOOD, DAGGER_DAMAGE, DAGGER_ATTACKS_SPEED))), false);
