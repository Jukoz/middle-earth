...
public class ModArmorMaterials {
    ...
    public static final ExtendedArmorMaterial DWARVEN_STEEL_T3 = registerArmor(Tiers.MEDIUM, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, ModResourceItems.KHAZAD_STEEL_INGOT);
    public static final ExtendedArmorMaterial DWARVEN_STEEL_T4 = registerArmor(Tiers.STURDY, SoundEvents.ITEM_ARMOR_EQUIP_IRON, ModResourceItems.KHAZAD_STEEL_INGOT);
    public static final ExtendedArmorMaterial DWARVEN_STEEL_T5 = registerArmor(Tiers.HEAVY, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, ModResourceItems.KHAZAD_STEEL_INGOT);

    public static final ExtendedArmorMaterial ELVEN_STEEL_T3 = registerArmor(Tiers.MEDIUM, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, ModResourceItems.EDHEL_STEEL_INGOT);
    public static final ExtendedArmorMaterial ELVEN_STEEL_T4 = registerArmor(Tiers.STURDY, SoundEvents.ITEM_ARMOR_EQUIP_IRON, ModResourceItems.EDHEL_STEEL_INGOT);
    public static final ExtendedArmorMaterial ELVEN_STEEL_T5 = registerArmor(Tiers.HEAVY, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, ModResourceItems.EDHEL_STEEL_INGOT);

    public static final ExtendedArmorMaterial URUK_STEEL_T3 = registerArmor(Tiers.MEDIUM, SoundEvents.ITEM_ARMOR_EQUIP_CHAIN, ModResourceItems.BURZUM_STEEL_INGOT);
    public static final ExtendedArmorMaterial URUK_STEEL_T4 = registerArmor(Tiers.STURDY, SoundEvents.ITEM_ARMOR_EQUIP_IRON, ModResourceItems.BURZUM_STEEL_INGOT);
    public static final ExtendedArmorMaterial URUK_STEEL_T5 = registerArmor(Tiers.HEAVY, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, ModResourceItems.BURZUM_STEEL_INGOT);
