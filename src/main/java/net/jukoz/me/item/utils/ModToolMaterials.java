...
{
    BRONZE(MiningLevels.STONE, 500, 6.0f, 1.5f, 13, () -> Ingredient.ofItems(ModRessourceItems.BRONZE_INGOT)),
    ...
    MORGUL(MiningLevels.DIAMOND, 666, 7f, 2.5f, 14, () -> Ingredient.ofItems(ModRessourceItems.MORGUL_INGOT)),
