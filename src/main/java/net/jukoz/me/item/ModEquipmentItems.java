...
public class ModEquipmentItems {
    ...
    public static final Item CLOAK_HOOD = registerItem("cloak_hood",
            new CustomHelmetItem(ModArmorMaterials.CLOAK, ArmorItem.Type.HELMET, new Item.Settings(), List.of(CustomHelmetItem.Customizations.HOOD)));
    public static final Item CLOAK = registerItem("cloak",
            new CustomChestplateItem(ModArmorMaterials.CLOAK, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));

    // Tunic cloak
    public static final Item TUNIC_CLOAK = registerItem("tunic_cloak",
            new CustomChestplateItem(ModArmorMaterials.TUNIC_CLOAK, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));

    // Fur cloaks
    public static final Item FUR_CLOAK_HOOD = registerGeneratedItem("fur_cloak_hood",
            new CustomHelmetItem(ModArmorMaterials.FUR_CLOAK, ArmorItem.Type.HELMET, new Item.Settings(),  List.of(CustomHelmetItem.Customizations.HOOD)));
    public static final Item FUR_CLOAK = registerGeneratedItem("fur_cloak",
            new CustomChestplateItem(ModArmorMaterials.FUR_CLOAK, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));

    // Chainmail fur cloaks
    public static final Item CHAINMAIL_FUR_CLOAK = registerGeneratedItem("chainmail_fur_cloak",
            new CustomChestplateItem(ModArmorMaterials.CHAINMAIL_FUR_CLOAK, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item GONDORIAN_MAIL_HELMET = registerGeneratedItem("gondorian_mail_helmet",
            new CustomHelmetItem(ModArmorMaterials.GONDORIAN_MAIL_ARMOR, ArmorItem.Type.HELMET, new Item.Settings()));
    public static final Item GONDORIAN_MAIL_CHESTPLATE = registerGeneratedItem("gondorian_mail_chestplate",
            new CustomChestplateItem(ModArmorMaterials.GONDORIAN_MAIL_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings()));
    public static final Item GONDORIAN_MAIL_LEGGINGS = registerGeneratedItem("gondorian_mail_leggings",
            new CustomLeggingsItem(ModArmorMaterials.GONDORIAN_MAIL_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Settings()));
    public static final Item GONDORIAN_MAIL_BOOTS = registerGeneratedItem("gondorian_mail_boots",
            new CustomBootsItem(ModArmorMaterials.GONDORIAN_MAIL_ARMOR, ArmorItem.Type.BOOTS, new Item.Settings()));

    public static final Item GONDORIAN_REINFORCED_MAIL_HELMET = registerGeneratedItem("gondorian_reinforced_mail_helmet",
            new CustomHelmetItem(ModArmorMaterials.GONDORIAN_REINFORCED_MAIL_ARMOR, ArmorItem.Type.HELMET, new Item.Settings()));
    public static final Item GONDORIAN_REINFORCED_MAIL_CHESTPLATE = registerGeneratedItem("gondorian_reinforced_mail_chestplate",
            new CustomChestplateItem(ModArmorMaterials.GONDORIAN_REINFORCED_MAIL_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings()));
    public static final Item GONDORIAN_REINFORCED_MAIL_LEGGINGS = registerGeneratedItem("gondorian_reinforced_mail_leggings",
            new CustomLeggingsItem(ModArmorMaterials.GONDORIAN_REINFORCED_MAIL_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Settings()));
    public static final Item GONDORIAN_REINFORCED_MAIL_BOOTS = registerGeneratedItem("gondorian_reinforced_mail_boots",
            new CustomBootsItem(ModArmorMaterials.GONDORIAN_REINFORCED_MAIL_ARMOR, ArmorItem.Type.BOOTS, new Item.Settings()));
    ...
    public static final Item GONDORIAN_CITADEL_GUARD_CHESTPLATE = registerGeneratedItem("gondorian_citadel_guard_chestplate",
            new CustomChestplateItem(ModArmorMaterials.GONDORIAN_CITADEL_GUARD_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item GONDORIAN_FOUNTAIN_GUARD_CHESTPLATE = registerGeneratedItem("gondorian_fountain_guard_chestplate",
            new CustomChestplateItem(ModArmorMaterials.GONDORIAN_FOUNTAIN_GUARD_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item ROHIRRIC_MAIL_HELMET = registerGeneratedItem("rohirric_mail_helmet",
            new CustomHelmetItem(ModArmorMaterials.ROHIRRIC_MAIL_ARMOR, ArmorItem.Type.HELMET, new Item.Settings()));
    public static final Item ROHIRRIC_MAIL_CHESTPLATE = registerGeneratedItem("rohirric_mail_chestplate",
            new CustomChestplateItem(ModArmorMaterials.ROHIRRIC_MAIL_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    public static final Item ROHIRRIC_MAIL_LEGGINGS = registerGeneratedItem("rohirric_mail_leggings",
            new CustomLeggingsItem(ModArmorMaterials.ROHIRRIC_MAIL_ARMOR, ArmorItem.Type.LEGGINGS, new Item.Settings()));
    public static final Item ROHIRRIC_MAIL_BOOTS = registerGeneratedItem("rohirric_mail_boots",
            new CustomBootsItem(ModArmorMaterials.ROHIRRIC_MAIL_ARMOR, ArmorItem.Type.BOOTS, new Item.Settings()));
    ...
    public static final Item ROHIRRIC_SCALE_CHESTPLATE = registerGeneratedItem("rohirric_scale_chestplate",
            new CustomChestplateItem(ModArmorMaterials.ROHIRRIC_SCALE_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item ROHIRRIC_ROYAL_GUARD_CHESTPLATE = registerGeneratedItem("rohirric_royal_guard_chestplate",
            new CustomChestplateItem(ModArmorMaterials.ROHIRRIC_ROYAL_GUARD_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item HORSE_LORD_CHESTPLATE = registerGeneratedItem("horse_lord_chestplate",
            new CustomChestplateItem(ModArmorMaterials.HORSE_LORD_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item DWARVEN_PARTISAN_CHESTPLATE = registerGeneratedItem("dwarven_partisan_chestplate",
            new CustomChestplateItem(ModArmorMaterials.DWARVEN_PARTISAN, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item EREBOR_MAIL_CHESTPLATE = registerGeneratedItem("erebor_mail_chestplate",
            new CustomChestplateItem(ModArmorMaterials.EREBOR_MAIL_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item EREBOR_SCALE_CHESTPLATE = registerGeneratedItem("erebor_scale_chestplate",
            new CustomChestplateItem(ModArmorMaterials.EREBOR_SCALE_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.POUCH)));
    ...
    public static final Item EREBOR_PLATE_CHESTPLATE = registerGeneratedItem("erebor_plate_chestplate",
            new CustomChestplateItem(ModArmorMaterials.EREBOR_PLATE_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.POUCH)));
    ...
    public static final Item EREBOR_COMMANDER_CHESTPLATE = registerGeneratedItem("erebor_commander_chestplate",
            new CustomChestplateItem(ModArmorMaterials.EREBOR_COMMANDER_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item LORIEN_MAIL_HELMET = registerGeneratedItem("lorien_mail_helmet",
            new CustomHelmetItem(ModArmorMaterials.LORIEN_MAIL_ARMOR, ArmorItem.Type.HELMET, new Item.Settings(), List.of(CustomHelmetItem.Customizations.HOOD)));
    public static final Item LORIEN_MAIL_CHESTPLATE = registerGeneratedItem("lorien_mail_chestplate",
            new CustomChestplateItem(ModArmorMaterials.LORIEN_MAIL_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item LORIEN_SCALE_HELMET = registerGeneratedItem("lorien_scale_helmet",
            new CustomHelmetItem(ModArmorMaterials.LORIEN_SCALE_ARMOR, ArmorItem.Type.HELMET, new Item.Settings(), List.of(CustomHelmetItem.Customizations.HOOD)));
    public static final Item LORIEN_SCALE_CHESTPLATE = registerGeneratedItem("lorien_scale_chestplate",
            new CustomChestplateItem(ModArmorMaterials.LORIEN_SCALE_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item LORIEN_PLATE_HELMET = registerGeneratedItem("lorien_plate_helmet",
            new CustomHelmetItem(ModArmorMaterials.LORIEN_PLATE_ARMOR, ArmorItem.Type.HELMET, new Item.Settings(), List.of(CustomHelmetItem.Customizations.HOOD)));
    public static final Item LORIEN_PLATE_CHESTPLATE = registerGeneratedItem("lorien_plate_chestplate",
            new CustomChestplateItem(ModArmorMaterials.LORIEN_PLATE_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item LORIEN_COMMANDER_HELMET = registerGeneratedItem("lorien_commander_helmet",
            new CustomHelmetItem(ModArmorMaterials.LORIEN_COMMANDER_ARMOR, ArmorItem.Type.HELMET, new Item.Settings(), List.of(CustomHelmetItem.Customizations.HOOD)));
    public static final Item LORIEN_COMMANDER_CHESTPLATE = registerGeneratedItem("lorien_commander_chestplate",
            new CustomChestplateItem(ModArmorMaterials.LORIEN_COMMANDER_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item MORDOR_BLACK_URUK_COMMANDER_HELMET = registerGeneratedItem("mordor_black_uruk_commander_helmet",
            new CustomHelmetItem(ModArmorMaterials.MORDOR_BLACK_URUK_PLATE_ARMOR, ArmorItem.Type.HELMET, new Item.Settings(), List.of(CustomHelmetItem.Customizations.SKULL)));
    ...
    public static final Item NAZGUL_CLOAK_HOOD = registerGeneratedItem("nazgul_cloak_hood",
            new CustomHelmetItem(ModArmorMaterials.NAZGUL_CLOAK, ArmorItem.Type.HELMET, new Item.Settings(),List.of(CustomHelmetItem.Customizations.HOOD)));
    public static final Item NAZGUL_CLOAK = registerGeneratedItem("nazgul_cloak",
            new CustomChestplateItem(ModArmorMaterials.NAZGUL_CLOAK, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.CAPE)));
    ...
    public static final Item MISTY_HOBGOBLIN_COMMANDER_CHESTPLATE = registerGeneratedItem("misty_hobgoblin_commander_chestplate",
            new CustomChestplateItem(ModArmorMaterials.MISTY_HOBGOBLIN_PLATE_ARMOR, ArmorItem.Type.CHESTPLATE, new Item.Settings(), List.of(CustomChestplateItem.Customizations.IMPALED_SKULLS)));
