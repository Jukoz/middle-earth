...
public class FireBowlBlockEntity extends BlockEntity {

    public FireBowlBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.FIRE_BOWL, pos, state);
    }

    public static void clientTick(World world, BlockPos pos, BlockState state, FireBowlBlockEntity campfire) {
        int i;
