...
public class SmallBrazierBlockEntity extends BlockEntity {

    public SmallBrazierBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SMALL_BRAZIER, pos, state);
    }

    public static void clientTick(World world, BlockPos pos, BlockState state, SmallBrazierBlockEntity campfire) {
        int i;
