    ...
    static {
        ...
        ROHAN_SOLDIER = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "soldier"), MiddleEarthRaces.HUMAN, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.OFFHAND, NpcGearSlotData.create()
                                .add(NpcGearItemData.create(ModEquipmentItems.ROHIRRIC_SHIELD).withWeight(3))
                                .add(NpcGearItemData.create(ModEquipmentItems.ROHIRRIC_BUCKING_HORSE_SHIELD))
                                .add(NpcGearItemData.create(ModEquipmentItems.ROHIRRIC_GALLOPING_HORSE_SHIELD))
                                .add(NpcGearItemData.create(ModEquipmentItems.ROHIRRIC_HORSE_HEAD_SHIELD))
                                .add(NpcGearItemData.create(ModEquipmentItems.ROHIRRIC_PLAINSMAN_SHIELD))
                                .add(NpcGearItemData.create(ModEquipmentItems.ROHIRRIC_TWIN_HORSES_SHIELD))
        ...
        ROHAN_ROYAL_GUARD = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "royal_guard"), MiddleEarthRaces.HUMAN, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.OFFHAND, NpcGearSlotData.create(NpcGearItemData.create(ModEquipmentItems.ROHIRRIC_ROYAL_GUARD_SHIELD)))
        ));
        ROHAN_EORLING_MARSHAL = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "eorling_marhsal"), MiddleEarthRaces.HUMAN, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.OFFHAND, NpcGearSlotData.create()
                                .add(NpcGearItemData.create(ModEquipmentItems.ROHIRRIC_EORLING_SHIELD))
        ...
        ROHAN_HORSE_LORD = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "horse_lord"), MiddleEarthRaces.HUMAN, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.OFFHAND, NpcGearSlotData.create()
                                .add(NpcGearItemData.create(ModEquipmentItems.ROHIRRIC_ORNAMENTED_SHIELD))
                                .add(NpcGearItemData.create().withWeight(3))
                        )
        ));
