        ...
        BANDIT_THUG = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "thug"), MiddleEarthRaces.HUMAN, List.of(
                NpcGearData.create()
                        .add(EquipmentSlot.HEAD, NpcGearSlotData.create()
                                ...
                                .add(NpcGearItemData.create(ModEquipmentItems.GAMBESON_CAP).withHood(ModHoods.BASE_HOOD, true))
                                .add(NpcGearItemData.create(ModEquipmentItems.GAMBESON_COWL).withHood(ModHoods.BASE_HOOD, true))
            ...
            NpcGearData.create()
                    .add(EquipmentSlot.HEAD, NpcGearSlotData.create()
                            ...
                            .add(NpcGearItemData.create(ModEquipmentItems.GAMBESON_CAP).withHood(ModHoods.BASE_HOOD, true).withColor(DARK_BLUE))
                            .add(NpcGearItemData.create(ModEquipmentItems.GAMBESON_COWL).withHood(ModHoods.BASE_HOOD, true).withColor(DARK_BLUE))
                ...
                NpcGearData.create()
                        .add(EquipmentSlot.HEAD, NpcGearSlotData.create()
                                ...
                                .add(NpcGearItemData.create(ModEquipmentItems.GAMBESON_CAP).withHood(ModHoods.BASE_HOOD, true).withColor(OLIVE_GREEN))
                                .add(NpcGearItemData.create(ModEquipmentItems.GAMBESON_COWL).withHood(ModHoods.BASE_HOOD, true).withColor(OLIVE_GREEN))
                ...
                NpcGearData.create()
                        .add(EquipmentSlot.HEAD, NpcGearSlotData.create()
                                ...
                                .add(NpcGearItemData.create(ModEquipmentItems.GAMBESON_CAP).withHood(ModHoods.BASE_HOOD, true).withColor(DARK_BROWN))
                                .add(NpcGearItemData.create(ModEquipmentItems.GAMBESON_COWL).withHood(ModHoods.BASE_HOOD, true).withColor(DARK_BROWN))
