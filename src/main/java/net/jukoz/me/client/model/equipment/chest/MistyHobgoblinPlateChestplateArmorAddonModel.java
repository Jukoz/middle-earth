...
public class MistyHobgoblinPlateChestplateArmorAddonModel<T extends LivingEntity> extends ChestplateAddonModel<T> {
    private static final float MAX_ANGLE_HAIR = 75f;

    public final ModelPart shoulderAddon;

    public MistyHobgoblinPlateChestplateArmorAddonModel(ModelPart root) {
        super(root);
        shoulderAddon = root.getChild("right_arm").getChild("shoulder_addon");

        CHESTPLATE_ADDON_TEXTURE = Identifier.of(MiddleEarth.MOD_ID, "textures/models/armor/misty_hobgoblin_plate_chestplate_addon.png");
    }
