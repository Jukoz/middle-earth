...
public class MistyHobgoblinScaleChestplateArmorAddonModel<T extends LivingEntity> extends ChestplateAddonModel<T> {
    private static final float MAX_ANGLE_HAIR = 75f;

    public final ModelPart shoulderAddon;

    public MistyHobgoblinScaleChestplateArmorAddonModel(ModelPart root) {
        super(root);
