...
public class LongbeardPouchChestplateArmorModel<T extends LivingEntity> extends CustomChestplateModel<T> {

    public final ModelPart pouch;

    public LongbeardPouchChestplateArmorModel(ModelPart root) {
        super(root);
