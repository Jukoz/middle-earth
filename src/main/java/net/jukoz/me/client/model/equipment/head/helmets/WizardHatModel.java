...
public class WizardHatModel<T extends LivingEntity> extends HelmetAddonModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData wizard = head.addChild("wizard", ModelPartBuilder.create().uv(0, 47).cuboid(-8.0F, -6.134F, -8.0F, 16.0F, 1.0F, 16.0F, new Dilation(0.0F)), ModelTransform.of(0.0F, 0.4F, -1.15F, -0.1745F, 0.0F, 0.0F));
