...
public class GondorianPlateHelmetArmorAddonModel<T extends LivingEntity> extends HelmetAddonModel<T> {

    public final ModelPart addons;

    public GondorianPlateHelmetArmorAddonModel(ModelPart root) {
        super(root);
