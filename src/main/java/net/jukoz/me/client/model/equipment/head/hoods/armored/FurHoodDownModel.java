...
public class FurHoodDownModel<T extends LivingEntity> extends CloakHoodModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData FurHood2 = hood.addChild("FurHood2", ModelPartBuilder.create(), ModelTransform.of(0.0F, -6.5F, -3.5F, 1.5708F, 0.0F, 0.0F));

        ModelPartData down = FurHood2.addChild("down", ModelPartBuilder.create().uv(96, 0).cuboid(-4.0F, -6.0F, 0.75F, 8.0F, 8.0F, 8.0F, new Dilation(1.3F))
                .uv(64, 0).cuboid(-4.0F, -5.91F, 0.75F, 8.0F, 8.0F, 8.0F, new Dilation(1.0F)), ModelTransform.of(0.0F, 0.0F, -6.0F, -1.1345F, 0.0F, 0.0F));

        ModelPartData hooddown = down.addChild("hooddown", ModelPartBuilder.create(), ModelTransform.of(-0.144F, 4.2857F, -1.716F, -1.5708F, 0.0F, 0.0F));
