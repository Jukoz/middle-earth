...
public class CustomLeggingsModel<T extends LivingEntity> extends BipedEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData waist = body.addChild("waist", ModelPartBuilder.create().uv(16, 16).cuboid(-3.9F, -0.0F, -2.1F, 8.0F, 12.0F, 4.0F, new Dilation(0.3F)),
        ...
        ModelPartData rightLeg = modelPartData.addChild(EntityModelPartNames.RIGHT_LEG, ModelPartBuilder.create().uv(0, 16).cuboid(-2.1F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.3F)), ModelTransform.pivot(-1.9F, -11.0F, 0.0F));
        ModelPartData leftLeg = modelPartData.addChild(EntityModelPartNames.LEFT_LEG, ModelPartBuilder.create().uv(0, 32).mirrored().cuboid(-1.968F, -1.0F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.3F)).mirrored(false), ModelTransform.pivot(1.9F, -11.0F, 0.0F));
