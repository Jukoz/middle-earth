...
public class MistyHobgoblinCommanderChestplateArmorModel<T extends LivingEntity> extends CustomChestplateModel<T> {

    public MistyHobgoblinCommanderChestplateArmorModel(ModelPart root) {
        super(root);
