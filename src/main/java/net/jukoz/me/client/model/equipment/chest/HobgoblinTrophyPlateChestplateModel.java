...
public class HobgoblinTrophyPlateChestplateModel<T extends LivingEntity> extends ChestplateAddonModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        rightspear.addChild("Skull2", ModelPartBuilder.create().uv(40, 0).cuboid(-3.0F, -41.0F, -3.0F, 6.0F, 7.0F, 6.0F, new Dilation(0.0F))
        ...
        centrespear.addChild("Skull8", ModelPartBuilder.create().uv(40, 0).cuboid(-3.0F, -41.0F, -3.0F, 6.0F, 7.0F, 6.0F, new Dilation(0.0F))
                .uv(40, 13).cuboid(-3.0F, -41.0F, -3.0F, 6.0F, 10.0F, 6.0F, new Dilation(0.2F)), ModelTransform.pivot(0.0F, 10.0F, -0.2F));
        centrespear.addChild("rib3", ModelPartBuilder.create().uv(36, 38).cuboid(-5.0F, -5.4F, -1.0F, 10.0F, 9.0F, 4.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -18.5F, -0.2F));
