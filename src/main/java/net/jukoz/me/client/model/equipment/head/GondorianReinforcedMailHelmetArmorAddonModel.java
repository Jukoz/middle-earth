...
public class GondorianReinforcedMailHelmetArmorAddonModel<T extends LivingEntity> extends HelmetAddonModel<T> {

    public final ModelPart addons;

    public GondorianReinforcedMailHelmetArmorAddonModel(ModelPart root) {
        super(root);
