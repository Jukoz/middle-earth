...
public class HobgoblinPlateHelmetModel<T extends LivingEntity> extends HelmetAddonModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        headthing2.addChild("cube_r3", ModelPartBuilder.create().uv(24, 10).cuboid(1.0F, -12.0F, -2.5F, 0.0F, 14.0F, 20.0F, new Dilation(0.0F)), ModelTransform.of(0.5F, 3.1132F, -0.3666F, 0.3054F, 0.0F, 0.0F));
