...
public class PlayableNpcPreviewWidget extends ModWidget{
    ...
    public void updateEntity(FactionNpcPreviewData.PreviewData data, Race race, World world) {
        if(world != null)
    ...
    private void updateEquipment(FactionNpcPreviewData.PreviewData data){
        if(data == null) {
            this.entity = null;
            return;
        }
