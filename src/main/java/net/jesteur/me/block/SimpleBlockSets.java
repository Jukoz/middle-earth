...
public class SimpleBlockSets {
    ...
    public static SimpleBlockSet FROZEN_BLUE_COBBLESTONE = registerBrickSet("frozen_blue_cobblestone", COBBLE_STRENGTH);
    ...
    public static SimpleBlockSet POLISHED_FROZEN_BLUE_ROCK = registerBrickSet("polished_frozen_blue_rock", STONE_STRENGTH);
