...
public class CustomItemModels {
    public static final Model BIG_WEAPON = new Model(Optional.of(
            MiddleEarth.id("item/big_weapon")), Optional.empty(), TextureKey.LAYER0);
    public static final Model BIG_WEAPON_STAFF = new Model(Optional.of(
            MiddleEarth.id("item/big_weapon_staff")), Optional.empty(), TextureKey.LAYER0);
    public static final Model BIG_WEAPON_BLOCKING = new Model(Optional.of(
            MiddleEarth.id("item/big_weapon_blocking")), Optional.of("_blocking"), TextureKey.LAYER0);
    public static final Model BOW = new Model(Optional.of(
            MiddleEarth.id("item/bow")), Optional.empty(), TextureKey.LAYER0);
    public static final Model LONGBOW = new Model(Optional.of(
            MiddleEarth.id("item/longbow")), Optional.empty(), TextureKey.LAYER0);
    public static final Model DAGGER_STRIKE = new Model(Optional.of(
            MiddleEarth.id("item/dagger_strike")), Optional.empty(), TextureKey.LAYER0);
