...
import net.sevenstars.middleearth.network.packets.client2server.ArtisanTableTabPacket;
...
public class ArtisanTableScreen extends HandledScreen<ArtisanTableScreenHandler> implements ScreenHandlerListener {
    ...
    public void equipArmorStand(ItemStack stack) {
        ...
        if (!stack.isEmpty()) {
            ...
            if (itemStack.getComponents().contains(DataComponentTypes.EQUIPPABLE)) {
