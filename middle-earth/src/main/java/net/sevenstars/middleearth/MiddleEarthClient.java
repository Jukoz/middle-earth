...
import net.sevenstars.middleearth.block.special.crockpot.CrockpotEntityRenderer;
...
public class MiddleEarthClient implements ClientModInitializer {
    ...
    private void initializeRenderLayerMap() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModDecorativeBlocks.CROCKPOT, RenderLayer.getCutout());
