...
public class MiddleEarthClient implements ClientModInitializer {
    ...
    private void initializeRenderLayerMap() {
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModNatureBlocks.ATHELAS, RenderLayer.getCutout());
        ...
        }, ModNatureBlocks.WILD_GRASS, ModNatureBlocks.GRASS_TUFT, ModNatureBlocks.WHEATGRASS, ModNatureBlocks.BRACKEN,
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModDecorativeBlocks.LARGE_BEECH_FENCE_GATE, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModDecorativeBlocks.SHIRE_LANTERN, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModDecorativeBlocks.WALL_SHIRE_LANTERN, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.CRUDE_BARS, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.CRUDE_DOOR, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.CRUDE_TRAPDOOR, RenderLayer.getCutout());
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModDecorativeBlocks.BASALT_STATUE, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModDecorativeBlocks.GALONN_STATUE, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModDecorativeBlocks.PUMICE_STATUE, RenderLayer.getCutout());
