...
public class NpcTexturePattern {
    ...
    static {
        ...
        ENTRY_CODEC = RegistryElementCodec.of(MiddleEarthNpcTexturePatterns.KEY, CODEC);
        ENTRY_PACKET_CODEC = PacketCodecs.registryEntry(MiddleEarthNpcTexturePatterns.KEY, PACKET_CODEC);
    }
}
