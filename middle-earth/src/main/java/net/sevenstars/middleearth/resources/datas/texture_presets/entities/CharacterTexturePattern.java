...
public class CharacterTexturePattern {
    ...
    private final NpcTextureType category;

    private Boolean hasAddon;
    public CharacterTexturePattern(Identifier assetId, String category, Optional<Boolean> hasAddon){
    ...
    public CharacterTexturePattern(Identifier id, NpcTextureType category, Boolean hasAddon){
        this(id, category);
        this.hasAddon = hasAddon;
    }
    public CharacterTexturePattern(Identifier id, NpcTextureType category){
        this.assetId = id;
