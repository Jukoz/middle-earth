    ...
    static {
        EREBOR_MINER = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "miner"), RacesME.DWARF, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.CHEST, NpcGearSlotData.create()
                                ...
                                .add(NpcGearItemData.create(EquipmentItemsME.DWARVEN_GAMBESON).withColor(LIGHT_RED).withCape(ModCapes.SURCOAT, DARK_BROWN))
                                .add(NpcGearItemData.create(EquipmentItemsME.DWARVEN_MINER_GAMBESON).withColor(LIGHT_RED).withCape(ModCapes.SURCOAT, DARK_BROWN))
                        )
        ...
        EREBOR_MILITIA = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "militia"), RacesME.DWARF, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.CHEST, NpcGearSlotData.create()
                                .add(NpcGearItemData.create(EquipmentItemsME.LONGBEARD_PARTISAN_OUTFIT).withColor(LIGHT_RED).withCape(ModCapes.SURCOAT, LIGHT_BLUE))
        ...
        EREBOR_SOLDIER = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "soldier"), RacesME.DWARF, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.CHEST, NpcGearSlotData.create()
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_PADDED_MAIL_HAUBERK).withCape(ModCapes.EREBOR_CAPE))
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_PADDED_MAIL_HAUBERK).withCape(ModCapes.SURCOAT, LIGHT_BLUE))
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_LONG_COAT).withColor(LIGHT_RED))
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_LONG_COAT).withColor(LIGHT_RED).withCape(ModCapes.SURCOAT, LIGHT_BLUE))
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_BRAWLER_CHESTPLATE).withColor(LIGHT_BLUE))
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_BRAWLER_CHESTPLATE).withColor(DARK_RED).withCape(ModCapes.EREBOR_CAPE))
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_REINFORCED_LEATHER_HAUBERK).withColor(LIGHT_BLUE))
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_REINFORCED_COAT).withColor(LIGHT_BLUE).withCape(ModCapes.SURCOAT, LIGHT_BLUE))
                        )
                        .add(EquipmentSlot.LEGS, NpcGearSlotData.create()
        ...
        EREBOR_ELITE = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "elite"), RacesME.DWARF, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.CHEST, NpcGearSlotData.create()
                                ...
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_BRAWLER_CHESTPLATE).withColor(LIGHT_BLUE).withCape(ModCapes.EREBOR_CAPE))

                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_PLATE_CHESTPLATE).withCape(ModCapes.EREBOR_CAPE).withWeight(3))
                        )
                        .add(EquipmentSlot.LEGS, NpcGearSlotData.create()
        ...
        EREBOR_VETERAN = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "veteran"), RacesME.DWARF, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.CHEST, NpcGearSlotData.create()
                                ...
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_PLATE_CHESTPLATE).withCape(ModCapes.SURCOAT, LIGHT_BLUE))
                        )
                        .add(EquipmentSlot.LEGS, NpcGearSlotData.create()
        ...
        EREBOR_GATEWARDEN = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "gatewarden"), RacesME.DWARF, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.CHEST, NpcGearSlotData.create()
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_GATEWARDEN_CHESTPLATE).withCape(ModCapes.EREBOR_CAPE))
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_GATEWARDEN_CHESTPLATE).withCape(ModCapes.SURCOAT, LIGHT_BLUE))
                        )
                        .add(EquipmentSlot.LEGS, NpcGearSlotData.create()
        ...
        EREBOR_LEADER = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE + "leader"), RacesME.DWARF, List.of(
                NpcGearData.create()
                        ...
                        .add(EquipmentSlot.CHEST, NpcGearSlotData.create()
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_PLATE_CHESTPLATE).withCape(ModCapes.EREBOR_CAPE))
                                .add(NpcGearItemData.create(EquipmentItemsME.EREBOR_PLATE_CHESTPLATE).withCape(ModCapes.SURCOAT, LIGHT_BLUE))
                        )
                        .add(EquipmentSlot.LEGS, NpcGearSlotData.create()
