...
public class WargArmorFrontSkullFeatureRenderer extends FeatureRenderer<WargEntityRenderState, WargModel> {
    ...
    public WargArmorFrontSkullFeatureRenderer(FeatureRendererContext<WargEntityRenderState, WargModel> context, EntityModelLoader loader, EquipmentRenderer equipmentRenderer) {
        super(context);
