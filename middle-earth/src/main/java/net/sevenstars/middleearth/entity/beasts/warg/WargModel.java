...
public class WargModel extends EntityModel<WargEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData mane = upper_body.addChild("mane", ModelPartBuilder.create().uv(6, 73).cuboid(-9.5F, -3.0F, 0.0F, 17.0F, 6.0F, 0.0F, new Dilation(0.0F)), ModelTransform.origin(5.5F, -8.0F, 1.0F));

        ModelPartData right_front_leg = upper_body.addChild("right_front_leg", ModelPartBuilder.create().uv(46, 50).cuboid(-2.0F, 1.0F, -1.5F, 4.0F, 12.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(10.0F, 4.0F, -1.5F));

        ModelPartData left_front_leg = upper_body.addChild("left_front_leg", ModelPartBuilder.create().uv(32, 50).cuboid(-2.0F, 1.0F, -1.0F, 4.0F, 12.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(10.0F, 4.0F, 3.0F));
        ...
        ModelPartData jaw = head.addChild("jaw", ModelPartBuilder.create().uv(0, 44).cuboid(-5.5F, -0.25F, -1.5F, 15.0F, 2.0F, 3.0F, new Dilation(0.0F))
                .uv(0, 66).cuboid(-5.5F, -1.25F, -1.5F, 15.0F, 1.0F, 3.0F, new Dilation(-0.05F)), ModelTransform.origin(4.1142F, 3.1362F, -0.5F));
        ...
        ModelPartData left_back_leg = body.addChild("left_back_leg", ModelPartBuilder.create().uv(0, 50).cuboid(-2.7F, 1.0F, -1.5F, 5.0F, 12.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(-9.8858F, 2.8862F, 2.0F));

        ModelPartData right_back_leg = body.addChild("right_back_leg", ModelPartBuilder.create().uv(16, 50).cuboid(-2.7F, 1.0F, -1.5F, 5.0F, 12.0F, 3.0F, new Dilation(0.0F)), ModelTransform.origin(-9.8858F, 2.8862F, -3.0F));
