...
public class WargArmorSideAddonsModel extends WargArmorModel {
    ...
    public static TexturedModelData getTexturedModelDataSideSkulls() {
        ...
        ModelPartData skulls = addons_front_armor.addChild("skulls", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 1.0F));
        ...
        skull_02.addChild("back_body_no_legs", ModelPartBuilder.create(), ModelTransform.origin(-4.5F, -3.0F, -6.0F));
