...
public class EarModel  extends EntityModel<NpcEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData cube_ears = modelPartData.addChild("cube_ears", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));

        cube_ears.addChild("ears_cube_left", ModelPartBuilder.create().uv(12, 0).cuboid(-5.0f, -4f, -1f, 1, 2, 1, Dilation.NONE), ModelTransform.origin(0.0F, 0.0F, 0.0F));
        cube_ears.addChild("ears_cube_right", ModelPartBuilder.create().uv(12, 0).cuboid(4.0f, -4f, -1f, 1, 2, 1, Dilation.NONE), ModelTransform.origin(0.0F, 0.0F, 0.0F));

        ModelPartData pointy_ears = modelPartData.addChild("pointy_ears", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));

        pointy_ears.addChild("ears_pointy_right", ModelPartBuilder.create().uv(0, -3).cuboid(0f,0f,0f, 0, 2, 6, Dilation.NONE), ModelTransform.origin(-3.75f, -3f, -2f));
        pointy_ears.addChild("ears_pointy_left", ModelPartBuilder.create().uv(0, -3).cuboid(0f,0f,0f, 0, 2, 6, Dilation.NONE), ModelTransform.origin(3.75f, -3f, -2f));
    ...
    public void setAngles(NpcEntityRenderState state) {
        ...
        this.cubeEarGroup.yaw = state.relativeHeadYaw * 0.017453292F;
        this.cubeEarGroup.pitch = state.pitch * 0.017453292F;

        this.pointyEarGroup.yaw = state.relativeHeadYaw * 0.017453292F;
