    ...
    private static final Map<BroadhoofGoatPattern, Identifier> TEXTURES = Maps.newEnumMap(
            Map.ofEntries(
                    ...
                    Map.entry(BroadhoofGoatPattern.BLACK_MASK,
                            MiddleEarth.id(PATH + "broadhoof_goat_black_mask.png")),
                    Map.entry(BroadhoofGoatPattern.BLACK_PATCHES,
                            MiddleEarth.id(PATH + "broadhoof_goat_black_patches.png")),
                    Map.entry(BroadhoofGoatPattern.BLACK_SIDE_PATCH,
                            MiddleEarth.id(PATH + "broadhoof_goat_black_side_patch.png")),
                    Map.entry(BroadhoofGoatPattern.BLACK_SPOTS,
                            MiddleEarth.id(PATH + "broadhoof_goat_black_spots.png")),
                    Map.entry(BroadhoofGoatPattern.BLACK_STRIPS,
                            MiddleEarth.id(PATH + "broadhoof_goat_black_strip.png")),

                    Map.entry(BroadhoofGoatPattern.BROWN_MASK,
                            MiddleEarth.id(PATH + "broadhoof_goat_brown_mask.png")),
                    Map.entry(BroadhoofGoatPattern.BROWN_PATCHES,
                            MiddleEarth.id(PATH + "broadhoof_goat_brown_patches.png")),
                    Map.entry(BroadhoofGoatPattern.BROWN_SIDE_PATCH,
                            MiddleEarth.id(PATH + "broadhoof_goat_brown_side_patch.png")),
                    Map.entry(BroadhoofGoatPattern.BROWN_SPOTS,
                            MiddleEarth.id(PATH + "broadhoof_goat_brown_spots.png")),
                    Map.entry(BroadhoofGoatPattern.BROWN_STRIPS,
                            MiddleEarth.id(PATH + "broadhoof_goat_brown_strip.png")),

                    Map.entry(BroadhoofGoatPattern.PALE_MASK,
                            MiddleEarth.id(PATH + "broadhoof_goat_pale_mask.png")),
                    Map.entry(BroadhoofGoatPattern.PALE_PATCHES,
                            MiddleEarth.id(PATH + "broadhoof_goat_pale_patches.png")),
                    Map.entry(BroadhoofGoatPattern.PALE_SIDE_PATCH,
                            MiddleEarth.id(PATH + "broadhoof_goat_pale_side_patch.png")),
                    Map.entry(BroadhoofGoatPattern.PALE_SPOTS,
                            MiddleEarth.id(PATH + "broadhoof_goat_pale_spots.png")),
                    Map.entry(BroadhoofGoatPattern.PALE_STRIPS,
                            MiddleEarth.id(PATH + "broadhoof_goat_pale_strip.png")),

                    Map.entry(BroadhoofGoatPattern.GRAY_BEARD,
                            MiddleEarth.id(PATH + "broadhoof_goat_gray_beard.png"))
