...
public class CaveTrollSaddleModel extends CaveTrollEntityModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData armor = body.addChild("armor", ModelPartBuilder.create().uv(91, 51)
                .cuboid(-16.0F, -40.0F, -9.0F, 33.0F, 40.0F, 17.0F, new Dilation(0.2F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData saddle_platform = modelPartData.addChild("saddle_platform", ModelPartBuilder.create().uv(0, 0).cuboid(-7.5F, 1.0F, -7.5F, 15.0F, 2.0F, 16.0F, new Dilation(0.0F))
                .uv(0, 77).cuboid(-7.5F, -17.0F, -7.5F, 15.0F, 18.0F, 16.0F,
                        new Dilation(0.0F)), ModelTransform.origin(0.5F, -47.0F, 6.5F));
