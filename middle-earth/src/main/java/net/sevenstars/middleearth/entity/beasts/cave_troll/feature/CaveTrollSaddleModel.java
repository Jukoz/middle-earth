...
public class CaveTrollSaddleModel extends EntityModel<CaveTrollEntityRenderState> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData saddle_platform = body_no_limbs.addChild("saddle_platform", ModelPartBuilder.create().uv(0, 0).cuboid(-7.5F, 1.0F, -7.5F, 15.0F, 2.0F, 16.0F, new Dilation(0.0F))
        ...
        ModelPartData Platform = body_no_limbs.addChild("Platform", ModelPartBuilder.create().uv(106, 15).cuboid(-15.5F, 12.0F, 1.5F, 31.0F, 4.0F, 4.0F, new Dilation(0.0F))
        ...
        ModelPartData Head = body_no_limbs.addChild("Head", ModelPartBuilder.create(), ModelTransform.origin(0.5F, -34.5F, -8.5F));
