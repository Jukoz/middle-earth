...
public class NatureBlockItemsME {
    ...
    public static final Item SMALL_LILY_PADS = registerItem("small_lily_pads",
            (settings) -> new PlaceableOnWaterItem(NatureBlockRegistryME.SMALL_LILY_PADS, settings), new Item.Settings());
    public static final Item SMALL_FLOWERING_LILY_PADS = registerItem("small_flowering_lily_pads",
            (settings) ->  new PlaceableOnWaterItem(NatureBlockRegistryME.SMALL_FLOWERING_LILY_PADS, settings), new Item.Settings());
    public static final Item LILY_PADS = registerItem("lily_pads",
            (settings) ->  new PlaceableOnWaterItem(NatureBlockRegistryME.LILY_PADS, settings), new Item.Settings());
    public static final Item FLOWERING_LILY_PADS = registerItem("flowering_lily_pads",
            (settings) ->  new PlaceableOnWaterItem(NatureBlockRegistryME.FLOWERING_LILY_PADS, settings), new Item.Settings());
    public static final Item LARGE_LILY_PAD = registerItem("large_lily_pad",
            (settings) ->  new PlaceableOnWaterItem(NatureBlockRegistryME.LARGE_LILY_PAD, settings), new Item.Settings());
    public static final Item LARGE_FLOWERING_LILY_PAD = registerItem("large_flowering_lily_pad",
            (settings) ->  new PlaceableOnWaterItem(NatureBlockRegistryME.LARGE_FLOWERING_LILY_PAD, settings), new Item.Settings());

    public static final Item DUCKWEED = registerItem("duckweed",
            (settings) ->  new PlaceableOnWaterItem(NatureBlockRegistryME.DUCKWEED, settings), new Item.Settings());

    public static final Item FLOATING_ICE = registerItem("floating_ice",
            (settings) -> new PlaceableOnWaterItem(NatureBlockRegistryME.FLOATING_ICE, settings), new Item.Settings());
