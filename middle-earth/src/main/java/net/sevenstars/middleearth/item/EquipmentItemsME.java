...
public class EquipmentItemsME {
    ...
    public static final Item STRAW_HAT = registerCustomModelArmorPiece("straw_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STRAW_T1, settings, ModFactions.NONE), new Item.Settings());
    ...
    public static final Item SALLET = registerCustomModelArmorPiece("sallet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.NONE), new Item.Settings());
    //endregion
    ...
    public static final Item GONDORIAN_SOLDIER_HELMET = registerCustomModelArmorPiece("gondorian_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.GONDOR), new Item.Settings());

    public static final Item GONDORIAN_SOLDIER_CHESTPLATE = registerArmorPiece("gondorian_soldier_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.GONDOR), new Item.Settings());
    ...
    public static final Item GONDORIAN_PLATE_LEGGINGS = registerArmorPiece("gondorian_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.GONDOR), new Item.Settings());
    public static final Item GONDORIAN_PLATE_BOOTS = registerArmorPiece("gondorian_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.GONDOR), new Item.Settings());
    ...
    public static final Item ROHIRRIC_MILITIA_HELMET = registerArmorPiece("rohirric_militia_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.ROHAN), new Item.Settings());
    ...
    public static final Item ROHIRRIC_SOLDIER_HELMET = registerArmorPiece("rohirric_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.ROHAN), new Item.Settings());
    ...
    public static final Item ROHIRRIC_SCALE_JACKET = registerArmorPiece("rohirric_scale_jacket",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.ROHAN), new Item.Settings());

    public static final Item EORLING_MARSHAL_HELMET = registerCustomModelArmorPiece("eorling_marshal_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ROHAN), new Item.Settings());
    ...
    public static final Item EORLING_MARSHAL_LEGGINGS = registerArmorPiece("eorling_marshal_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ROHAN), new Item.Settings());
    public static final Item EORLING_MARSHAL_BOOTS = registerArmorPiece("eorling_marshal_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ROHAN), new Item.Settings());
    ...
    public static final Item DALISH_BOOTS = registerArmorPiece("dalish_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.DALE), new Item.Settings());

    public static final Item DALISH_HELMET = registerCustomModelArmorPiece("dalish_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.DALE), new Item.Settings());
    ...
    public static final Item DALISH_MAIL_HAUBERK = registerArmorPiece("dalish_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.DALE), new Item.Settings());

    public static final Item DALISH_MAIL_COAT = registerArmorPiece("dalish_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.DALE), new Item.Settings());

    public static final Item DALISH_BURGONET = registerCustomModelArmorPiece("dalish_burgonet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.DALE), new Item.Settings());
    ...
    public static final Item DALISH_HEYDAY_MAIL_COAT = registerArmorPiece("dalish_heyday_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.DALE), new Item.Settings());
    public static final Item DALISH_HEYDAY_BOOTS = registerArmorPiece("dalish_heyday_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.DALE), new Item.Settings());

    public static final Item BARDING_SOLDIER_HELMET = registerCustomModelArmorPiece("barding_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.DALE), new Item.Settings());
    ...
    public static final Item BARDING_MAIL_SKIRT = registerArmorPiece("barding_mail_skirt",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.DALE), new Item.Settings());
    public static final Item BARDING_PLATED_BOOTS = registerArmorPiece("barding_plated_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.DALE), new Item.Settings());
    ...
    public static final Item DWARVEN_MAIL_CHAUSSES = registerArmorPiece("dwarven_mail_chausses",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.NONE), new Item.Settings());
    ...
    public static final Item DWARVEN_SCALE_HAUBERK = registerArmorPiece("dwarven_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModFactions.NONE), new Item.Settings());

    public static final Item DWARVEN_SCALE_COAT = registerArmorPiece("dwarven_scale_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModFactions.NONE), new Item.Settings());

    public static final Item DWARVEN_REINFORCED_BOOTS = registerArmorPiece("dwarven_reinforced_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModFactions.NONE), new Item.Settings());
    //endregion

    //region LONGBEARDS
    public static final Item LONGBEARD_SEGMENTED_HELMET = registerArmorPiece("longbeard_segmented_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BRONZE_T2, settings, ModFactions.LONGBEARDS), new Item.Settings());
    ...
    public static final Item EREBOR_MAIL_CHAUSSES = registerArmorPiece("erebor_mail_chausses",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.IRON_T3, settings, ModSubFactions.EREBOR), new Item.Settings());
    ...
    public static final Item RAVENHILL_HELMET = registerArmorPiece("ravenhill_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModSubFactions.EREBOR), new Item.Settings());
    ...
    public static final Item EREBOR_SCALE_COAT = registerArmorPiece("erebor_scale_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModSubFactions.EREBOR), new Item.Settings());
    ...
    public static final Item RAVENHILL_BOOTS = registerArmorPiece("ravenhill_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModSubFactions.EREBOR), new Item.Settings());

    public static final Item EREBOR_GUARD_HELMET = registerArmorPiece("erebor_guard_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings, ModSubFactions.EREBOR), new Item.Settings());
    ...
    public static final Item EREBOR_PLATE_LEGGINGS = registerArmorPiece("erebor_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings, ModSubFactions.EREBOR), new Item.Settings());
    public static final Item EREBOR_PLATE_BOOTS = registerArmorPiece("erebor_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings, ModSubFactions.EREBOR), new Item.Settings());
    ...
    public static final Item LORIEN_DIADEM = registerCustomModelArmorPiece("lorien_diadem",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BRONZE_T1, settings, ModFactions.LOTHLORIEN), new Item.Settings());

    public static final Item LORIEN_LEATHER_HELMET = registerCustomModelArmorPiece("lorien_leather_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.LOTHLORIEN), new Item.Settings());

    public static final Item LORIEN_ARMING_COAT = registerArmorPiece("lorien_arming_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.LOTHLORIEN), new Item.Settings());

    public static final Item LORIEN_ARMING_SKIRT = registerArmorPiece("lorien_arming_skirt",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.LOTHLORIEN), new Item.Settings());

    public static final Item LORIEN_MAIL_COIF_DIADEM = registerCustomModelArmorPiece("lorien_mail_coif_diadem",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.LOTHLORIEN), new Item.Settings());
    ...
    public static final Item LORIEN_SOLDIER_HELMET = registerCustomModelArmorPiece("lorien_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings, ModFactions.LOTHLORIEN), new Item.Settings());

    public static final Item LORIEN_SOLDIER_MAIL_HAUBERK = registerArmorPiece("lorien_soldier_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings, ModFactions.LOTHLORIEN), new Item.Settings());
    ...
    public static final Item LORIEN_SCALE_COAT = registerArmorPiece("lorien_scale_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings, ModFactions.LOTHLORIEN), new Item.Settings());
    ...
    public static final Item GALADHRIM_LEGGINGS = registerArmorPiece("galadhrim_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings, ModFactions.LOTHLORIEN), new Item.Settings());
    public static final Item GALADHRIM_BOOTS = registerArmorPiece("galadhrim_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings, ModFactions.LOTHLORIEN), new Item.Settings());
    ...
    public static final Item RUSTED_MORDOR_HELMET = registerArmorPiece("rusted_mordor_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T2, settings, ModFactions.MORDOR), new Item.Settings());
    ...
    public static final Item RUSTED_MORDOR_CREST_HELMET = registerCustomModelArmorPiece("rusted_mordor_crest_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T3, settings, ModFactions.MORDOR), new Item.Settings());
    ...
    public static final Item MORDOR_CREST_HELMET = registerCustomModelArmorPiece("mordor_crest_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.MORDOR), new Item.Settings());
    ...
    public static final Item MORDOR_PLATE_BOOTS = registerArmorPiece("mordor_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.MORDOR), new Item.Settings());
    ...
    public static final Item BLACK_URUK_PLATE_LEGGINGS = registerArmorPiece("black_uruk_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings());
    ...
    public static final Item MORDOR_BLACK_NUMENOREAN_PLATE_HELMET = registerCustomModelArmorPiece("mordor_black_numenorean_plate_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModSubFactions.MORDOR_BLACK_NUMENOREANS), new Item.Settings());
    ...
    public static final Item MORDOR_BLACK_NUMENOREAN_PLATE_LEGGINGS = registerArmorPiece("mordor_black_numenorean_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModSubFactions.MORDOR_BLACK_NUMENOREANS), new Item.Settings());
    public static final Item MORDOR_BLACK_NUMENOREAN_PLATE_BOOTS = registerArmorPiece("mordor_black_numenorean_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModSubFactions.MORDOR_BLACK_NUMENOREANS), new Item.Settings());
    ...
    public static final Item RINGWRAITH_MAIL_HAUBERK = registerArmorPiece("ringwraith_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings());
    public static final Item RINGWRAITH_LEGGINGS = registerArmorPiece("ringwraith_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings());
    public static final Item RINGWRAITH_BOOTS = registerArmorPiece("ringwraith_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings());
    //endregion

    //region ISENGARD
    public static final Item URUK_HAI_LEATHER_SCOUT_CAP = registerCustomModelArmorPiece("uruk_hai_leather_scout_cap",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.ISENGARD), new Item.Settings());

    public static final Item URUK_HAI_LEATHER_CHESTPLATE = registerArmorPiece("uruk_hai_leather_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.ISENGARD), new Item.Settings());
    ...
    public static final Item URUK_HAI_BOOTS = registerArmorPiece("uruk_hai_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.ISENGARD), new Item.Settings());

    public static final Item URUK_HAI_LIGHT_HELMET = registerCustomModelArmorPiece("uruk_hai_light_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T3, settings, ModFactions.ISENGARD), new Item.Settings());
    ...
    public static final Item URUK_HAI_MAIL_HAUBERK = registerArmorPiece("uruk_hai_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.CRUDE_T3, settings, ModFactions.ISENGARD), new Item.Settings());

    public static final Item URUK_HAI_MAIL_COAT = registerArmorPiece("uruk_hai_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.CRUDE_T3, settings, ModFactions.ISENGARD), new Item.Settings());
    ...
    public static final Item URUK_HAI_SOLDIER_HELMET = registerCustomModelArmorPiece("uruk_hai_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.ISENGARD), new Item.Settings());
    ...
    public static final Item URUK_HAI_CUIRASS = registerArmorPiece("uruk_hai_cuirass",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.ISENGARD), new Item.Settings());

    public static final Item URUK_HAI_PLATE_HELMET = registerCustomModelArmorPiece("uruk_hai_plate_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings());
    ...
    public static final Item URUK_HAI_PLATE_CHESTPLATE = registerCustomModelArmorPiece("uruk_hai_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings());
    public static final Item URUK_HAI_PLATE_LEGGINGS = registerArmorPiece("uruk_hai_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings());
    public static final Item URUK_HAI_PLATE_BOOTS = registerArmorPiece("uruk_hai_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings());

    public static final Item ORTHANC_GUARD_HELMET = registerCustomModelArmorPiece("orthanc_guard_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings());
    ...
    public static final Item ORTHANC_GUARD_LEGGINGS = registerArmorPiece("orthanc_guard_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings());
    public static final Item ORTHANC_GUARD_BOOTS = registerArmorPiece("orthanc_guard_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings());
    ...
    public static final Item HELMET_OF_HELM_HAMMERHAND = registerCustomModelArmorPiece("helmet_of_helm_hammerhand",
            (settings) -> new CustomArtefactHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ROHAN), new Item.Settings());
