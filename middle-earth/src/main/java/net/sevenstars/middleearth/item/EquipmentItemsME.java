...
public class EquipmentItemsME {
    ...
    public static final Item STRAW_HAT = registerCustomModelArmorPiece("straw_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STRAW_T1, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.BASIC);

    public static final Item WOVEN_HAT = registerCustomModelArmorPiece("woven_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.WOOL_T1, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.BASIC);
    ...
    public static final Item BYCOCKET = registerDyeableArmorPiece("bycocket",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.WOOL_T1, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(-6265536)), ArmorMaterialsME.Tiers.BASIC);
    ...
    public static final Item WANDERER_HAT = registerDyeableCustomModelArmorPiece("wanderer_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.FABRIC_T1, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(5394247)), ArmorMaterialsME.Tiers.BASIC);
    ...
    public static final Item ARMING_COAT = registerDyeableArmorPiece("arming_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(15256475)), ArmorMaterialsME.Tiers.BASIC);
    ...
    public static final Item SHOES = registerArmorPiece("shoes",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.FABRIC_T1, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.BASIC);
    ...
    public static final Item LEATHER_SKULLCAP = registerDyeableArmorPiece("leather_skullcap",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(-6265536)), ArmorMaterialsME.Tiers.LIGHT);

    public static final Item GAMBESON_CAP = registerDyeableArmorPiece("gambeson_cap",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(15256475)), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item KETTLE_HAT = registerCustomModelArmorPiece("kettle_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T2, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item STURDY_BOOTS = registerArmorPiece("sturdy_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item MAIL_COIF = registerArmorPiece("mail_coif",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item MAIL_HAUBERK = registerArmorPiece("mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item MAIL_SKIRT = registerArmorPiece("mail_skirt",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);

    public static final Item SALLET = registerCustomModelArmorPiece("sallet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    //endregion
    ...
    public static final Item SHIRRIFF_HAT = registerDyeableCustomModelArmorPiece("shirriff_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T1, settings, ModFactions.SHIRE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(3440180)), ArmorMaterialsME.Tiers.BASIC);
    //endregion

    //region MEN
    //region GONDOR
    public static final Item GONDORIAN_BOOTS = registerArmorPiece("gondorian_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.GONDOR), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);

    public static final Item GONDORIAN_CABASSET_HELMET = registerCustomModelArmorPiece("gondorian_cabasset_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.GONDOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);

    public static final Item GONDORIAN_MAIL_HAUBERK = registerArmorPiece("gondorian_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.GONDOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item GONDORIAN_LEATHER_CUIRASS = registerDyeableArmorPiece("gondorian_leather_cuirass",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.GONDOR), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(-6265536)), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item GONDORIAN_MAIL_COAT = registerArmorPiece("gondorian_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.GONDOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);

    public static final Item GONDORIAN_SOLDIER_HELMET = registerCustomModelArmorPiece("gondorian_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.GONDOR), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item GONDORIAN_SOLDIER_CHESTPLATE = registerArmorPiece("gondorian_soldier_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.GONDOR), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item GONDORIAN_PLATE_HELMET = registerCustomModelArmorPiece("gondorian_plate_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.GONDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item GONDORIAN_PLATE_CHESTPLATE = registerCustomModelArmorPiece("gondorian_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.GONDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item GONDORIAN_PLATE_LEGGINGS = registerArmorPiece("gondorian_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.GONDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item GONDORIAN_PLATE_BOOTS = registerArmorPiece("gondorian_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.GONDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item GONDORIAN_KINGS_GUARD_CHESTKPLATE = registerCustomModelArmorPiece("gondorian_kings_guard_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.GONDOR), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.GONDORIAN_KINGS_GUARD_CAPE)), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item GONDORIAN_CITADEL_GUARD_HELMET = registerCustomModelArmorPiece("gondorian_citadel_guard_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.GONDOR), new Item.Settings()
                    .component(DataComponentTypesME.HELMET_ATTACHMENT_DATA, HelmetAttachmentDataComponent.newHelmetAttachmentwithState(true, HelmetAttachmentsME.GONDORIAN_CITADEL_GUARD_HOOD)), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item GONDORIAN_CITADEL_GUARD_CHESTPLATE = registerArmorPiece("gondorian_citadel_guard_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.GONDOR), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.GONDORIAN_CITADEL_GUARD_CAPE)), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item GONDORIAN_FOUNTAIN_GUARD_CHESTPLATE = registerCustomModelArmorPiece("gondorian_fountain_guard_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.GONDOR), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.GONDORIAN_FOUNTAIN_GUARD_CAPE)), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item GONDORIAN_CITADEL_GUARD_HOOD = registerHelmetAttachment("gondorian_citadel_guard_hood",
            (settings) -> new HelmetAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.GONDOR), new Item.Settings()
    ...
    public static final Item GONDORIAN_CAPTAIN_CAPE = registerBackAttachment("gondorian_captain_cape",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.GONDOR), new Item.Settings()
    ...
    public static final Item GONDORIAN_HORSE_ARMOR = registerGeneratedItem("gondorian_horse_armor",
            (settings) -> new CustomHorseArmorItem(ArmorMaterialsME.GONDORIAN_HORSE_ARMOR.material(), settings, ModFactions.GONDOR), new Item.Settings().maxCount(1));
    ...
    public static final Item ROHIRRIC_REINFORCED_COAT = registerDyeableArmorPiece("rohirric_reinforced_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings, ModFactions.ROHAN), new Item.Settings()
                    ...
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_CAPE)), ArmorMaterialsME.Tiers.BASIC);

    public static final Item ROHIRRIC_LEATHER_HELMET = registerArmorPiece("rohirric_leather_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.ROHAN), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item ROHIRRIC_LEATHER_VEST = registerDyeableArmorPiece("rohirric_leather_vest",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.ROHAN), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(15256475))
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_CAPE)), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item ROHIRRIC_MILITIA_HELMET = registerArmorPiece("rohirric_militia_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.ROHAN), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item ROHIRRIC_REINFORCED_LEATHER_VEST = registerDyeableArmorPiece("rohirric_reinforced_leather_vest",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.ROHAN), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(15256475))
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_CAPE)), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item ROHIRRIC_SOLDIER_HELMET = registerArmorPiece("rohirric_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.ROHAN), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item ROHIRRIC_SCALE_HAUBERK = registerArmorPiece("rohirric_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.ROHAN), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    public static final Item ROHIRRIC_ORNAMENTED_SCALE_HAUBERK = registerArmorPiece("rohirric_ornamented_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.ROHAN), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_ROYAL_GUARD_CAPE)), ArmorMaterialsME.Tiers.STURDY);

    public static final Item ROHIRRIC_SCALE_JACKET = registerArmorPiece("rohirric_scale_jacket",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.ROHAN), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item EORLING_MARSHAL_HELMET = registerCustomModelArmorPiece("eorling_marshal_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ROHAN), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item EORLING_MARSHAL_CHESTPLATE = registerArmorPiece("eorling_marshal_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ROHAN), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.EORLING_MARSHAL_CAPE)), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item EORLING_MARSHAL_LEGGINGS = registerArmorPiece("eorling_marshal_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ROHAN), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item EORLING_MARSHAL_BOOTS = registerArmorPiece("eorling_marshal_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ROHAN), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item HORSE_LORD_CHESTPLATE = registerArmorPiece("horse_lord_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ROHAN), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.HORSE_LORD_CAPE)), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item ROHIRRIC_CAPE = registerBackAttachment("rohirric_cape",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.ROHAN), new Item.Settings()
    ...
    public static final Item ROHIRRIC_ROYAL_GUARD_CAPE = registerBackAttachment("rohirric_royal_guard_cape",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.ROHAN), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_ROYAL_GUARD_CAPE)));
    public static final Item EORLING_MARSHAL_CAPE = registerBackAttachment("eorling_marshal_cape",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.ROHAN), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.EORLING_MARSHAL_CAPE)));
    public static final Item HORSE_LORD_CAPE = registerBackAttachment("horse_lord_cape",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.ROHAN), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.HORSE_LORD_CAPE)));

    public static final Item ROHIRRIC_HORSE_ARMOR = registerGeneratedItem("rohirric_horse_armor",
            (settings) -> new CustomHorseArmorItem(ArmorMaterialsME.ROHIRRIC_HORSE_ARMOR.material(), settings, ModFactions.ROHAN), new Item.Settings().maxCount(1));
    //endregion
    ...
    public static final Item DALISH_ARMING_COAT_BLACK_FUR = registerDyeableArmorPiece("dalish_arming_coat_black_fur",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings, ModFactions.DALE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(7296407)), ArmorMaterialsME.Tiers.BASIC);
    ...
    public static final Item DALISH_HEYDAY_ARMING_COAT = registerArmorPiece("dalish_heyday_arming_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.BASIC);

    public static final Item DALISH_BOOTS = registerArmorPiece("dalish_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);

    public static final Item DALISH_HELMET = registerCustomModelArmorPiece("dalish_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item DALISH_MAIL_HAUBERK = registerArmorPiece("dalish_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);

    public static final Item DALISH_MAIL_COAT = registerArmorPiece("dalish_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);

    public static final Item DALISH_BURGONET = registerCustomModelArmorPiece("dalish_burgonet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item DALISH_SCALE_HAUBERK = registerArmorPiece("dalish_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item DALISH_HEYDAY_CHESTPLATE = registerArmorPiece("dalish_heyday_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.DALE), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.DALISH_HEYDAY_CLOAK)), ArmorMaterialsME.Tiers.STURDY);
    public static final Item DALISH_HEYDAY_MAIL_COAT = registerArmorPiece("dalish_heyday_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    public static final Item DALISH_HEYDAY_BOOTS = registerArmorPiece("dalish_heyday_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T4, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item BARDING_SOLDIER_HELMET = registerCustomModelArmorPiece("barding_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item BARDING_SOLDIER_CHESTPLATE = registerArmorPiece("barding_soldier_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item BARDING_MAIL_SKIRT = registerArmorPiece("barding_mail_skirt",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item BARDING_PLATED_BOOTS = registerArmorPiece("barding_plated_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.DALE), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item BARDING_SERGEANT_CHESTPLATE = registerArmorPiece("barding_sergeant_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.DALE), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.BARDING_SERGEANT_CAPE)), ArmorMaterialsME.Tiers.HEAVY);

    public static final Item BARDING_SURCOAT = registerBackAttachment("barding_surcoat",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.DALE), new Item.Settings()
    ...
    public static final Item DALISH_HORSE_ARMOR = registerGeneratedItem("dalish_horse_armor",
            (settings) -> new CustomHorseArmorItem(ArmorMaterialsME.DALISH_HORSE_ARMOR.material(), settings, ModFactions.DALE), new Item.Settings().maxCount(1));
    ...
    public static final Item DWARVEN_MINER_HELMET = registerDyeableCustomModelArmorPiece("dwarven_miner_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(7098174)), ArmorMaterialsME.Tiers.LIGHT);

    public static final Item DWARVEN_GAMBESON = registerDyeableArmorPiece("dwarven_gambeson",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(11572859)), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item DWARVEN_MINER_GAMBESON = registerDyeableArmorPiece("dwarven_miner_gambeson",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(11572859)), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item DWARVEN_MAIL_CHAUSSES = registerArmorPiece("dwarven_mail_chausses",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item DWARVEN_SCALE_HAUBERK = registerArmorPiece("dwarven_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item DWARVEN_SCALE_COAT = registerArmorPiece("dwarven_scale_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item DWARVEN_REINFORCED_BOOTS = registerArmorPiece("dwarven_reinforced_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    //endregion

    //region LONGBEARDS
    public static final Item LONGBEARD_SEGMENTED_HELMET = registerArmorPiece("longbeard_segmented_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BRONZE_T2, settings, ModFactions.LONGBEARDS), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item LONGBEARD_LEATHER_HAUBERK = registerDyeableArmorPiece("longbeard_leather_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.LONGBEARDS), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(5914168)), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item LONGBEARD_PARTISAN_OUTFIT = registerDyeableArmorPiece("longbeard_partisan_outfit",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.LONGBEARDS), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(5914168)), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item EREBOR_BRACED_LEATHER_HELMET = registerDyeableArmorPiece("erebor_braced_leather_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T2, settings, ModSubFactions.EREBOR), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(6309430)), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item EREBOR_MAIL_COIF = registerArmorPiece("erebor_mail_coif",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item EREBOR_MAIL_HAUBERK = registerArmorPiece("erebor_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    public static final Item EREBOR_PADDED_MAIL_HAUBERK = registerDyeableArmorPiece("erebor_padded_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModSubFactions.EREBOR), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(3687263)), ArmorMaterialsME.Tiers.MEDIUM);

    public static final Item EREBOR_MAIL_COAT = registerArmorPiece("erebor_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.IRON_T3, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item EREBOR_MAIL_CHAUSSES = registerArmorPiece("erebor_mail_chausses",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.IRON_T3, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item RAVENHILL_HELMET = registerArmorPiece("ravenhill_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item EREBOR_SCALE_HAUBERK = registerArmorPiece("erebor_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    public static final Item EREBOR_LONG_COAT = registerDyeableArmorPiece("erebor_long_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModSubFactions.EREBOR), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(5914168)), ArmorMaterialsME.Tiers.STURDY);
    public static final Item EREBOR_BRAWLER_CHESTPLATE = registerDyeableArmorPiece("erebor_brawler_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModSubFactions.EREBOR), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(3687263)), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item EREBOR_SCALE_COAT = registerArmorPiece("erebor_scale_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item RAVENHILL_BOOTS = registerArmorPiece("ravenhill_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item EREBOR_GUARD_HELMET = registerArmorPiece("erebor_guard_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item EREBOR_PLATE_CHESTPLATE = registerCustomModelArmorPiece("erebor_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item EREBOR_PLATE_LEGGINGS = registerArmorPiece("erebor_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item EREBOR_PLATE_BOOTS = registerArmorPiece("erebor_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings, ModSubFactions.EREBOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item RAVENHILL_SENTINEL_CHESTPLATE = registerCustomModelArmorPiece("ravenhill_sentinel_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings, ModSubFactions.EREBOR), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.RAVENHILL_SENTINEL_CAPE)), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item EREBOR_GATEWARDEN_CHESTPLATE = registerCustomModelArmorPiece("erebor_gatewarden_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings, ModSubFactions.EREBOR), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.EREBOR_CAPE)), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item EREBOR_CAPE = registerBackAttachment("erebor_cape",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModSubFactions.EREBOR), new Item.Settings()
    ...
    public static final Item ELVEN_ARMING_COAT = registerDyeableArmorPiece("elven_arming_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(4805220)), ArmorMaterialsME.Tiers.BASIC);
    ...
    public static final Item LORIEN_DIADEM = registerCustomModelArmorPiece("lorien_diadem",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BRONZE_T1, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.BASIC);

    public static final Item LORIEN_LEATHER_HELMET = registerCustomModelArmorPiece("lorien_leather_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);

    public static final Item LORIEN_ARMING_COAT = registerArmorPiece("lorien_arming_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);

    public static final Item LORIEN_ARMING_SKIRT = registerArmorPiece("lorien_arming_skirt",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);

    public static final Item LORIEN_MAIL_COIF_DIADEM = registerCustomModelArmorPiece("lorien_mail_coif_diadem",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item LORIEN_MAIL_HAUBERK = registerArmorPiece("lorien_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    public static final Item LORIEN_MARCHWARDEN_MAIL_HAUBERK = registerArmorPiece("lorien_marchwarden_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.LOTHLORIEN), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.LORIEN_MARCHWARDEN_CAPE)), ArmorMaterialsME.Tiers.MEDIUM);

    public static final Item LORIEN_SOLDIER_HELMET = registerCustomModelArmorPiece("lorien_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item LORIEN_SOLDIER_MAIL_HAUBERK = registerArmorPiece("lorien_soldier_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item LORIEN_SCALE_COAT = registerArmorPiece("lorien_scale_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item GALADHRIM_HELMET = registerCustomModelArmorPiece("galadhrim_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings, ModFactions.LOTHLORIEN), new Item.Settings()
                    .component(DataComponentTypesME.HELMET_ATTACHMENT_DATA, HelmetAttachmentDataComponent.newHelmetAttachment(HelmetAttachmentsME.GALADHRIM_HOOD)), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item GALADHRIM_CHESTPLATE = registerArmorPiece("galadhrim_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings, ModFactions.LOTHLORIEN), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.GALADHRIM_CAPE)), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item GALADHRIM_LEGGINGS = registerArmorPiece("galadhrim_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item GALADHRIM_BOOTS = registerArmorPiece("galadhrim_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);

    public static final Item GALADHRIM_LORD_HELMET = registerCustomModelArmorPiece("galadhrim_lord_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings, ModFactions.LOTHLORIEN), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item GALADHRIM_LORD_CHESTPLATE = registerArmorPiece("galadhrim_lord_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings, ModFactions.LOTHLORIEN), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.GALADHRIM_LORD_SURCOAT)), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item LORIEN_MARCHWARDEN_HOOD = registerHelmetAttachment("lorien_marchwarden_hood",
            (settings) -> new HelmetAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.LOTHLORIEN), new Item.Settings()
    ...
    public static final Item LORIEN_MARCHWARDEN_CAPE = registerBackAttachment("lorien_marchwarden_cape",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.LOTHLORIEN), new Item.Settings()
    ...
    public static final Item LORIEN_HORSE_ARMOR = registerGeneratedItem("lorien_horse_armor",
            (settings) -> new CustomHorseArmorItem(ArmorMaterialsME.LORIEN_HORSE_ARMOR.material(), settings, ModFactions.LOTHLORIEN), new Item.Settings().maxCount(1));
    //endregion
    //endregion
    ...
    public static final Item ORCISH_LEATHER_STRAP = registerDyeableArmorPiece("orcish_leather_strap",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T1, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(4865076)), ArmorMaterialsME.Tiers.BASIC);
    ...
    public static final Item ORCISH_LEATHER_CHESTPLATE = registerDyeableArmorPiece("orcish_leather_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(4865076)), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item RUSTED_ORCISH_MAIL_HAUBERK = registerArmorPiece("rusted_orcish_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T2, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item RUSTED_ORCISH_MAIL_COAT = registerArmorPiece("rusted_orcish_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.IRON_T2, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item ORCISH_REINFORCED_LEATHER_SKIRT = registerDyeableArmorPiece("orcish_reinforced_leather_skirt",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.IRON_T3, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(4865076)), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item ORCISH_SALLET = registerCustomModelArmorPiece("orcish_sallet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item ORCISH_BELLY_PLATE_CHESTPLATE = registerDyeableArmorPiece("orcish_belly_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.NONE), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(4865076)), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item ORCISH_REINFORCED_LEG_BRACER = registerArmorPiece("orcish_reinforced_leg_bracer",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.NONE), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item RUSTED_MORDOR_HELMET = registerArmorPiece("rusted_mordor_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T2, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item MORDOR_LEATHER_CUIRASS = registerDyeableArmorPiece("mordor_leather_cuirass",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.MORDOR), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(5186845)), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item MORDOR_HELMET = registerArmorPiece("mordor_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T3, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item RUSTED_MORDOR_CREST_HELMET = registerCustomModelArmorPiece("rusted_mordor_crest_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T3, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item RUSTED_MORDOR_CHESTPLATE = registerArmorPiece("rusted_mordor_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T3, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    public static final Item RUSTED_MORDOR_CUIRASS = registerDyeableArmorPiece("rusted_mordor_cuirass",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T3, settings, ModFactions.MORDOR), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(5186845)), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item RUSTED_MORDOR_PLATE_BOOTS = registerArmorPiece("rusted_mordor_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.BURZUM_STEEL_T3, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);

    public static final Item MORDOR_CREST_HELMET = registerCustomModelArmorPiece("mordor_crest_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item MORDOR_CHESTPLATE = registerArmorPiece("mordor_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    public static final Item MORDOR_CUIRASS = registerDyeableArmorPiece("mordor_cuirass",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.MORDOR), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(5186845)), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item MORDOR_SCALE_COAT = registerArmorPiece("mordor_scale_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item MORDOR_PLATE_BOOTS = registerArmorPiece("mordor_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item MORDOR_GREAT_HELMET = registerCustomModelArmorPiece("mordor_great_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item BLACK_URUK_PLATE_CHESTPLATE = registerCustomModelArmorPiece("black_uruk_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item BLACK_URUK_PLATE_LEGGINGS = registerArmorPiece("black_uruk_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item BLACK_URUK_PLATE_BOOTS = registerArmorPiece("black_uruk_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item BLACK_URUK_COMMANDER_HELMET = registerArmorPiece("black_uruk_commander_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings()
                    .component(DataComponentTypesME.HELMET_ATTACHMENT_DATA, HelmetAttachmentDataComponent.newHelmetAttachment(HelmetAttachmentsME.SKULL)), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item MORDOR_BLACK_NUMENOREAN_PLATE_HELMET = registerCustomModelArmorPiece("mordor_black_numenorean_plate_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModSubFactions.MORDOR_BLACK_NUMENOREANS), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item MORDOR_BLACK_NUMENOREAN_PLATE_CHESTPLATE = registerCustomModelArmorPiece("mordor_black_numenorean_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModSubFactions.MORDOR_BLACK_NUMENOREANS), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.MORDOR_BLACK_NUMENOREAN_CAPE)), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item MORDOR_BLACK_NUMENOREAN_PLATE_LEGGINGS = registerArmorPiece("mordor_black_numenorean_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModSubFactions.MORDOR_BLACK_NUMENOREANS), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item MORDOR_BLACK_NUMENOREAN_PLATE_BOOTS = registerArmorPiece("mordor_black_numenorean_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModSubFactions.MORDOR_BLACK_NUMENOREANS), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);

    public static final Item MORDOR_BLACK_NUMENOREAN_CAPE = registerBackAttachment("mordor_black_numenorean_cape",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModSubFactions.MORDOR_BLACK_NUMENOREANS), new Item.Settings()
    ...
    public static final Item NAZGUL_HOOD = registerHelmetAttachment("nazgul_hood",
            (settings) -> new HelmetAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.MORDOR), new Item.Settings()
    ...
    public static final Item NAZGUL_ROBES = registerBackAttachment("nazgul_robes",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.MORDOR), new Item.Settings()
    ...
    public static final Item RINGWRAITH_MAIL_HAUBERK = registerArmorPiece("ringwraith_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item RINGWRAITH_LEGGINGS = registerArmorPiece("ringwraith_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item RINGWRAITH_BOOTS = registerArmorPiece("ringwraith_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.MORDOR), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    //endregion

    //region ISENGARD
    public static final Item URUK_HAI_LEATHER_SCOUT_CAP = registerCustomModelArmorPiece("uruk_hai_leather_scout_cap",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);

    public static final Item URUK_HAI_LEATHER_CHESTPLATE = registerArmorPiece("uruk_hai_leather_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item URUK_HAI_BOOTS = registerArmorPiece("uruk_hai_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.LEATHER_T2, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.LIGHT);

    public static final Item URUK_HAI_LIGHT_HELMET = registerCustomModelArmorPiece("uruk_hai_light_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T3, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item URUK_HAI_MAIL_HAUBERK = registerArmorPiece("uruk_hai_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.CRUDE_T3, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);

    public static final Item URUK_HAI_MAIL_COAT = registerArmorPiece("uruk_hai_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.CRUDE_T3, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item URUK_HAI_SOLDIER_HELMET = registerCustomModelArmorPiece("uruk_hai_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item URUK_HAI_CUIRASS = registerArmorPiece("uruk_hai_cuirass",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.STURDY);

    public static final Item URUK_HAI_PLATE_HELMET = registerCustomModelArmorPiece("uruk_hai_plate_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item URUK_HAI_PLATE_CHESTPLATE = registerCustomModelArmorPiece("uruk_hai_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item URUK_HAI_PLATE_LEGGINGS = registerArmorPiece("uruk_hai_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item URUK_HAI_PLATE_BOOTS = registerArmorPiece("uruk_hai_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);

    public static final Item ORTHANC_GUARD_HELMET = registerCustomModelArmorPiece("orthanc_guard_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item ORTHANC_GUARD_CHESTPLATE = registerArmorPiece("orthanc_guard_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ORTHANC_GUARD_CAPE)), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item ORTHANC_GUARD_LEGGINGS = registerArmorPiece("orthanc_guard_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item ORTHANC_GUARD_BOOTS = registerArmorPiece("orthanc_guard_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ISENGARD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);

    public static final Item ORTHANC_GUARD_CAPE = registerBackAttachment("orthanc_guard_cape",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0, ModFactions.ISENGARD), new Item.Settings()
    ...
    public static final Item GUNDABAD_BONE_PAULDRON = registerDyeableArmorPiece("gundabad_bone_pauldron",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T1, settings, ModSubFactions.GUNDABAD), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(3944757)), ArmorMaterialsME.Tiers.BASIC);
    ...
    public static final Item GUNDABAD_SEEKER_HELMET = registerDyeableCustomModelArmorPiece("gundabad_seeker_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T2, settings, ModSubFactions.GUNDABAD), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(3944757)), ArmorMaterialsME.Tiers.LIGHT);
    ...
    public static final Item GUNDABAD_SKULLCAP_HELMET = registerDyeableCustomModelArmorPiece("gundabad_skullcap_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T3, settings, ModSubFactions.GUNDABAD), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(3944757)), ArmorMaterialsME.Tiers.MEDIUM);
    public static final Item GUNDABAD_MAIL_COIF = registerArmorPiece("gundabad_mail_coif",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T3, settings, ModSubFactions.GUNDABAD), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);

    public static final Item GUNDABAD_MAIL_HAUBERK = registerArmorPiece("gundabad_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.CRUDE_T3, settings, ModSubFactions.GUNDABAD), new Item.Settings(), ArmorMaterialsME.Tiers.MEDIUM);
    ...
    public static final Item GUNDABAD_SCREECHER_HELMET = registerDyeableCustomModelArmorPiece("gundabad_screecher_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings, ModSubFactions.GUNDABAD), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(3944757)), ArmorMaterialsME.Tiers.STURDY);
    ...
    public static final Item GUNDABAD_CAPTAIN_HELMET = registerDyeableCustomModelArmorPiece("gundabad_captain_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModSubFactions.GUNDABAD), new Item.Settings()
                    .component(DataComponentTypesME.DYE_DATA, new CustomDyeableDataComponent(3944757)), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item GUNDABAD_HOBGOBLIN_PLATE_CRESTED_HELMET = registerCustomModelArmorPiece("gundabad_hobgoblin_plate_crested_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModSubFactions.GUNDABAD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    public static final Item GUNDABAD_HOBGOBLIN_PLATE_CHESTPLATE = registerCustomModelArmorPiece("gundabad_hobgoblin_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModSubFactions.GUNDABAD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item GUNDABAD_HOBGOBLIN_MAIL_COAT = registerArmorPiece("gundabad_hobgoblin_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModSubFactions.GUNDABAD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    public static final Item GUNDABAD_HOBGOBLIN_PLATED_BOOTS = registerArmorPiece("gundabad_hobgoblin_plated_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings, ModSubFactions.GUNDABAD), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    //endregion
    ...
    public static final Item WARG_MORDOR_PLATE_ARMOR = registerGeneratedItem("warg_mordor_plate_armor",
            (settings) -> new CustomAnimalArmorItem(ArmorMaterialsME.PLATE, "_mordor", CustomAnimalArmorItem.Type.WARG, false, settings, ModFactions.MORDOR), new Item.Settings());
    public static final Item WARG_GUNDABAD_PLATE_ARMOR = registerGeneratedItem("warg_gundabad_plate_armor",
            (settings) -> new CustomAnimalArmorItem(ArmorMaterialsME.PLATE, "_gundabad", CustomAnimalArmorItem.Type.WARG, false, settings, ModSubFactions.GUNDABAD), new Item.Settings());
    ...
    public static final Item HELMET_OF_HELM_HAMMERHAND = registerCustomModelArmorPiece("helmet_of_helm_hammerhand",
            (settings) -> new CustomArtefactHelmetItem(ArmorMaterialsME.STEEL_T5, settings, ModFactions.ROHAN), new Item.Settings(), ArmorMaterialsME.Tiers.HEAVY);
    ...
    private static Item registerDyeableArmorPiece(String name, Function<Item.Settings, Item> factory, Item.Settings settings, ArmorMaterialsME.Tiers tier) {
        Item item = (Item)factory.apply(settings.registryKey(ModBlocks.keyOfItem(name)));
        ModItemGroups.EQUIPMENT_CONTENTS.add(item.getDefaultStack());
        SimpleDyeableItemModel.items.add(item);
        ...
        if(!isMountArmor) assignArmorTierTag(item, tier);
        return registerItem(item, name);
    }

    private static Item registerArmorPiece(String name, Function<Item.Settings, Item> factory, Item.Settings settings, ArmorMaterialsME.Tiers tier) {
        Item item = (Item)factory.apply(settings.registryKey(ModBlocks.keyOfItem(name)));
        ModItemGroups.EQUIPMENT_CONTENTS.add(item.getDefaultStack());
        assignArmorTierTag(item, tier);
        SimpleItemModel.items.add(item);
        switch (item){
            case CustomHelmetItem helmetItem -> armorPiecesListHelmets.add(helmetItem);
            case CustomChestplateItem chestplateItem -> armorPiecesListChestplates.add(chestplateItem);
    ...
    private static Item registerCustomModelArmorPiece(String name, Function<Item.Settings, Item> factory, Item.Settings settings, ArmorMaterialsME.Tiers tier) {
        Item item = (Item)factory.apply(settings.registryKey(ModBlocks.keyOfItem(name)));
        ModItemGroups.EQUIPMENT_CONTENTS.add(item.getDefaultStack());
        assignArmorTierTag(item, tier);
        SimpleItemModel.items.add(item);
    ...
    private static Item registerDyeableCustomModelArmorPiece(String name, Function<Item.Settings, Item> factory, Item.Settings settings, ArmorMaterialsME.Tiers tier) {
        Item item = (Item)factory.apply(settings.registryKey(ModBlocks.keyOfItem(name)));
        ModItemGroups.EQUIPMENT_CONTENTS.add(item.getDefaultStack());
        assignArmorTierTag(item, tier);
        SimpleDyeableItemModel.items.add(item);
    ...
    private static void assignArmorTierTag(Item item, ArmorMaterialsME.Tiers tier) {
        switch (tier) {
            case CLOTHING, BASIC -> basicArmors.add(item);
            case LIGHT -> lightArmors.add(item);
            case MEDIUM -> mediumArmors.add(item);
            case STURDY -> sturdyArmors.add(item);
            case HEAVY -> heavyArmors.add(item);
        }
    }
