...
public class EquipmentItemsME {
    ...
    public static final Item ROHIRRIC_MILITIA_HELMET = registerArmorPiece("rohirric_militia_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item ROHIRRIC_SOLDIER_HELMET = registerArmorPiece("rohirric_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item ROHIRRIC_SCALE_HAUBERK = registerArmorPiece("rohirric_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item ROHIRRIC_SCALE_JACKET = registerArmorPiece("rohirric_scale_jacket",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));

    public static final Item EORLING_MARSHAL_HELMET = registerCustomModelArmorPiece("eorling_marshal_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item EORLING_MARSHAL_LEGGINGS = registerArmorPiece("eorling_marshal_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    public static final Item EORLING_MARSHAL_BOOTS = registerArmorPiece("eorling_marshal_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
