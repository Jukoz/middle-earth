...
public class EquipmentItemsME {
    ...
    public static final Item GONDORIAN_BOOTS = registerArmorPiece("gondorian_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Settings()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.GONDOR)));
    ...
    public static final Item ROHIRRIC_REINFORCED_COAT = registerDyeableArmorPiece("rohirric_reinforced_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings), new Item.Settings()
                    ...
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    ...
    public static final Item ROHIRRIC_LEATHER_VEST = registerDyeableArmorPiece("rohirric_leather_vest",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Settings()
                    .component(DataComponentTypes.DYED_COLOR, new DyedColorComponent(15256475))
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_CAPE))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)).component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    public static final Item ROHIRRIC_LEATHER_SCALE_VEST = registerDyeableArmorPiece("rohirric_leather_scale_vest",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Settings()
                    .component(DataComponentTypes.DYED_COLOR, new DyedColorComponent(15256475))
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_CAPE)).component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    ...
    public static final Item ROHIRRIC_MILITIA_HELMET = registerArmorPiece("rohirric_militia_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    ...
    public static final Item ROHIRRIC_SOLDIER_HELMET = registerArmorPiece("rohirric_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    ...
    public static final Item ROHIRRIC_SCALE_HAUBERK = registerArmorPiece("rohirric_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    public static final Item ROHIRRIC_ORNAMENTED_SCALE_HAUBERK = registerArmorPiece("rohirric_ornamented_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_ROYAL_GUARD_CAPE)).component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));

    public static final Item ROHIRRIC_SCALE_JACKET = registerArmorPiece("rohirric_scale_jacket",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));

    public static final Item EORLING_MARSHAL_HELMET = registerCustomModelArmorPiece("eorling_marshal_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    public static final Item EORLING_MARSHAL_CHESTPLATE = registerArmorPiece("eorling_marshal_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.EORLING_MARSHAL_CAPE)).component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    public static final Item EORLING_MARSHAL_LEGGINGS = registerArmorPiece("eorling_marshal_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    public static final Item EORLING_MARSHAL_BOOTS = registerArmorPiece("eorling_marshal_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Settings().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    ...
    public static final Item HORSE_LORD_CHESTPLATE = registerArmorPiece("horse_lord_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Settings()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.HORSE_LORD_CAPE)).component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ROHAN)));
    ...
    public static final Item DALISH_ARMING_COAT_BLACK_FUR = registerDyeableArmorPiece("dalish_arming_coat_black_fur",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings), new Item.Settings()
                    ...
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.DALE)));
    ...
    public static final Item LONGBEARD_SEGMENTED_HELMET = registerArmorPiece("longbeard_segmented_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BRONZE_T2, settings), new Item.Settings()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.LONGBEARDS)));
    ...
    public static final Item EREBOR_LEATHER_HELMET = registerDyeableArmorPiece("erebor_leather_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T2, settings), new Item.Settings()
                    .component(DataComponentTypes.DYED_COLOR, new DyedColorComponent(7098174))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.LONGBEARDS_EREBOR)));
    ...
    public static final Item LORIEN_DIADEM = registerCustomModelArmorPiece("lorien_diadem",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BRONZE_T1, settings), new Item.Settings()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.LOTHLORIEN)));
    ...
    public static final Item WOODLAND_REALM_BRONZE_TRIMMED_RANGER_HELMET = registerCustomModelArmorPiece("woodland_realm_bronze_trimmed_ranger_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Settings()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.WOODLAND_REALM)));
    ...
    public static final Item RUSTED_MORDOR_HELMET = registerArmorPiece("rusted_mordor_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T2, settings), new Item.Settings()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.MORDOR)));
    ...
    public static final Item URUK_HAI_LEATHER_SCOUT_CAP = registerCustomModelArmorPiece("uruk_hai_leather_scout_cap",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Settings()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.ISENGARD)));
    ...
    public static final Item GUNDABAD_BONE_PAULDRON = registerDyeableArmorPiece("gundabad_bone_pauldron",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T1, settings), new Item.Settings()
                    ...
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.HOBGOBLIN_TRIBES_GUNDABAD)));
    ...
    public static final Item MORIA_GOBLIN_SNAGA_NASAL_HELMET = registerDyeableCustomModelArmorPiece("moria_goblin_snaga_nasal_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T2, settings), new Item.Settings()
                    ...
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.MORIA)));
    ...
    public static final Item GOBLIN_KING_CROWN = registerCustomModelArmorPiece("goblin_king_crown",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BONE_T0, settings), new Item.Settings()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistryME.GOBLIN_TOWN)));
