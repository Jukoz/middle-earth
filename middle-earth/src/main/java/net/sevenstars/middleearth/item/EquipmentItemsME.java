...
public class EquipmentItemsME {
    ...
    public static final Item HOOD = registerDyeableHelmetAttachment("hood",
            (settings) -> new HelmetAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0), new Item.Properties()
                    ...
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(5394247, true)));
    ...
    public static final Item BLACK_FUR_HOOD = registerDyeableHelmetAttachment("black_fur_hood",
            (settings) -> new HelmetAttachmentItem(settings, ArmorMaterialsME.FUR_T0), new Item.Properties()
    ...
    public static final Item CAPE = registerDyeableBackAttachment("cape",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0), new Item.Properties()
    ...
    public static final Item BLACK_FUR_CLOAK = registerDyeableBackAttachment("black_fur_cloak",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FUR_T0), new Item.Properties()
    ...
    public static final Item BAGGY_HAT = registerCustomModelArmorPiece("baggy_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T1, settings), new Item.Properties());
    public static final Item CHAPERON = registerCustomModelArmorPiece("chaperon",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.FABRIC_T1, settings), new Item.Properties());
    public static final Item GLASSES = registerCustomModelArmorPiece("glasses",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BRONZE_T1, settings), new Item.Properties());
    ...
    public static final Item STRAW_HAT = registerCustomModelArmorPiece("straw_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STRAW_T1, settings), new Item.Properties());

    public static final Item WOVEN_HAT = registerCustomModelArmorPiece("woven_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.WOOL_T1, settings), new Item.Properties());

    public static final Item BYCOCKET = registerDyeableArmorPiece("bycocket",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.WOOL_T1, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(-6265536, true)));

    public static final Item BEEKEEPER_MASK = registerDyeableArmorPiece("beekeeper_mask",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STRAW_T1, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(11246676, true)));
    ...
    public static final Item ARMING_COAT = registerDyeableArmorPiece("arming_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(15256475, true)));

    public static final Item ARMING_SKIRT = registerDyeableArmorPiece("arming_skirt",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.FABRIC_T1, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(15256475, true)));

    public static final Item SHOES = registerArmorPiece("shoes",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.FABRIC_T1, settings), new Item.Properties());
    ...
    public static final Item LEATHER_SKULLCAP = registerDyeableArmorPiece("leather_skullcap",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(-6265536, true)));
    ...
    public static final Item KETTLE_HAT = registerCustomModelArmorPiece("kettle_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T2, settings), new Item.Properties());

    public static final Item BLACKSMITH_APRON = registerArmorPiece("blacksmith_apron",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties());
    ...
    public static final Item STURDY_BOOTS = registerArmorPiece("sturdy_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties());
    ...
    public static final Item COOKING_POT_HELMET = registerCustomModelArmorPiece("cooking_pot_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings), new Item.Properties());
    ...
    public static final Item MAIL_HAUBERK = registerArmorPiece("mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings), new Item.Properties());
    ...
    public static final Item MAIL_SKIRT = registerArmorPiece("mail_skirt",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.IRON_T3, settings), new Item.Properties());

    public static final Item SALLET = registerCustomModelArmorPiece("sallet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Properties());
    //endregion

    //region HOBBITS
    public static final Item SHIRRIFF_HAT = registerDyeableCustomModelArmorPiece("shirriff_hat",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T1, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(3440180, true)));
    //endregion
    ...
    public static final Item GONDORIAN_BOOTS = registerArmorPiece("gondorian_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    ...
    public static final Item GONDORIAN_SOLDIER_CHESTPLATE = registerArmorPiece("gondorian_soldier_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));

    public static final Item GONDORIAN_PLATE_HELMET = registerCustomModelArmorPiece("gondorian_plate_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    public static final Item GONDORIAN_PLATE_CHESTPLATE = registerCustomModelArmorPiece("gondorian_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    public static final Item GONDORIAN_PLATE_LEGGINGS = registerArmorPiece("gondorian_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    public static final Item GONDORIAN_PLATE_BOOTS = registerArmorPiece("gondorian_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    ...
    public static final Item GONDORIAN_HORSE_ARMOR = registerGeneratedItem("gondorian_horse_armor",
            (settings) -> new AnimalArmorItem(ArmorMaterialsME.GONDORIAN_HORSE_ARMOR.material(),
                    AnimalArmorItem.BodyType.EQUESTRIAN, false, settings), new Item.Properties().stacksTo(1)
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    //endregion
    ...
    public static final Item ROHIRRIC_REINFORCED_COAT = registerDyeableArmorPiece("rohirric_reinforced_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings), new Item.Properties()
                    ...
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item ROHIRRIC_LEATHER_VEST = registerDyeableArmorPiece("rohirric_leather_vest",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(15256475, true))
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_CAPE))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)).component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    public static final Item ROHIRRIC_LEATHER_SCALE_VEST = registerDyeableArmorPiece("rohirric_leather_scale_vest",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(15256475, true))
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_CAPE)).component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item ROHIRRIC_MILITIA_HELMET = registerArmorPiece("rohirric_militia_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T3, settings), new Item.Properties().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item ROHIRRIC_SOLDIER_HELMET = registerArmorPiece("rohirric_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Properties().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item ROHIRRIC_SCALE_HAUBERK = registerArmorPiece("rohirric_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Properties().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    public static final Item ROHIRRIC_ORNAMENTED_SCALE_HAUBERK = registerArmorPiece("rohirric_ornamented_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Properties()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.ROHIRRIC_ROYAL_GUARD_CAPE)).component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));

    public static final Item ROHIRRIC_SCALE_JACKET = registerArmorPiece("rohirric_scale_jacket",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Properties().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));

    public static final Item EORLING_MARSHAL_HELMET = registerCustomModelArmorPiece("eorling_marshal_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Properties().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    public static final Item EORLING_MARSHAL_CHESTPLATE = registerArmorPiece("eorling_marshal_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.EORLING_MARSHAL_CAPE)).component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    public static final Item EORLING_MARSHAL_LEGGINGS = registerArmorPiece("eorling_marshal_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Properties().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    public static final Item EORLING_MARSHAL_BOOTS = registerArmorPiece("eorling_marshal_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Properties().component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item HORSE_LORD_CHESTPLATE = registerArmorPiece("horse_lord_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.BACK_ATTACHMENT_DATA, BackAttachmentDataComponent.newBackAttachment(BackAttachmentsME.HORSE_LORD_CAPE)).component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item ROHIRRIC_HORSE_ARMOR = registerGeneratedItem("rohirric_horse_armor",
            (settings) -> new AnimalArmorItem(ArmorMaterialsME.ROHIRRIC_HORSE_ARMOR.material(),
                    AnimalArmorItem.BodyType.EQUESTRIAN, false, settings), new Item.Properties().stacksTo(1)
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    //endregion
    ...
    public static final Item DALISH_ARMING_COAT_BLACK_FUR = registerDyeableArmorPiece("dalish_arming_coat_black_fur",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(7296407, true))
    ...
    public static final Item DALISH_HEYDAY_MAIL_COAT = registerArmorPiece("dalish_heyday_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.DALE)));
    public static final Item DALISH_HEYDAY_BOOTS = registerArmorPiece("dalish_heyday_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.STEEL_T4, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.DALE)));
    ...
    public static final Item DALISH_HORSE_ARMOR = registerGeneratedItem("dalish_horse_armor",
            (settings) -> new AnimalArmorItem(ArmorMaterialsME.DALISH_HORSE_ARMOR.material(),
                    AnimalArmorItem.BodyType.EQUESTRIAN, false, settings), new Item.Properties().stacksTo(1)
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.DALE)));
    //endregion
    ...
    public static final Item DWARVEN_MINER_HELMET = registerDyeableCustomModelArmorPiece("dwarven_miner_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(7098174, true)));

    public static final Item DWARVEN_GAMBESON = registerDyeableArmorPiece("dwarven_gambeson",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(11572859, true)));
    ...
    public static final Item DWARVEN_MAIL_CHAUSSES = registerArmorPiece("dwarven_mail_chausses",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.IRON_T3, settings), new Item.Properties());
    ...
    public static final Item DWARVEN_SCALE_HAUBERK = registerArmorPiece("dwarven_scale_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings), new Item.Properties());

    public static final Item DWARVEN_SCALE_COAT = registerArmorPiece("dwarven_scale_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings), new Item.Properties());

    public static final Item DWARVEN_REINFORCED_BOOTS = registerArmorPiece("dwarven_reinforced_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings), new Item.Properties());
    //endregion

    //region LONGBEARDS
    public static final Item LONGBEARD_SEGMENTED_HELMET = registerArmorPiece("longbeard_segmented_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BRONZE_T2, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS)));

    public static final Item LONGBEARD_LEATHER_HAUBERK = registerDyeableArmorPiece("longbeard_leather_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(5914168, true))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS)));
    ...
    public static final Item LONGBEARD_LEATHER_LEGGINGS = registerDyeableArmorPiece("longbeard_leather_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(5914168, true))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS)));
    ...
    public static final Item EREBOR_LEATHER_HELMET = registerDyeableArmorPiece("erebor_leather_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(7098174, true))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    public static final Item EREBOR_BRACED_LEATHER_HELMET = registerDyeableArmorPiece("erebor_braced_leather_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.IRON_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(6309430, true))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    ...
    public static final Item EREBOR_PADDED_MAIL_HAUBERK = registerDyeableArmorPiece("erebor_padded_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T3, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(3687263, true))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    ...
    public static final Item RAVENHILL_HELMET = registerArmorPiece("ravenhill_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.DWARVEN_STEEL_T4, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    ...
    public static final Item EREBOR_GUARD_HELMET = registerArmorPiece("erebor_guard_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    ...
    public static final Item EREBOR_PLATE_CHESTPLATE = registerCustomModelArmorPiece("erebor_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    public static final Item EREBOR_PLATE_LEGGINGS = registerArmorPiece("erebor_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    public static final Item EREBOR_PLATE_BOOTS = registerArmorPiece("erebor_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.DWARVEN_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    ...
    public static final Item BROADHOOF_GOAT_PADDED_ARMOR = registerDyeableArmorPiece("broadhoof_goat_leather_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.BROADHOOF_GOAT_LEATHER_ARMOR, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    ...
    public static final Item BROADHOOF_GOAT_ORNAMENTED_PADDED_ARMOR = registerDyeableArmorPiece("broadhoof_goat_ornamented_leather_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.BROADHOOF_GOAT_ORNAMENTED_LEATHER_ARMOR, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    public static final Item BROADHOOF_GOAT_PLATE_ARMOR = registerGeneratedItem("broadhoof_goat_plate_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.BROADHOOF_GOAT_PLATE_ARMOR, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    //endregion
    //endregion
    ...
    public static final Item ELVEN_ARMING_COAT = registerDyeableArmorPiece("elven_arming_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(4805220, true)));
    ...
    public static final Item BRONZED_ELVEN_MAIL_HAUBERK = registerArmorPiece("bronzed_elven_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BRONZE_T2, settings), new Item.Properties());

    public static final Item BRONZED_ELVEN_MAIL_SKIRT = registerArmorPiece("bronzed_elven_mail_skirt",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.BRONZE_T2, settings), new Item.Properties());
    ...
    public static final Item MANTLE_OF_YAVANNA = registerDyeableBackAttachment("mantle_of_yavanna",
            (settings) -> new MantleOfYavannaItem(settings, ArmorMaterialsME.FABRIC_T0), new Item.Properties().rarity(Rarity.EPIC)
                    ...
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(0x375729, true)));
    public static final Item GREAT_HORN_LIGHT_ARMOR = registerDyeableArmorPiece("great_horn_light_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.GREAT_HORN_LIGHT_ARMOR, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(3879204, true)));
    public static final Item GREAT_HORN_LIGHT_GRAY_ARMOR = registerDyeableArmorPiece("great_horn_light_gray_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.GREAT_HORN_LIGHT_GRAY_ARMOR, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(5464949, true)));
    public static final Item GREAT_HORN_LIGHT_GREEN_ARMOR = registerDyeableArmorPiece("great_horn_light_green_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.GREAT_HORN_LIGHT_GREEN_ARMOR, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(3491893, true)));
    public static final Item GREAT_HORN_PLATE_ARMOR = registerGeneratedItem("great_horn_plate_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.GREAT_HORN_PLATE_ARMOR, settings), new Item.Properties());
    public static final Item GREAT_HORN_ORNAMENTED_PLATE_ARMOR = registerGeneratedItem("great_horn_ornamented_plate_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.GREAT_HORN_ORNAMENTED_PLATE_ARMOR, settings), new Item.Properties());
    public static final Item GREAT_HORN_GREEN_PLATE_ARMOR = registerGeneratedItem("great_horn_green_plate_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.GREAT_HORN_GREEN_PLATE_ARMOR, settings), new Item.Properties());
    //endregion
    ...
    public static final Item LORIEN_SOLDIER_HELMET = registerCustomModelArmorPiece("lorien_soldier_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)));

    public static final Item LORIEN_SOLDIER_MAIL_HAUBERK = registerArmorPiece("lorien_soldier_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)));
    ...
    public static final Item LORIEN_SCALE_COAT = registerArmorPiece("lorien_scale_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)));

    public static final Item GALADHRIM_HELMET = registerCustomModelArmorPiece("galadhrim_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings), new Item.Properties()
    ...
    public static final Item GALADHRIM_CHESTPLATE = registerArmorPiece("galadhrim_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings), new Item.Properties()
    ...
    public static final Item GALADHRIM_LEGGINGS = registerArmorPiece("galadhrim_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)));
    public static final Item GALADHRIM_BOOTS = registerArmorPiece("galadhrim_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)));

    public static final Item EGLADIL_SENTINEL_HELMET = registerDyeableCustomModelArmorPiece("egladil_sentinel_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(0x564469, true))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)));
    public static final Item EGLADIL_SENTINEL_CHESTPLATE = registerDyeableArmorPiece("egladil_sentinel_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(0x6171AE, true))
    ...
    public static final Item LORIEN_HORSE_ARMOR = registerGeneratedItem("lorien_horse_armor",
            (settings) -> new AnimalArmorItem(ArmorMaterialsME.LORIEN_HORSE_ARMOR.material(),
                    AnimalArmorItem.BodyType.EQUESTRIAN, false, settings), new Item.Properties().stacksTo(1)
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)));
    //endregion
    ...
    public static final Item WOODLAND_REALM_ARMING_COAT = registerDyeableArmorPiece("woodland_realm_arming_coat",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.FABRIC_T1, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(0x4a5110, true)));
    ...
    public static final Item WOODLAND_REALM_CAVALRY_HELMET = registerDyeableCustomModelArmorPiece("woodland_realm_cavalry_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.WOODLAND_REALM))
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(0x515638, true)));
    ...
    public static final Item WOODLAND_REALM_ROYAL_GUARD_HELMET = registerDyeableCustomModelArmorPiece("woodland_realm_royal_guard_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.ELVEN_STEEL_T4, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.WOODLAND_REALM))
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(0x532e29, true)));
    ...
    public static final Item WARDEN_OF_THE_GLADE_HELMET = registerDyeableCustomModelArmorPiece("warden_of_the_glade_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.ELVEN_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.WOODLAND_REALM))
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(0x5c5445, true)));
    ...
    public static final Item WOODLAND_REALM_CROWN = registerCustomModelArmorPiece("woodland_realm_crown",
            (settings) -> new WoodlandRealmCrownItem(ArmorMaterialsME.WOOD_T1, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.WOODLAND_REALM))
    ...
    public static final Item ORCISH_LEATHER_STRAP = registerDyeableArmorPiece("orcish_leather_strap",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T1, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(4865076, true)));
    ...
    public static final Item RUSTED_ORCISH_MAIL_HAUBERK = registerArmorPiece("rusted_orcish_mail_hauberk",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.IRON_T2, settings), new Item.Properties());
    ...
    public static final Item RUSTED_ORCISH_MAIL_COAT = registerArmorPiece("rusted_orcish_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.IRON_T2, settings), new Item.Properties());
    ...
    public static final Item ORCISH_SALLET = registerCustomModelArmorPiece("orcish_sallet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings), new Item.Properties());

    public static final Item ORCISH_BELLY_PLATE_CHESTPLATE = registerDyeableArmorPiece("orcish_belly_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(4865076, true)));
    ...
    public static final Item ORCISH_REINFORCED_LEG_BRACER = registerArmorPiece("orcish_reinforced_leg_bracer",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings), new Item.Properties());

    public static final Item ORCISH_BRACED_SANDALS = registerDyeableArmorPiece("orcish_braced_sandals",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.BURZUM_STEEL_T4, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(4865076, true)));
    ...
    public static final Item ORCISH_SHOULDERS = registerDyeableBackAttachment("orcish_shoulders",
            (settings) -> new BackAttachmentItem(settings, ArmorMaterialsME.FABRIC_T0), new Item.Properties()
                    ...
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(5186845, true)));
    ...
    public static final Item WARG_LEATHER_ARMOR = registerDyeableArmorPiece("warg_leather_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.WARG_LEATHER_ARMOR, settings), new Item.Properties());

    public static final Item WARG_REINFORCED_LEATHER_ARMOR = registerDyeableArmorPiece("warg_reinforced_leather_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.WARG_REINFORCED_LEATHER_ARMOR, settings), new Item.Properties());
    //endregion

    //region MORDOR
    public static final Item RUSTED_MORDOR_HELMET = registerArmorPiece("rusted_mordor_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T2, settings), new Item.Properties()
    ...
    public static final Item MORDOR_HELMET = registerArmorPiece("mordor_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T3, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    ...
    public static final Item RUSTED_MORDOR_CREST_HELMET = registerCustomModelArmorPiece("rusted_mordor_crest_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T3, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    ...
    public static final Item RUSTED_MORDOR_CHESTPLATE = registerArmorPiece("rusted_mordor_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T3, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    ...
    public static final Item RUSTED_MORDOR_PLATE_BOOTS = registerArmorPiece("rusted_mordor_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.BURZUM_STEEL_T3, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    ...
    public static final Item MORDOR_GREAT_HELMET = registerCustomModelArmorPiece("mordor_great_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    ...
    public static final Item BLACK_URUK_PLATE_CHESTPLATE = registerCustomModelArmorPiece("black_uruk_plate_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    public static final Item BLACK_URUK_PLATE_LEGGINGS = registerArmorPiece("black_uruk_plate_leggings",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    public static final Item BLACK_URUK_PLATE_BOOTS = registerArmorPiece("black_uruk_plate_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    ...
    public static final Item WARG_MORDOR_MAIL_ARMOR = registerDyeableArmorPiece("warg_mordor_mail_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.WARG_MORDOR_MAIL_ARMOR, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));

    public static final Item WARG_MORDOR_PLATE_ARMOR = registerGeneratedItem("warg_mordor_plate_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.WARG_MORDOR_PLATE_ARMOR, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));


    //region DOL GULDUR
    public static final Item DOL_GULDUR_JAILER_COLLAR = registerArmorPiece("dol_guldur_jailer_collar",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T1, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    ...
    public static final Item DOL_GULDUR_EXECUTIONER_CHESTPLATE = registerArmorPiece("dol_guldur_executioner_chestplate",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.CRUDE_T3, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    ...
    public static final Item DOL_GULDUR_STALKER_HELMET = registerDyeableCustomModelArmorPiece("dol_guldur_stalker_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BURZUM_STEEL_T5, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(0x3D3232, true))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)));
    ...
    public static final Item URUK_HAI_LEATHER_SCOUT_CAP = registerCustomModelArmorPiece("uruk_hai_leather_scout_cap",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.LEATHER_T2, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ISENGARD)));
    ...
    public static final Item URUK_HAI_MAIL_COAT = registerArmorPiece("uruk_hai_mail_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.CRUDE_T3, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ISENGARD)));
    ...
    public static final Item GUNDABAD_BONE_PAULDRON = registerDyeableArmorPiece("gundabad_bone_pauldron",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.LEATHER_T1, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(3944757, true))
    ...
    public static final Item WARG_GUNDABAD_PLATE_ARMOR = registerGeneratedItem("warg_gundabad_plate_armor",
            (settings) -> new MountArmorItem(ArmorMaterialsME.WARG_GUNDABAD_PLATE_ARMOR, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.HOBGOBLIN_TRIBES_GUNDABAD)));
    //endregion
    ...
    public static final Item MORIA_GOBLIN_SNAGA_NASAL_HELMET = registerDyeableCustomModelArmorPiece("moria_goblin_snaga_nasal_helmet",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.CRUDE_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(0x441E17, true))
    ...
    public static final Item MORIA_GOBLIN_SNAGA_CUIRASS = registerCustomModelArmorPiece("moria_goblin_snaga_cuirass",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.CRUDE_T2, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORIA)));
    ...
    public static final Item MORIA_GOBLIN_CLOTH_COAT = registerDyeableArmorPiece("moria_goblin_cloth_coat",
            (settings) -> new CustomLeggingsItem(ArmorMaterialsME.CRUDE_T2, settings), new Item.Properties()
                    .component(DataComponents.DYED_COLOR, new DyedItemColor(0x441E17, true))
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORIA)));
    ...
    public static final Item MORIA_GOBLIN_CRUDE_BOOTS = registerArmorPiece("moria_goblin_crude_boots",
            (settings) -> new CustomBootsItem(ArmorMaterialsME.CRUDE_T2, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORIA)));
    ...
    public static final Item GOBLIN_KING_CROWN = registerCustomModelArmorPiece("goblin_king_crown",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BONE_T0, settings), new Item.Properties()
    ...
    public static final Item GOBLIN_TOWN_BONE_MANDIBLE_CAP = registerCustomModelArmorPiece("goblin_town_bone_mandible_cap",
            (settings) -> new CustomHelmetItem(ArmorMaterialsME.BONE_T1, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GOBLIN_TOWN)));
    ...
    public static final Item GOBLIN_TOWN_BONE_STRAP = registerArmorPiece("goblin_town_bone_strap",
            (settings) -> new CustomChestplateItem(ArmorMaterialsME.BONE_T1, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GOBLIN_TOWN)));
    ...
    public static final Item HELMET_OF_HELM_HAMMERHAND = registerCustomModelArmorPiece("helmet_of_helm_hammerhand",
            (settings) -> new CustomArtefactHelmetItem(ArmorMaterialsME.STEEL_T5, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN))
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("helmet_of_helm_hammerhand")));

    private static Item registerHelmetAttachment(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.EQUIPMENT_CONTENTS.add(item.getDefaultInstance());
        SimpleItemModel.items.add(item);
        helmetAttachments.add(item);
        return registerItem(item, name);
    }

    private static Item registerDyeableHelmetAttachment(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.EQUIPMENT_CONTENTS.add(item.getDefaultInstance());
    ...
    private static Item registerBackAttachment(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.EQUIPMENT_CONTENTS.add(item.getDefaultInstance());
        SimpleItemModel.items.add(item);
    ...
    private static Item registerDyeableBackAttachment(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.EQUIPMENT_CONTENTS.add(item.getDefaultInstance());
        SimpleDyeableItemModel.items.add(item);
        backAttachments.add(item);
    ...
    private static Item registerGeneratedItem(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.EQUIPMENT_CONTENTS.add(item.getDefaultInstance());
        SimpleItemModel.items.add(item);
        return registerItem(item, name);
    ...
    private static Item registerDyeableArmorPiece(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.EQUIPMENT_CONTENTS.add(item.getDefaultInstance());
        SimpleDyeableItemModel.items.add(item);
        switch (item){
    ...
    private static Item registerArmorPiece(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.EQUIPMENT_CONTENTS.add(item.getDefaultInstance());
        SimpleItemModel.items.add(item);
        switch (item){
    ...
    private static Item registerCustomModelArmorPiece(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.EQUIPMENT_CONTENTS.add(item.getDefaultInstance());
        SimpleItemModel.items.add(item);
        return registerItem(item, name);
    ...
    private static Item registerDyeableCustomModelArmorPiece(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.EQUIPMENT_CONTENTS.add(item.getDefaultInstance());
        SimpleDyeableItemModel.items.add(item);
        return registerItem(item, name);
    ...
    private static Item registerItem(Item item, String name){
        ...
        if (item instanceof ArmorItem armorItem){
            ...
            switch (armorItem.getExtendedMaterial().tier()){
            ...
            Map<net.minecraft.world.item.ArmorItem.Type, Integer> defensePointsMap =
                    armorItem.getExtendedMaterial().defense();

            switch (item){
                case CustomHelmetItem helmetItem -> {
                    ArmorTags.headArmors.add(helmetItem);
                    if(defensePointsMap.get(net.minecraft.world.item.ArmorItem.Type.HELMET) < 3) ArmorTags.incompleteArmors.add(item);
                }
                case CustomChestplateItem chestplateItem -> {
                    ArmorTags.chestArmors.add(chestplateItem);
                    if(defensePointsMap.get(net.minecraft.world.item.ArmorItem.Type.CHESTPLATE) < 8) ArmorTags.incompleteArmors.add(item);
                }
                case CustomLeggingsItem leggingsItem -> {
                    ArmorTags.legArmors.add(leggingsItem);
                    if(defensePointsMap.get(net.minecraft.world.item.ArmorItem.Type.LEGGINGS) < 6) ArmorTags.incompleteArmors.add(item);
                }
                case CustomBootsItem bootsItem -> {
                    ArmorTags.footArmors.add(bootsItem);
                    if(defensePointsMap.get(net.minecraft.world.item.ArmorItem.Type.BOOTS) < 3) ArmorTags.incompleteArmors.add(item);
                }
                default -> {}
            }
