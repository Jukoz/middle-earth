...
public class WeaponItemsME {
    ...
    public static final Item WOODEN_DAGGER = registerItemWithModel("wooden_dagger",
            (settings) -> new CustomDaggerWeaponItem(Tiers.WOOD, settings), new Item.Properties(), false);
    public static final Item WOODEN_SPEAR = registerItemWithSpearModel("wooden_spear",
            (settings) -> new CustomSpearWeaponItem(Tiers.WOOD, settings), new Item.Properties());

    public static final Item STONE_DAGGER = registerItemWithModel("stone_dagger",
            (settings) -> new CustomDaggerWeaponItem(Tiers.STONE, settings), new Item.Properties(), false);
    public static final Item STONE_SPEAR = registerItemWithSpearModel("stone_spear",
            (settings) -> new CustomSpearWeaponItem(Tiers.STONE, settings), new Item.Properties());

    public static final Item BONE_CLEAVER = registerItemWithModel("bone_cleaver",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.BONE, settings), new Item.Properties(), true);
    public static final Item BONE_SCIMITAR = registerItemWithModel("bone_scimitar",
            (settings) -> new CustomLongswordWeaponItem(ToolMaterialsME.BONE, settings), new Item.Properties(), true);
    public static final Item BONE_SHANK = registerItemWithModel("bone_shank",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.BONE, settings), new Item.Properties(), false);
    public static final Item BONE_AXE = registerItemWithModel("bone_axe",
            (settings) -> new CustomAxeWeaponItem(ToolMaterialsME.BONE, settings), new Item.Properties(), true);
    public static final Item BONE_SPEAR = registerItemWithSpearModel("bone_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterialsME.BONE, settings), new Item.Properties());

    public static final Item BRONZE_SWORD = registerItemWithModel("bronze_sword",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.BRONZE, settings), new Item.Properties(), true);
    public static final Item BRONZE_DAGGER = registerItemWithModel("bronze_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.BRONZE, settings), new Item.Properties(), false);
    public static final Item BRONZE_SPEAR = registerItemWithSpearModel("bronze_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterialsME.BRONZE, settings), new Item.Properties());

    public static final Item CRUDE_FALCHION = registerItemWithModel("crude_falchion",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.CRUDE, settings), new Item.Properties(), true);
    public static final Item CRUDE_LONGBLADE = registerItemWithModel("crude_longblade",
            (settings) -> new CustomLongswordWeaponItem(ToolMaterialsME.CRUDE, settings), new Item.Properties(), true);
    public static final Item CRUDE_DAGGER = registerItemWithModel("crude_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.CRUDE, settings), new Item.Properties(), false);
    public static final Item CRUDE_SPEAR = registerItemWithSpearModel("crude_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterialsME.CRUDE, settings), new Item.Properties());

    public static final Item IRON_DAGGER = registerItemWithModel("iron_dagger",
            (settings) -> new CustomDaggerWeaponItem(Tiers.IRON, settings), new Item.Properties(), false);
    public static final Item IRON_SPEAR = registerItemWithSpearModel("iron_spear",
            (settings) -> new CustomSpearWeaponItem(Tiers.IRON, settings), new Item.Properties());
    ...
    public static final Item STEEL_SPEAR = registerItemWithSpearModel("steel_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties());

    public static final Item BURZUM_STEEL_SWORD = registerItemWithModel("burzum_steel_sword",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties(), true);
    public static final Item BURZUM_STEEL_SPEAR = registerItemWithSpearModel("burzum_steel_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties());

    public static final Item EDHEL_STEEL_SWORD = registerItemWithModel("edhel_steel_sword",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.EDHEL_STEEL, settings), new Item.Properties(), true);
    public static final Item EDHEL_STEEL_SPEAR = registerItemWithSpearModel("edhel_steel_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterialsME.EDHEL_STEEL, settings), new Item.Properties());

    public static final Item KHAZAD_STEEL_SWORD = registerItemWithModel("khazad_steel_sword",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.KHAZAD_STEEL, settings), new Item.Properties(), true);
    public static final Item KHAZAD_STEEL_SPEAR = registerItemWithSpearModel("khazad_steel_spear",
            (settings) -> new CustomSpearWeaponItem(ToolMaterialsME.KHAZAD_STEEL, settings), new Item.Properties());
    ...
    public static final Item ROUND_SHIELD = registerBannerShield("round_shield",
            (settings) -> new CustomBannerShieldItem(ShieldTypesME.MEDIUM_SHIELD, settings), new Item.Properties());
    ...
    public static final Item GONDORIAN_SWORD = registerItemWithModel("gondorian_sword",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)), true);
    public static final Item GONDORIAN_LONGSWORD = registerItemWithModel("gondorian_longsword",
            (settings) -> new CustomLongswordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)), true);
    public static final Item GONDORIAN_DAGGER = registerItemWithModel("gondorian_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)), false);
    ...
    public static final Item GONDORIAN_BOW = registerBowItem("gondorian_bow",
            (settings) -> new CustomBowWeaponItem(RangedWeaponTypesME.BOW, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    public static final Item GONDORIAN_LONGBOW = registerBigBowItem("gondorian_longbow",
            (settings) -> new CustomLongbowWeaponItem(RangedWeaponTypesME.LONGBOW, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    ...
    public static final Item GONDORIAN_NOBLE_LONGBOW = registerBigBowItem("gondorian_noble_longbow",
            (settings) -> new CustomLongbowWeaponItem(RangedWeaponTypesME.NOBLE_LONGBOW, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    ...
    public static final Item GONDORIAN_SHIELD = registerShield("gondorian_shield",
            (settings) -> new CustomShieldItem(ShieldTypesME.MEDIUM_SHIELD,  settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    ...
    public static final Item GONDORIAN_KNIGHT_SHIELD = registerShield("gondorian_knight_shield",
            (settings) -> new CustomShieldItem(ShieldTypesME.HEAVY_SHIELD,  settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GONDOR)));
    ...
    public static final Item ROHIRRIC_SWORD = registerItemWithModel("rohirric_sword",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)), true);
    ...
    public static final Item ROHIRRIC_DAGGER = registerItemWithModel("rohirric_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)), false);
    ...
    public static final Item ROHIRRIC_NOBLE_BOW = registerBigBowItem("rohirric_noble_bow",
            (settings) -> new CustomBowWeaponItem(RangedWeaponTypesME.NOBLE_BOW, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ROHAN)));
    ...
    public static final Item DALISH_SWORD = registerItemWithModel("dalish_sword",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.DALE)), true);
    ...
    public static final Item DALISH_DAGGER = registerItemWithModel("dalish_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.DALE)), false);
    ...
    public static final Item LORIEN_SWORD = registerItemWithModel("lorien_sword",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.EDHEL_STEEL,  settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)), true);
    public static final Item LORIEN_GLAIVE = registerItemWithModel("lorien_glaive",
            (settings) -> new CustomLongswordWeaponItem(ToolMaterialsME.EDHEL_STEEL,  settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)), true);
    public static final Item LORIEN_DAGGER = registerItemWithModel("lorien_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.EDHEL_STEEL,  settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)), false);
    public static final Item LORIEN_AXE = registerItemWithModel("lorien_axe",
            (settings) -> new CustomAxeWeaponItem(ToolMaterialsME.EDHEL_STEEL,  settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LOTHLORIEN)), true);
    ...
    public static final Item WOODLAND_REALM_BUCKLER_SHIELD = registerShield("woodland_realm_buckler_shield",
            (settings) -> new CustomShieldItem(ShieldTypesME.LIGHT_SHIELD, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.WOODLAND_REALM)));
    ...
    public static final Item EREBOR_SWORD = registerItemWithModel("erebor_sword",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.KHAZAD_STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)), true);
    public static final Item EREBOR_LONGSWORD = registerItemWithModel("erebor_longsword",
            (settings) -> new CustomLongswordWeaponItem(ToolMaterialsME.KHAZAD_STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)), true);
    public static final Item EREBOR_DAGGER = registerItemWithModel("erebor_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.KHAZAD_STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)), false);
    public static final Item EREBOR_AXE = registerItemWithModel("erebor_axe",
            (settings) -> new CustomAxeWeaponItem(ToolMaterialsME.KHAZAD_STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)), true);
    ...
    public static final Item EREBOR_CROSSBOW = registerCrossbowItem("erebor_crossbow",
            (settings) -> new CustomCrossbowWeaponItem(RangedWeaponTypesME.CROSSBOW, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    ...
    public static final Item EREBOR_NOBLE_CROSSBOW = registerCrossbowItem("erebor_noble_crossbow",
            (settings) -> new CustomCrossbowWeaponItem(RangedWeaponTypesME.NOBLE_CROSSBOW, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.LONGBEARDS_EREBOR)));
    ...
    public static final Item ORC_BROADBLADE = registerItemWithModel("orc_broadblade",
            (settings) -> new CustomLongswordWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties(), true);
    public static final Item ORC_KNIFE = registerItemWithModel("orc_knife",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties(), false);
    public static final Item ORC_AXE = registerItemWithModel("orc_axe",
            (settings) -> new CustomAxeWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties(), true);
    ...
    public static final Item MORDOR_FALCHION = registerItemWithModel("mordor_falchion",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties()
    ...
    public static final Item MORDOR_SCIMITAR = registerItemWithModel("mordor_scimitar",
            (settings) -> new CustomLongswordWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)), true);
    public static final Item MORDOR_DAGGER = registerItemWithModel("mordor_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.MORDOR)), false);
    ...
    public static final Item ISENGARD_ORC_CLEAVER = registerItemWithModel("isengard_orc_cleaver",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ISENGARD)), true);
    ...
    public static final Item ISENGARD_ORC_DAGGER = registerItemWithModel("isengard_orc_dagger",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ISENGARD)), false);
    ...
    public static final Item URUK_HAI_SIEGE_SHIELD = registerShield("uruk_hai_siege_shield",
            (settings) -> new CustomSiegeShieldItem(ShieldTypesME.HEAVY_SHIELD, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.ISENGARD)));
    //endregion
    ...
    public static final Item GUNDABAD_FALCHION = registerItemWithModel("gundabad_falchion",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.HOBGOBLIN_TRIBES)), true);
    ...
    public static final Item GUNDABAD_SHANK = registerItemWithModel("gundabad_shank",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.BURZUM_STEEL, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.HOBGOBLIN_TRIBES)), false);
    ...
    public static final Item GOBLIN_TOWN_FALCHION = registerItemWithModel("goblin_town_falchion",
            (settings) -> new CustomSwordWeaponItem(ToolMaterialsME.CRUDE, settings), new Item.Properties()
    ...
    public static final Item GOBLIN_TOWN_SCIMITAR = registerItemWithModel("goblin_town_scimitar",
            (settings) -> new CustomLongswordWeaponItem(ToolMaterialsME.CRUDE, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GOBLIN_TOWN)), true);
    public static final Item GOBLIN_TOWN_SHANK = registerItemWithModel("goblin_town_shank",
            (settings) -> new CustomDaggerWeaponItem(ToolMaterialsME.CRUDE, settings), new Item.Properties()
    ...
    public static final Item GOBLIN_TOWN_AXE = registerItemWithModel("goblin_town_axe",
            (settings) -> new CustomAxeWeaponItem(ToolMaterialsME.CRUDE, settings), new Item.Properties()
                    .component(DataComponentTypesME.FACTION_DATA, new FactionDataComponent(FactionRegistry.GOBLIN_TOWN)), true);
    ...
    public static final Item DAGAMARTH = registerArtefact("dagamarth",
            (settings) -> new ArtefactCustomSwordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("dagamarth")), true);
    public static final Item HERUGRIM = registerArtefact("herugrim",
            (settings) -> new ArtefactCustomSwordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("herugrim")), true);
    public static final Item NAZGUL_SWORD = registerArtefact("nazgul_sword",
            (settings) -> new ArtefactCustomSwordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("nazgul_sword")), true);

    public static final Item HAMMER_OF_HELM_HAMMERHAND = registerArtefact("hammer_of_helm_hammerhand",
            (settings) -> new ArtefactCustomAxeWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("hammer_of_helm_hammerhand")), true);
    public static final Item MACE_OF_SAURON = registerArtefact("mace_of_sauron",
            (settings) -> new ArtefactCustomAxeWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("mace_of_sauron")), true);

    public static final Item ANGUIREL = registerArtefact("anguirel",
            (settings) -> new ArtefactCustomLongswordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("anguirel")), true);
    public static final Item GLAMDRING = registerArtefact("glamdring",
            (settings) ->  new ArtefactCustomGlowingLongswordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("glamdring")), true);
    public static final Item LONG_FORGOTTEN_LONGSWORD = registerArtefact("long_forgotten_longsword",
            (settings) ->  new ArtefactCustomLongswordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("long_forgotten_longsword")), true);
    public static final Item LONGSWORD_OF_ELDER_KINGS = registerArtefact("longsword_of_elder_kings",
            (settings) -> new ArtefactCustomLongswordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("longsword_of_elder_kings")), true);
    public static final Item NARSIL = registerArtefact("narsil",
            (settings) -> new ArtefactCustomLongswordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("narsil")), true);
    public static final Item NOLDORIN_LONGSWORD = registerArtefact("noldorin_longsword",
            (settings) ->  new ArtefactCustomLongswordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("noldorin_longsword")), true);
    public static final Item ORCRIST = registerArtefact("orcrist",
            (settings) -> new ArtefactCustomGlowingLongswordWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("orcrist")), true);

    public static final Item BARROW_BLADE = registerArtefact("barrow_blade",
            (settings) -> new ArtefactCustomDaggerWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("barrow_blade")), false);
    public static final Item MORGUL_KNIFE = registerArtefact("morgul_knife",
            (settings) -> new MorgulKnifeItem(ToolMaterialsME.MORGUL_KNIFE, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("morgul_knife")), false);
    public static final Item STING = registerArtefact("sting",
            (settings) -> new ArtefactCustomGlowingDaggerWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("sting")), false);

    public static final Item AEGLOS = registerItemWithSpearModel("aeglos",
            (settings) -> new ArtefactCustomSpearWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("aeglos")));

    public static final Item GUARDIAN_OF_THE_GREENWOOD_STAFF = registerItemWithModel("guardian_of_the_greenwood_staff",
            (settings) -> new ArtefactCustomSpearWeaponItem(ToolMaterialsME.STEEL, settings), new Item.Properties().rarity(Rarity.EPIC), true);
    ...
    public static final Item ANORTHANN = registerShield("anorthann",
            (settings) -> new ArtefactCustomShieldItem(ShieldTypesME.HEAVY_SHIELD, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("anorthann")));
    public static final Item CUTHANN = registerShield("cuthann",
            (settings) -> new ArtefactCustomShieldItem(ShieldTypesME.HEAVY_SHIELD, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("cuthann")));
    public static final Item SHIELD_OF_DURINS_GUARD = registerShield("shield_of_durins_guard",
            (settings) -> new ArtefactCustomShieldItem(ShieldTypesME.HEAVY_SHIELD, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("shield_of_durins_guard")));
    public static final Item SHIELD_OF_THE_KING_UNDER_THE_MOUNTAIN = registerShield("shield_of_the_king_under_the_mountain",
            (settings) -> new ArtefactCustomShieldItem(ShieldTypesME.HEAVY_SHIELD, settings), new Item.Properties().rarity(Rarity.EPIC)
                    .component(DataComponents.LORE, ArtefactUtils.getArtefactLore("shield_of_the_king_under_the_mountain")));
    //endregion

    public static final Item HELD_BANNER = registerItemNoModel("held_banner",
            HeldBannerItem::new);

    private static Item registerItemWithModel(String name, Function<Item.Properties, Item> factory, Item.Properties settings, boolean isDualModel) {
    ...
    private static Item registerItemNoModel(String name, Function<Item.Properties, Item> factory) {
        Item item = factory.apply(new Item.Properties());
        ItemGroupsME.WEAPONS_CONTENTS.add(item.getDefaultInstance());
        return registerItem(item, name);
    }

    private static Item registerItemWithSpearModel(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.WEAPONS_CONTENTS.add(item.getDefaultInstance());
        spears.add(item);
    ...
    private static Item registerBowItem(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.WEAPONS_CONTENTS.add(item.getDefaultInstance());
    ...
    private static Item registerBigBowItem(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.WEAPONS_CONTENTS.add(item.getDefaultInstance());
    ...
    private static Item registerArtefact(String name, Function<Item.Properties, Item> factory, Item.Properties settings, boolean isDualModel) {
        Item item = factory.apply(settings);
        ItemGroupsME.WEAPONS_CONTENTS.add(item.getDefaultInstance());
    ...
    private static Item registerBannerShield(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.WEAPONS_CONTENTS.add(item.getDefaultInstance());
        return registerItem(item, name);
    }

    private static Item registerShield(String name, Function<Item.Properties, Item> factory, Item.Properties settings) {
        Item item = factory.apply(settings);
        ItemGroupsME.WEAPONS_CONTENTS.add(item.getDefaultInstance());
        shields.add(item);
        return registerItem(item, name);
