...
public class ModStatusEffects {
    ...
    public static final RegistryEntry<StatusEffect> RESTRAINED = register("restrained", new RestrainedStatusEffect(StatusEffectCategory.HARMFUL, 0x006666)
            .addAttributeModifier(EntityAttributes.ATTACK_DAMAGE, Identifier.ofVanilla("effect.weakness"), -8.0, EntityAttributeModifier.Operation.ADD_VALUE));
