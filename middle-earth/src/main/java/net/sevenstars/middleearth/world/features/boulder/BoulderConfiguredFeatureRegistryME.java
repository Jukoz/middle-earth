...
public class BoulderConfiguredFeatureRegistryME {
    ...
    private static final List<BlockState> andesite = Arrays.asList(
            ...
            Blocks.ANDESITE.getDefaultState(),
            StoneBlockSetRegistryME.ANDESITE_SET.cobblestoneBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.ANDESITE_SET.mossyCobblestoneBlocks.base().getDefaultState());

    private static final List<BlockState> ashenStone = Arrays.asList(
            StoneBlockSetRegistryME.ASHENSTONE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.ASHENSTONE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.ASHENSTONE_SET.cobblestoneBlocks.base().getDefaultState(),
            BlockRegistryME.ASHEN_GRAVEL.getDefaultState(),
            BlockRegistryME.ASH_BLOCK.getDefaultState());
    ...
    private static final List<BlockState> blueTuff = Arrays.asList(
            StoneBlockSetRegistryME.BLUE_TUFF_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.BLUE_TUFF_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.BLUE_TUFF_SET.cobblestoneBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.BLUE_TUFF_SET.mossyCobblestoneBlocks.base().getDefaultState());

    private static final List<BlockState> calcite = Arrays.asList(
            Blocks.CALCITE.getDefaultState(),
            Blocks.CALCITE.getDefaultState(),
            StoneBlockSetRegistryME.CALCITE_SET.cobblestoneBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.CALCITE_SET.mossyCobblestoneBlocks.base().getDefaultState());

    private static final List<BlockState> diorite = Arrays.asList(
            Blocks.DIORITE.getDefaultState(),
            Blocks.DIORITE.getDefaultState(),
            StoneBlockSetRegistryME.DIORITE_SET.smoothBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.DIORITE_SET.mossySmoothBlocks.base().getDefaultState());

    private static final List<BlockState> dolomite = Arrays.asList(
            StoneBlockSetRegistryME.DOLOMITE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.DOLOMITE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.DOLOMITE_SET.cobblestoneBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.DOLOMITE_SET.mossyCobblestoneBlocks.base().getDefaultState());

    private static final List<BlockState> smoothDolomite = Arrays.asList(
            StoneBlockSetRegistryME.DOLOMITE_SET.smoothBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.DOLOMITE_SET.smoothBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.DOLOMITE_SET.crackedSmoothBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.DOLOMITE_SET.mossySmoothBlocks.base().getDefaultState());

    private static final List<BlockState> galonn = Arrays.asList(
            StoneBlockSetRegistryME.GALONN_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.GALONN_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.GALONN_SET.crackedSmoothBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.GALONN_SET.mossySmoothBlocks.base().getDefaultState());

    private static final List<BlockState> gneiss = Arrays.asList(
            StoneBlockSetRegistryME.GNEISS_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.GNEISS_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.GNEISS_SET.smoothBlocks.base().getDefaultState());

    private static final List<BlockState> granite = Arrays.asList(
            Blocks.GRANITE.getDefaultState(),
            Blocks.GRANITE.getDefaultState(),
            StoneBlockSetRegistryME.GRANITE_SET.cobblestoneBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.GRANITE_SET.mossyCobblestoneBlocks.base().getDefaultState());

    private static final List<BlockState> hematite = Arrays.asList(
            StoneBlockSetRegistryME.HEMATITE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.HEMATITE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.HEMATITE_SET.cobblestoneBlocks.base().getDefaultState());

    private static final List<BlockState> ironStone = Arrays.asList(
            StoneBlockSetRegistryME.IRONSTONE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.IRONSTONE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.IRONSTONE_SET.cobblestoneBlocks.base().getDefaultState());

    private static final List<BlockState> limeStone = Arrays.asList(
            StoneBlockSetRegistryME.LIMESTONE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.LIMESTONE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.LIMESTONE_SET.crackedSmoothBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.LIMESTONE_SET.mossySmoothBlocks.base().getDefaultState());
    ...
    private static final List<BlockState> slate = Arrays.asList(
            StoneBlockSetRegistryME.SLATE_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.SLATE_SET.cobblestoneBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.SLATE_SET.oldBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.SLATE_SET.mossySmoothBlocks.base().getDefaultState());

    private static final List<BlockState> gabbro = Arrays.asList(
            StoneBlockSetRegistryME.GABBRO_SET.baseBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.GABBRO_SET.mossyCobblestoneBlocks.base().getDefaultState(),
            StoneBlockSetRegistryME.GABBRO_SET.mossySmoothBlocks.base().getDefaultState());
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        ConfiguredFeatures.register(featureRegisterable, LIMESTONE_BOULDER, Feature.FOREST_ROCK,
                new SingleStateFeatureConfig(StoneBlockSetRegistryME.LIMESTONE_SET.baseBlocks.base().getDefaultState()));
        ...
        ConfiguredFeatures.register(featureRegisterable, MIRKWOOD_ROOTS_BOULDER, Feature.FOREST_ROCK,
                new SingleStateFeatureConfig(NatureBlockRegistryME.MIRKWOOD_ROOTS.getDefaultState()));
        ...
        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_ANDESITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, andesite));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_ANDESITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, andesite));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_ANDESITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, andesite));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_ASHEN_STONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, ashenStone));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_ASHEN_STONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, ashenStone));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_ASHEN_STONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, ashenStone));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_BASALT, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, basalt));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_BASALT, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, basalt));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_BASALT, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, basalt));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_BLUE_TUFF, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, blueTuff));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_BLUE_TUFF, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, blueTuff));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_BLUE_TUFF, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, blueTuff));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_CALCITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, calcite));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_CALCITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, calcite));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_CALCITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, calcite));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_DIORITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, diorite));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_DIORITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, diorite));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_DIORITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, diorite));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_DOLOMITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, dolomite));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_DOLOMITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, dolomite));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_DOLOMITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, dolomite));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_SMOOTH_DOLOMITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, smoothDolomite));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_SMOOTH_DOLOMITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, smoothDolomite));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_SMOOTH_DOLOMITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, smoothDolomite));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_GALONN, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, galonn));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_GALONN, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, galonn));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_GALONN, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, galonn));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_GNEISS, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, gneiss));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_GNEISS, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, gneiss));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_GNEISS, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, gneiss));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_GRANITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, granite));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_GRANITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, granite));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_GRANITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, granite));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_HEMATITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, hematite));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_HEMATITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, hematite));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_HEMATITE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, hematite));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_IRONSTONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, ironStone));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_IRONSTONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, ironStone));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_IRONSTONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, ironStone));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_LIMESTONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, limeStone));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_LIMESTONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, limeStone));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_LIMESTONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, limeStone));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_MOSSY_STONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, mossyStone));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_MOSSY_STONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, mossyStone));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_MOSSY_STONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, mossyStone));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_SANDSTONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, sandStone));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_SANDSTONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, sandStone));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_SANDSTONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, sandStone));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_STONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, stone));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_STONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, stone));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_STONE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(bigWidth, bigLength, bigHeight, bigRandomSize, bigRandomness, stone));
        
        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_SLATE, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, slate));

        ConfiguredFeatures.register(featureRegisterable, SMALL_BOULDER_GABBRO, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(smallWidth, smallLength, smallHeight, smallRandomSize, smallRandomness, gabbro));
        ConfiguredFeatures.register(featureRegisterable, MEDIUM_BOULDER_GABBRO, FeatureRegistryME.BIG_BOULDER,
                new BigBoulderFeatureConfig(mediumWidth, mediumLength, mediumHeight, mediumRandomSize, mediumRandomness, gabbro));
        ConfiguredFeatures.register(featureRegisterable, BIG_BOULDER_GABBRO, FeatureRegistryME.BIG_BOULDER,
