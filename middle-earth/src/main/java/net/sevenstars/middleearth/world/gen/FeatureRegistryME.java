...
import net.sevenstars.middleearth.world.features.deltas.DeltaFeature;
...
import net.sevenstars.middleearth.world.features.ores.OreFeature;
...
public class FeatureRegistryME {
    public static Feature<DeltaFeatureConfig> DELTA_FEATURE = register("delta_feature", new DeltaFeature(DeltaFeatureConfig.CODEC));

    public static Feature<net.minecraft.world.gen.feature.OreFeatureConfig> SURFACE_ORE = register("surface_ore", new SurfaceOreFeature(net.minecraft.world.gen.feature.OreFeatureConfig.CODEC));
    ...
    public static Feature<OreFeatureConfigME> ORE = register("ore", new OreFeature(OreFeatureConfigME.CODEC));
