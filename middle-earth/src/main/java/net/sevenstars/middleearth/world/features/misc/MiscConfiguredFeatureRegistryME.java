...
public class MiscConfiguredFeatureRegistryME {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        ConfiguredFeatures.register(featureRegisterable, SMALL_PUMICE_COLUMNS, FeatureRegistryME.COLUMNS,
                new ColumnsFeatureConfig(ConstantIntProvider.create(1), UniformIntProvider.create(1, 4), StoneBlockSetRegistryME.PUMICE_SET.baseBlocks.base().getDefaultState()));
        ConfiguredFeatures.register(featureRegisterable, LARGE_PUMICE_COLUMNS, FeatureRegistryME.COLUMNS,
                new ColumnsFeatureConfig(UniformIntProvider.create(2, 3), UniformIntProvider.create(4, 7), StoneBlockSetRegistryME.PUMICE_SET.baseBlocks.base().getDefaultState()));
    }
