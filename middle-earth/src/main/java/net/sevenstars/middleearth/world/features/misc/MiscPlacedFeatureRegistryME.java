...
public class MiscPlacedFeatureRegistryME {
    ...
    public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
        ...
        PlacedFeatures.register(featureRegisterable, LAVA_MAGMA_POOL, registryEntryLookup.getOrThrow(MiscConfiguredFeatureRegistryME.LAVA_MAGMA_POOL),
        ...
        PlacedFeatures.register(featureRegisterable, SMALL_PUMICE_COLUMNS, registryEntryLookup.getOrThrow(MiscConfiguredFeatureRegistryME.SMALL_PUMICE_COLUMNS),
                CountMultilayerPlacementModifier.of(2), BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, LARGE_PUMICE_COLUMNS, registryEntryLookup.getOrThrow(MiscConfiguredFeatureRegistryME.LARGE_PUMICE_COLUMNS),
                CountMultilayerPlacementModifier.of(1), BiomePlacementModifier.of());
    }
