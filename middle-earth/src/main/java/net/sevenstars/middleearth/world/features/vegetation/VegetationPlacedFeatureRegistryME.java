...
public class VegetationPlacedFeatureRegistryME {
    ...
    public static final RegistryKey<PlacedFeature> THORNY_GROWTH = registerKey("thorny_growth");
    ...
    public static final RegistryKey<PlacedFeature> PATCH_SCARCE_WHITE_LAVENDER = registerKey("patch_sparse_white_lavender");
    ...
    public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
        ...
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> waterDelta = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.WATER_DELTA);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerAllium = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_ALLIUM);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerAthelas = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_ATHELAS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerAzureBluet = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_AZURE_BLUET);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerBlueGentian = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_BLUE_GENTIAN);
        ...
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerCornflower = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_CORNFLOWER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerDorwinion = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_DORWINION);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerGreenJewel = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_GREEN_JEWEL);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerLilac = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_LILAC);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerLebennin = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_LEBENNIN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerLossarnach = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_LOSSARNACH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerMallos = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_MALLOS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerNobleWhite = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_NOBLEWHITE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerPoppy = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_POPPY);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerElanor = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_ELANOR);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerNiphredil = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_NIPHREDIL);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerSimbelmyne = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_SIMBELMYNE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowerRoseBush = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWER_ROSE_BUSH);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowersLightBlue = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWERS_LIGHT_BLUE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowersMagenta = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWERS_MAGENTA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowersOrange = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWERS_ORANGE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowersPink = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWERS_PINK);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowersPurple = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWERS_PURPLE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowersRed = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWERS_RED);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowersWhite = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWERS_WHITE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> flowersYellow = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FLOWERS_YELLOW);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> fieldHeather = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FIELD_HEATHER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> fieldDryHeather = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FIELD_DRY_HEATHER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> fieldLavender = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FIELD_LAVENDER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> fieldWildWeather = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FIELD_WILD_WHEAT);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> mirkwoodVines = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.MIRKWOOD_VINES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> willowVines = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.WILLOW_VINES);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> growthAzalea = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.AZALEA_GROWTH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> growthDry = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.DRY_GROWTH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> growthIvy = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.IVY_GROWTH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> growthFrozen = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FROZEN_GROWTH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> growthGreen = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_GREEN_GROWTH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> thornyGrowth = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_THORNY_GROWTH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> growthLilacFlower = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.LILAC_FLOWER_GROWTH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> growthRedFlower = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.RED_FLOWER_GROWTH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> growthYellowFlower = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.YELLOW_FLOWER_GROWTH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> growthPinkFlower = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PINK_FLOWER_GROWTH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> growthWhiteFlower = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.WHITE_FLOWER_GROWTH);
        ...
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> basalt = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_BASALT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> blackStone = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_BLACKSTONE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> beachGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_BEACH_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> bushes = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_BUSHES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> clovers = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_CLOVERS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pumice = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_PUMICE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pumiceColumn = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PUMICE_COLUMN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pumiceColumnLarge = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PUMICE_COLUMN_LARGE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> brownGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_BROWN_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> bracken = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_BRACKEN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> giantButterbur = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_GIANT_BUTTERBUR);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> fieldBlueFescue = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FIELD_BLUE_FESCUE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> cobweb = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_COBWEB);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> shortBulrush = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SHORT_BULRUSH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> tallBulrush = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_TALL_BULRUSH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> shortCattail = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SHORT_CATTAIL);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> tallCattail = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_TALL_CATTAIL);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> coastalPanicGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_COASTAL_PANIC_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> corruptedMoss = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_CORRUPTED_MOSS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> corruptedMossCarpet = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_CORRUPTED_MOSS_CARPET);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> deadRushes = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_DEAD_RUSHES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> dyingGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_DYING_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> dryGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_DRY_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> smallDryShrub = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SMALL_DRY_SHRUB);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> duckweed = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_DUCKWEED);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> falseOatgrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FALSE_OATGRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> fallenLeaves = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FALLEN_LEAVES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> fallenMallornLeaves = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FALLEN_MALLORN_LEAVES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> fallenMirkwoodLeaves = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FALLEN_MIRKWOOD_LEAVES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> floatingIce = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FLOATING_ICE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> forestMoss = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FOREST_MOSS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> forestMossCarpet = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FOREST_MOSS_CARPET);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> frozenGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FROZEN_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> frozenShrub = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FROZEN_SHRUB);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> frozenTuft = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FROZEN_SHRUB);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> greenShrub = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_GREEN_SHRUB);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> grass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatures.PATCH_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> grimGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_GRIM_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> heath = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_HEATH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> heather = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_HEATHER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> deadHeather = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_DEAD_HEATHER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> dryHeather = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_DRY_HEATHER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> redHeather = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_RED_HEATHER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> fieldDeadNormalHeather = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.FIELD_DEAD_NORMAL_HEATHER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> blueLavender = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_BLUE_LAVENDER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lavender = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_LAVENDER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> whiteLavender = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WHITE_LAVENDER);
        ...
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> largeLilyPad = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_LARGE_LILY_PAD);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> largeFloweringLilyPad = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_LARGE_FLOWERING_LILY_PAD);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lilyPads = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_LILY_PADS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> floweringLilyPads = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_FLOWERING_LILY_PADS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> smallLilyPads = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SMALL_LILY_PADS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> smallFloweringLilyPads = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SMALL_FLOWERING_LILY_PADS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> mirkwoodRoots = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_MIRKWOOD_ROOTS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> mirkwood = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_MIRKWOOD);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> mistweed = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_MISTWEED);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> moss = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_MOSS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> mossCarpet = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_MOSS_CARPET);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> hogweed = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_HOGWEED);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> hobbitSunflowers = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_HOBBIT_SUNFLOWERS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> blueBigleafHydrangea = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_BLUE_BIGLEAF_HYDRANGEA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pinkBigleafHydrangea = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_PINK_BIGLEAF_HYDRANGEA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> whiteBigleafHydrangea = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WHITE_BIGLEAF_HYDRANGEA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> campion = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_CAMPION);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> reeds = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_REEDS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> shortReeds = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SHORT_REEDS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> stickySnow = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_STICKY_SNOW);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> strawBerries = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_STRAWBERRY_BUSH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> scorchedGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SCORCHED_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> scorchedShrub = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SCORCHED_SHRUB);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> scorchedTuft = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SCORCHED_TUFT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> sedum = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SEDUM);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> sedumOrange = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SEDUM_ORANGE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> sedumRed = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SEDUM_RED);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> sedumYellow = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SEDUM_YELLOW);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> sedums = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SEDUMS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> shriveledShrubs = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SHRIVELED_SHRUB);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> largeShriveledShrubs = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_LARGE_SHRIVELED_SHRUB);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> rushes = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_RUSHES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> shortRushes = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SHORT_RUSHES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> spiderEggs = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SPIDER_EGGS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> tanShrub = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_TAN_SHRUB);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> yellowTrollius = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_YELLOW_TROLLIUS);
        ...
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> temperateGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_TEMPERATE_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> sweetBerries = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SWEET_BERRY_BUSH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> toughBerries = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_TOUGH_BERRY_BUSH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> tuftGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_TUFT_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> sparseGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_SPARSE_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wheatGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WHEAT_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> meadowGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_MEADOW_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> mixedWildWheat = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_MIXED_WILD_WHEAT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wilderGrass = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILDER_GRASS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> yellowFlower = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_YELLOW_FLOWER);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> nettles = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_NETTLES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> thistle = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_THISTLE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> mordorBrambles = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_MORDOR_BRAMBLES);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> bolete = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_BROWN_BOLETE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> boleteTiller = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_BROWN_BOLETE_TILLER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> morsel = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_MORSEL);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> morselTiller = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_MORSEL_TILLER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> whiteMushroom = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WHITE_MUSHROOM);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> whiteMushroomTiller = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WHITE_MUSHROOM_TILLER);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildBeetroot = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_BEETROOT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildBellPepper = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_BELL_PEPPER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildCarrot = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_CARROT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildCucumber = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_CUCUMBER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildFlax = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_FLAX);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildGarlic = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_GARLIC);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildLeek = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_LEEK);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildLettuce = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_LETTUCE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildOnion = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_ONION);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildPipeweed = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_PIPEWEED);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildPotato = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_POTATO);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> wildTomato = registryEntryLookup.getOrThrow(VegetationConfiguredFeatureRegistryME.PATCH_WILD_TOMATO);
        ...
        PlacedFeatures.register(featureRegisterable, THORNY_GROWTH, thornyGrowth, CountPlacementModifier.of(UniformIntProvider.create(16, 31)), SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
        ...
        PlacedFeatures.register(featureRegisterable, PATCH_SCARCE_WHITE_LAVENDER, whiteLavender, scarce, SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
        ...
        PlacedFeatures.register(featureRegisterable, PATCH_BLUE_BIGLEAF_HYDRANGEA, blueBigleafHydrangea, veryRare, SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, PATCH_PINK_BIGLEAF_HYDRANGEA, pinkBigleafHydrangea, veryRare, SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
        PlacedFeatures.register(featureRegisterable, PATCH_WHITE_BIGLEAF_HYDRANGEA, whiteBigleafHydrangea, veryRare, SquarePlacementModifier.of(), PlacedFeatures.WORLD_SURFACE_WG_HEIGHTMAP, BiomePlacementModifier.of());
