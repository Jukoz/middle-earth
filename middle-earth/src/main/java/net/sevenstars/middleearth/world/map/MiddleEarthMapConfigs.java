...
public class MiddleEarthMapConfigs {
    ...
    public static final String MAP_DATA_VERSION = "1.0.0-1.21.8-beta";
    /**
    ...
    public static final String MOD_DATA = "data/me/%s".formatted(MAP_DATA_VERSION);
    ...
    public static final String INITIAL_MAP_FOLDER =
            "assets/%s/textures/map_data/%s".formatted(MiddleEarth.MOD_ID, MAP_DATA_VERSION);
