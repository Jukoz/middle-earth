...
public class MiddleEarthMapConfigs {
    ...
    public static final String MOD_DATA = "data/me/%s".formatted(MiddleEarth.getModVersion());
    ...
    public static final String INITIAL_IMAGE = "assets/%s/textures/map.png".formatted(MiddleEarth.getModId());  // FIXME: might be a better way
    public static final String INITIAL_MAP_FOLDER = "assets/%s/textures/map_data/%s".formatted(MiddleEarth.getModId(), MiddleEarth.getModVersion());  // FIXME: might be a better way
