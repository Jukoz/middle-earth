...
public class CavesPlacedFeatureRegistryME {
    ...
    public static final RegistryKey<PlacedFeature> ORE_GABBRO = registerKey("ore_gabbro");
    ...
    public static final RegistryKey<PlacedFeature> ORE_GNEISS = registerKey("ore_gneiss");
    ...
    public static final RegistryKey<PlacedFeature> ORE_ZIGIL_ABAN = registerKey("ore_zigil_aban");
    ...
    public static final RegistryKey<PlacedFeature> ORE_SCHIST = registerKey("ore_schist");
    ...
    public static final RegistryKey<PlacedFeature> ORE_ADAMANT = registerKey("ore_adamant");
    ...
    public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
        ...
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> amethystGeode = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.AMETHYST_GEODE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> citrineGeode = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.CITRINE_GEODE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> glowstoneGeode = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.GLOWSTONE_GEODE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> redAgateGeode = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.RED_AGATE_GEODE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> quartzGeode = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.QUARTZ_GEODE);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreDolomite = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_DOLOMITE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreOldDolomite = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_OLD_DOLOMITE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreMagma = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_MAGMA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreObsidian = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_OBSIDIAN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreDirt = registryEntryLookup.getOrThrow(OreConfiguredFeatures.ORE_DIRT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreMud = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_MUD);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreAsh = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_ASH);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreAshenDirt = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_ASHEN_DIRT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreDryDirt = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_DRY_DIRT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreBlueIce = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_BLUE_ICE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> orePackedIce = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_PACKED_ICE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreGabbro = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_GABBRO);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreGalonn = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_GALONN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreOldGalonn = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_OLD_GALONN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreGneiss = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_GNEISS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreGreenTuff = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_GREEN_TUFF);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreGildedGreenTuff = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_GILDED_GREEN_TUFF);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreGoldGreenTuff = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_GOLD_GREEN_TUFF);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreGoldenGreenTuff = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_GOLDEN_GREEN_TUFF);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreIzherAban = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_IZHER_ABAN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreZigilAban = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_ZIGIL_ABAN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreOldIzherAban = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_OLD_IZHER_ABAN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreLimestone = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_LIMESTONE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreOldLimestone = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_OLD_LIMESTONE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreSand = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_SAND);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreSandstone = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_SANDSTONE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreSchist = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_SCHIST);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreSnow = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_SNOW);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreTerracotta = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_TERRACOTTA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreTuff = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_TUFF);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreBasalt = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_BASALT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> oreBlackstone = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_BLACKSTONE);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> dolomiteCluster = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.DOLOMITE_CLUSTER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> largeDolomite = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.LARGE_DOLOMITE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pointedDolomite = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.POINTED_DOLOMITE);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> galonnCluster = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.GALONN_CLUSTER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> largeGalonn = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.LARGE_GALONN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pointedGalonn = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.POINTED_GALONN);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> izherAbanCluster = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.IZHER_ABAN_CLUSTER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> largeIzherAban = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.LARGE_IZHER_ABAN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pointedIzherAban = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.POINTED_IZHER_ABAN);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> limestoneCluster = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.LIMESTONE_CLUSTER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> largeLimestone = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.LARGE_LIMESTONE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pointedLimestone = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.POINTED_LIMESTONE);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> poolMud = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.POOL_MUD);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> diskMycelium = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.DISK_MYCELIUM);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> delta = registryEntryLookup.getOrThrow(NetherConfiguredFeatures.DELTA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pillarBasalt = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PILLAR_BASALT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pillarBlackstone = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PILLAR_BLACKSTONE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pillarPackedIce = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PILLAR_PACKED_ICE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> pillarSmoothSandstone = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PILLAR_SMOOTH_SANDSTONE);

        RegistryEntry.Reference<ConfiguredFeature<?, ?>> coalOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_COAL);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> copperOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_COPPER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> tinOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_TIN);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> lapisOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_LAPIS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> leadOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_LEAD);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> quartziteOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_QUARTZITE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> ironOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_IRON);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> silverOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_SILVER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> jadeOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_JADE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> goldOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_GOLD);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> emeraldOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_EMERALD);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> rubyOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_RUBY);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> sapphireOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_SAPPHIRE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> adamantOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_ADAMANT);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> mithrilOre = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.ORE_MITHRIL);

        // region MUSHROOMS
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> brownBoletteTree = registryEntryLookup.getOrThrow(MushroomTreeConfiguredFeatureRegistryME.BROWN_BOLETTE_TREE_KEY);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> caveAmanita = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_CAVE_AMANITA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> caveAmanitaTiller = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_CAVE_AMANITA_TILLER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> caveAmanitaTree = registryEntryLookup.getOrThrow(MushroomTreeConfiguredFeatureRegistryME.CAVE_AMANITA_TREE_KEY);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> deepFirecap = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_DEEP_FIRECAP);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> deepFirecapTiller = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_DEEP_FIRECAP_TILLER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> deepFirecapTree = registryEntryLookup.getOrThrow(MushroomTreeConfiguredFeatureRegistryME.DEEP_FIRECAP_TREE_KEY);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> ghostshrooms = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_GHOSTSHROOM);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> ghostshroomsTiller = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_GHOSTSHROOM_TILLER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> skyFirecap = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_SKY_FIRECAP);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> skyFirecapTiller = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_SKY_FIRECAP_TILLER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> skyFirecapTree = registryEntryLookup.getOrThrow(MushroomTreeConfiguredFeatureRegistryME.SKY_FIRECAP_TREE_KEY);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> tubeshroom = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_TUBESHROOMS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> tallTubeshroom = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_TALL_TUBESHROOMS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> trumpetShroom = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_TRUMPET_SHROOM);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> tallTrumpetShroom = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_TALL_TRUMPET_SHROOM);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> violetCaps = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_VIOLET_CAPS);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> violetCapsTiller = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_VIOLET_CAPS_TILLER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> yellowAmanita = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_YELLOW_AMANITA);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> yellowAmanitaTiller = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.PATCH_YELLOW_AMANITA_TILLER);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> yellowAmanitaTree = registryEntryLookup.getOrThrow(MushroomTreeConfiguredFeatureRegistryME.YELLOW_AMANITA_TREE_KEY);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> glowwormWebbing = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.GLOWWORM_WEBBING);
        // endregion
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> droopingIcicles = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.DROOPING_ICICLES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> shortIcicles = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.SHORT_ICICLES);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> stickyIce = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.STICKY_ICE);
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> stickySnow = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.STICKY_SNOW);
        ...
        RegistryEntry.Reference<ConfiguredFeature<?, ?>> springLava = registryEntryLookup.getOrThrow(CavesConfiguredFeatureRegistryME.SPRING_LAVA);
        ...
        PlacedFeatures.register(featureRegisterable, ORE_GABBRO, oreGabbro, modifiersWithCount(23, HeightRangePlacementModifier.trapezoid(YOffset.fixed(MiddleEarthChunkGenerator.NURGON_LEVEL), YOffset.fixed(300))));
        ...
        PlacedFeatures.register(featureRegisterable, ORE_GNEISS, oreGneiss, modifiersWithCount(23, HeightRangePlacementModifier.trapezoid(YOffset.fixed(MiddleEarthChunkGenerator.NURGON_LEVEL), YOffset.fixed(300))));
        ...
        PlacedFeatures.register(featureRegisterable, ORE_ZIGIL_ABAN, oreZigilAban, modifiersWithCount(37, HeightRangePlacementModifier.trapezoid(YOffset.fixed(MiddleEarthChunkGenerator.NURGON_LEVEL), YOffset.fixed(300))));
        ...
        PlacedFeatures.register(featureRegisterable, ORE_SCHIST, oreSchist, modifiersWithCount(23, HeightRangePlacementModifier.trapezoid(YOffset.fixed(MiddleEarthChunkGenerator.NURGON_LEVEL), YOffset.fixed(300))));
