...
public class CharacterClothesRegistryME {
    ...
    public record Over(){
        ...
        public final static Identifier SILVER_TUNIC                                     = MiddleEarth.of("silver_tunic");
        public final static Identifier TAN_TUNIC                                        = MiddleEarth.of("tan_tunic");
    ...
    public record Extra(){
        ...
        public final static Identifier PURPLE_HOUPPELANDE                               = MiddleEarth.of("purple_houppelande");
        public final static Identifier RICH_HOUPPELANDE                                 = MiddleEarth.of("rich_houppelande");
