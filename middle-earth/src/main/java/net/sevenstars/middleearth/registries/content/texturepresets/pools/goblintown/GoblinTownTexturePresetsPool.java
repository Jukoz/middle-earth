package net.sevenstars.middleearth.registries.content.texturepresets.pools.goblintown;
...
public class GoblinTownTexturePresetsPool {
    ...
    public static List<TexturePresetsRegistry.RegisterableNpcTextureData> fetchAll() {
        return List.of(
                new TexturePresetsRegistry.RegisterableNpcTextureData(TexturePresetsRegistry.GOBLIN_TOWN_GOBLIN, WEAK),
                new TexturePresetsRegistry.RegisterableNpcTextureData(TexturePresetsRegistry.GOBLIN_TOWN_WARRIOR, WARRIOR),
                new TexturePresetsRegistry.RegisterableNpcTextureData(TexturePresetsRegistry.GOBLIN_TOWN_BRUTE, BRUTE)
        );
    }
    ...
    static {
        BASE_PRESET = new WeightedTexturePresetHolder()
            ...
            .withPatterns(CharacterPatternTypes.HEAD, List.of(
                    WeightedIdentifier.fromKey(CharacterPatternsRegistryME.Skins.Head.GOBLIN),
