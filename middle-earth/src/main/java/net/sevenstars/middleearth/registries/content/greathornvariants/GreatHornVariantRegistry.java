...
public class GreatHornVariantRegistry {
    ...
    public static final RegistryKey<GreatHornVariant> BROWN = DynamicRegistriesME.of(GREAT_HORN_VARIANTS_KEY, IdentifierUtil.build("brown"));
    public static final RegistryKey<GreatHornVariant> TEMPERATE = DynamicRegistriesME.of(GREAT_HORN_VARIANTS_KEY, IdentifierUtil.build("temperate"));
    public static final RegistryKey<GreatHornVariant> WARM = DynamicRegistriesME.of(GREAT_HORN_VARIANTS_KEY, IdentifierUtil.build("warm"));
    public static final RegistryKey<GreatHornVariant> COLD = DynamicRegistriesME.of(GREAT_HORN_VARIANTS_KEY, IdentifierUtil.build("cold"));
    ...
    public static void bootstrap(Registerable<GreatHornVariant> context) {
        ...
        register(context, registryEntryLookup, WARM, new GreatHornVariant(
                ...
                GreatHornVariantRegistryHelper.createSpawnConditions(context, TagKey.of(RegistryKeys.BIOME, IdentifierUtil.build("spawns_warm_variant_great_horn")), 0)));

        register(context, registryEntryLookup, COLD, new GreatHornVariant(
                GreatHornVariantRegistryHelper.createAssetInfos("cold"),
                GreatHornVariantRegistryHelper.createSpawnConditions(context, TagKey.of(RegistryKeys.BIOME, IdentifierUtil.build("spawns_cold_variant_great_horn")), 1)));
    }
