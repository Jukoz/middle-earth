...
public class GreatHornVariantRegistry {
    ...
    public static final RegistryKey<GreatHornVariant> BROWN = DynamicRegistriesME.of(GREAT_HORN_VARIANTS_KEY, MiddleEarth.id("brown"));
    public static final RegistryKey<GreatHornVariant> TEMPERATE = DynamicRegistriesME.of(GREAT_HORN_VARIANTS_KEY, MiddleEarth.id("temperate"));
    public static final RegistryKey<GreatHornVariant> WARM = DynamicRegistriesME.of(GREAT_HORN_VARIANTS_KEY, MiddleEarth.id("warm"));
    public static final RegistryKey<GreatHornVariant> COLD = DynamicRegistriesME.of(GREAT_HORN_VARIANTS_KEY, MiddleEarth.id("cold"));
    ...
    public static void bootstrap(Registerable<GreatHornVariant> context) {
        ...
        register(context, registryEntryLookup, WARM, new GreatHornVariant(
                ...
                GreatHornVariantRegistryHelper.createSpawnConditions(context, TagKey.of(RegistryKeys.BIOME, MiddleEarth.id("spawns_warm_variant_great_horn")), 0)));

        register(context, registryEntryLookup, COLD, new GreatHornVariant(
                GreatHornVariantRegistryHelper.createAssetInfos("cold"),
                GreatHornVariantRegistryHelper.createSpawnConditions(context, TagKey.of(RegistryKeys.BIOME, MiddleEarth.id("spawns_cold_variant_great_horn")), 1)));
    }
