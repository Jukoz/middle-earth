...
public class ShireBiomeEventPool {
    ...
    static {
        DEFAULT = new BiomeEventData(false, List.of(
            new WildSpawnEventData(ShireNpcDataPool.PEASANT).withWeight(12),
            new WildSpawnEventData(ShireNpcDataPool.MILITIA).withWeight(3),
            new WildSpawnEventData(ShireNpcDataPool.SHIRRIFF)
        ));
    }
}
