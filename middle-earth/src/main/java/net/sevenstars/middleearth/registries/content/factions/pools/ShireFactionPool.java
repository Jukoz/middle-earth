    ...
    static {
        SHIRE = new Faction(FactionRegistry.SHIRE, true, DispositionType.GOOD, FactionType.FACTION, null,null,
                ...
                new SpawnDataHandler(List.of(
                        new SpawnData(MiddleEarth.idAggregate(FactionRegistry.SHIRE.getValue().getPath(), "hobbiton"), new Vector2d(933, 900)),
                        new SpawnData(MiddleEarth.idAggregate(FactionRegistry.SHIRE.getValue().getPath(), "willowbottom"), new Vector2d(981, 970))
                )), List.of(), List.of(),
                List.of(
