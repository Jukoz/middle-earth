...
public class MordorNpcDataPool {
    ...
    static {
        ...
        MORDOR_BLACK_NUMENOREAN = new NpcData(Identifier.of(MiddleEarth.MOD_ID, FACTION_BASE.formatted("black_numenorean")), RaceRegistry.HUMAN, FACTION, NpcTextureDatasME.GENERIC_HUMAN, List.of(
                NpcGearData.create()
