        ...
        MILITIA = new NpcData(NpcRegistry.MORDOR_MILITIA.getValue(), RaceRegistry.ORC, FACTION, TexturePresetsRegistry.MORDOR_ORC, List.of(
                GearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                ...
                                .add(WeightedItemData.create(EquipmentItemsME.RUSTED_MORDOR_HELMET).withWeight(2).withHood(HelmetAttachmentsME.HOOD, allColors))
                                .add(WeightedItemData.create(EquipmentItemsME.RUSTED_MORDOR_NASAL_HELMET).withWeight(2).withHood(HelmetAttachmentsME.HOOD, allColors))
                                ...
                                .add(WeightedItemData.create(EquipmentItemsME.ORCISH_HELMET).withHood(HelmetAttachmentsME.HOOD, allColors))
        ...
        SCOUT = new NpcData(NpcRegistry.MORDOR_SCOUT.getValue(), RaceRegistry.ORC, FACTION, TexturePresetsRegistry.MORDOR_ORC, List.of(
                GearData.create()
                        ...
                        .add(EquipmentSlot.MAINHAND, GearSlotPool.create()
                                ...
                                .add(WeightedItemData.create(Items.BOW).withWeight(15))
                        )
                        .add(EquipmentSlot.OFFHAND, GearSlotPool.create()
                                .add(WeightedItemData.create(Items.AIR))
                        )
        ...
        WARRIOR = new NpcData(NpcRegistry.MORDOR_WARRIOR.getValue(), RaceRegistry.URUK, FACTION, TexturePresetsRegistry.MORDOR_BLACK_URUK, List.of(
                GearData.create()
                        .add(EquipmentSlot.HEAD, GearSlotPool.create()
                                ...
                                .add(WeightedItemData.create(EquipmentItemsME.MORDOR_HELMET).withWeight(2).withHood(HelmetAttachmentsME.HOOD, allColors))
                                .add(WeightedItemData.create(EquipmentItemsME.MORDOR_NASAL_HELMET).withWeight(3))
                                .add(WeightedItemData.create(EquipmentItemsME.MORDOR_NASAL_HELMET).withWeight(2).withHood(HelmetAttachmentsME.HOOD, allColors))
                                ...
                                .add(WeightedItemData.create(EquipmentItemsME.MORDOR_SALLET).withHood(HelmetAttachmentsME.HOOD, allColors))
