...
public class FurSurcoatModel extends ChestplateAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        right_arm.addChild("right_arm_shoulder_cape", ModelPartBuilder.create().
                uv(24, 16).cuboid(-3.5F, -2.5F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.8F)), ModelTransform.origin(-0.0F, -0.0F, 0.0F));
        ...
        left_arm.addChild("left_arm_shoulder_cape", ModelPartBuilder.create()
                .uv(40, 16).mirrored().cuboid(-0.5F, -2.5F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.8F)).mirrored(false), ModelTransform.origin(0.0F, -0.0F, 0.0F));
