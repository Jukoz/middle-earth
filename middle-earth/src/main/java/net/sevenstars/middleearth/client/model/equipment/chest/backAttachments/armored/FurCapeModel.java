...
public class FurCapeModel extends CloakCapeModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        body.addChild("fur", ModelPartBuilder.create().uv(76, 68).cuboid(-9.49F, -2.0F, -3.75F, 19.0F, 5.0F, 7.0F, new Dilation(0.6F))
                .uv(24, 66).cuboid(-9.5F, -2.0F, -3.75F, 19.0F, 7.0F, 7.0F, new Dilation(0.3F)),
                ModelTransform.origin(0.0F, 0.0f, 0.0f));
        ...
        ModelPartData cape = body.addChild("cape", ModelPartBuilder.create()
                ...
                .uv(0, 94).mirrored().cuboid(-9F, 0.2F, -3F, 18.0F, 13.0F, 6.0F, new Dilation(0.39F)).mirrored(false),
        ...
        cape.addChild("cape_low", ModelPartBuilder.create()
                ...
                .uv(0, 113).mirrored().cuboid(-9F, 0.2F, -3F, 18.0F, 9.0F, 6.0F, new Dilation(0.39F)).mirrored(false),
        ...
        right_arm.addChild("right_arm_shoulder_cape", ModelPartBuilder.create().
                uv(24, 16).cuboid(-3.5F, -2.5F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.8F)),
                ModelTransform.origin(-0.0F, -0.0F, 0.0F));
        ...
        left_arm.addChild("left_arm_shoulder_cape", ModelPartBuilder.create()
                .uv(40, 16).mirrored().cuboid(-0.5F, -2.5F, -2.0F, 4.0F, 12.0F, 4.0F, new Dilation(0.8F)).mirrored(false),
                ModelTransform.origin(0.0F, -0.0F, 0.0F));
