...
public class CapeMediumModel extends CloakCapeModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition cape = body.addOrReplaceChild("cape", CubeListBuilder.create()
                ...
                .texOffs(53, 94).mirror().addBox(-6.5F, -1.0F, -1F, 13.0F, 13.0F, 5.0F, new CubeDeformation(0.19F)).mirror(false),
        ...
        cape.addOrReplaceChild("cape_low", CubeListBuilder.create()
                ...
                .texOffs(53, 112).mirror().addBox(-6.5F, -0.8F, -1F, 13.0F, 10.0F, 5.0F, new CubeDeformation(0.19F)).mirror(false),
