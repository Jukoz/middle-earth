...
public class NazgulRobesModel extends CloakCapeModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        body.addChild("fur", ModelPartBuilder.create().uv(24, 66).cuboid(-9.5F, -2.0F, -3.75F, 19.0F, 7.0F, 7.0F, new Dilation(0.3F)),
                ModelTransform.origin(0.0F, 0.0f, 0.0f));
        ...
        ModelPartData cape = body.addChild("cape", ModelPartBuilder.create()
                ...
                .uv(0, 94).mirrored().cuboid(-9F, 0.0F, -3F, 18.0F, 13.0F, 6.0F, new Dilation(0.39F)).mirrored(false),
