...
public class MordorBNHelmetModel extends HelmetAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData addons = head.addChild("addons", ModelPartBuilder.create().
                        uv(0, 0).cuboid(-3.5F, -11.75F, -3.5F, 7.0F, 2.0F, 7.0F, new Dilation(0.0F))
                        .uv(0, 10).cuboid(-1.5F, -13.25F, -0.5F, 3.0F, 2.0F, 3.0F, new Dilation(0.0F))
                        .uv(40, 3).cuboid(0.0F, -17.10F, -6.1F, 0.0F, 17.0F, 12.0F, new Dilation(0.0F))
                        .uv(46, 63).cuboid(-4.5F, -3.55F, -4.475F, 9.0F, 1.0F, 0.0F, new Dilation(0.0F))
                        .uv(0, 15).cuboid(-4.0F, -9.25F, -4.0F, 8.0F, 9.0F, 8.0F, new Dilation(0.5F)),
                ModelTransform.origin(0.0F, 0.0F, 0.0F));

        addons.addChild("side_left", ModelPartBuilder.create()
                        .uv(40, 0).mirrored().cuboid(-0.5F, -9.75F, 0.284F, 6.0F, 15.0F, 0.0F, new Dilation(0.0F)).mirrored(false),
                ModelTransform.of(4.814F, -7.0F, -1.5F, 0.0F, -0.6545F, 0.0F));

        addons.addChild("side_right", ModelPartBuilder.create()
                        .uv(52, 0).cuboid(-5.25F, -9.75F, 0.252F, 6.0F, 15.0F, 0.0F, new Dilation(0.0F)),
