...
public class OrthancCommanderHelmetModel extends HelmetAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        head.addChild("addons", ModelPartBuilder.create().uv(0, 0).cuboid(-3.5F, -12.0F, -3.5F, 7.0F, 2.0F, 7.0F, new Dilation(0.0F))
                ...
                .uv(-9, 30).cuboid(-7.5F, -3.1F, -1.0F, 15.0F, 0.0F, 9.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 1.1F, 0.0F));
