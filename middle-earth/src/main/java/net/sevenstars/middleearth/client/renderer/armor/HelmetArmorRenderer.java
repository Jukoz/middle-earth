        ...
        if (slot == EquipmentSlot.HEAD) {
            ...
            if (this.helmetAddonModel != null) {
                ...
                if(texture.contains("_helmet.png")){
                    CustomArmorRenderer.renderArmor(matrices, vertexConsumers, light, stack, this.helmetAddonModel, MiddleEarth.id(texture.replaceAll("_helmet.png", "_addition.png")), dyeable);
                } else if(texture.contains("glass") || texture.contains("monocle")){
                    CustomArmorRenderer.renderTranslucentPiece(matrices, vertexConsumers, light, stack, this.helmetAddonModel, MiddleEarth.id(texture.replaceAll(".png", "_addition.png")));
                } else {
