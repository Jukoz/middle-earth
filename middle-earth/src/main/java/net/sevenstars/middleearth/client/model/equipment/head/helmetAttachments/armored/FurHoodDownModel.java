...
public class FurHoodDownModel extends CloakHoodModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition hood = hat.addOrReplaceChild("helmetAttachment", CubeListBuilder.create().texOffs(0, 73).addBox(-4.0F, -9.0F, -4.376F, 8.0F, 5.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offset(0.0F, -0.0F, 0.0F));
