...
public class FurHoodDownModel extends CloakHoodModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData hood = hat.addChild("helmetAttachment", ModelPartBuilder.create().uv(0, 73).cuboid(-4.0F, -9.0F, -4.376F, 8.0F, 5.0F, 2.0F, new Dilation(0.1F)), ModelTransform.origin(0.0F, -0.0F, 0.0F));
        ...
        hoodDown.addChild("left", ModelPartBuilder.create().uv(100, 20).cuboid(3.6F, -11.2857F, -5.3F, 1.0F, 8.0F, 2.0F, new Dilation(0.5F))
                .uv(94, 20).cuboid(3.6F, -11.2857F, -5.3F, 1.0F, 8.0F, 2.0F, new Dilation(0.6F)), ModelTransform.origin(0.25F, 0.0F, 0.0F));
        hoodDown.addChild("right", ModelPartBuilder.create().uv(100, 20).mirrored().cuboid(-4.35F, -11.2857F, -5.3F, 1.0F, 8.0F, 2.0F, new Dilation(0.5F)).mirrored(false)
                .uv(106, 20).cuboid(-4.35F, -11.2857F, -5.3F, 1.0F, 8.0F, 2.0F, new Dilation(0.6F)), ModelTransform.origin(-0.25F, 0.0F, 0.0F));
