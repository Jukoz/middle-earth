...
public class HammerhandHelmModel extends HelmetAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData addons = head.addChild("addons", ModelPartBuilder.create().uv(30, 17).cuboid(0.0F, -13.5F, -9.5F, 0.0F, 11.0F, 17.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -1.0F, 0.0F));

        ModelPartData hornRight = addons.addChild("horns_right", ModelPartBuilder.create().uv(0, 0).cuboid(0.1F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(-6.5F, -4.0F, 0.0F));
        ...
        ModelPartData hornLeft = addons.addChild("horns_left", ModelPartBuilder.create().uv(0, 0).cuboid(11.1F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(-6.5F, -4.0F, 0.0F));
