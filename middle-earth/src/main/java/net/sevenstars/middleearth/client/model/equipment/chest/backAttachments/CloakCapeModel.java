...
public class CloakCapeModel  extends ChestplateAddonModel {
    ...
    public void setAngles(BipedEntityRenderState bipedEntityRenderState) {
        ...
        /*this.backAttachment.traverse().forEach(ModelPart::resetTransform);
        ...
        if (bipedEntityRenderState.isInSneakingPose) {
            this.backAttachment.pivotZ = 0.0f;
            this.backAttachment.pivotY = 0.0f;
            degree = 5f + (speed * (MAX_ANGLE_CLOAK / 2));
        } else {
            this.backAttachment.pivotZ = 0;
            this.backAttachment.pivotY = 0.0f;
        ...
        if(result > 0) {
            this.backAttachment.pitch = ToRad.ex(degree);
        }*/
    }
}
