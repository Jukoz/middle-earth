...
public class DwarvenMinerHelmetModel extends HelmetAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = modelPartData.addChild(EntityModelPartNames.HEAD, ModelPartBuilder.create(), ModelTransform.origin(0.0F, 1.0F, 0.0F));
        head.addChild(EntityModelPartNames.HAT, ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));

        ModelPartData head_addon_gr = head.addChild("head_addon_gr", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.8F, 0.0F));

        head_addon_gr.addChild("addon_flaps", ModelPartBuilder.create().uv(0, 20).cuboid(-4.0F, 0.8F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.9F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
        ModelPartData addon_candles = head_addon_gr.addChild("addon_candles", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 0.0F, 0.0F));
        ...
        ModelPartData addon_right_candle = addon_candles.addChild("addon_right_candle", ModelPartBuilder.create().uv(0, 0).cuboid(-1.0F, -2.0F, 1.0F, 2.0F, 2.0F, 4.0F, new Dilation(0.0F))
                ...
                .uv(0, 22).cuboid(-1.0F, -6.0F, -3.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F)), ModelTransform.origin(-5.5F, -4.5F, -4.5F));
        ...
        ModelPartData addon_left_candle = addon_candles.addChild("addon_left_candle", ModelPartBuilder.create().uv(0, 0).mirrored().cuboid(-1.0F, -2.0F, 1.0F, 2.0F, 2.0F, 4.0F, new Dilation(0.0F)).mirrored(false)
                ...
                .uv(0, 22).mirrored().cuboid(-1.0F, -6.0F, -3.0F, 2.0F, 4.0F, 2.0F, new Dilation(0.0F)).mirrored(false), ModelTransform.origin(5.5F, -4.5F, -4.5F));
