...
public class DaleHelmetModel extends HelmetAddonModel {
    ...
    public static MeshDefinition getModelData() {
        ...
        head.addOrReplaceChild("Addon", CubeListBuilder.create()
                .texOffs(0, 37).addBox(-5.0F, -5.375F, -6.0F, 10.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 29).addBox(0.0F, -13.375F, -6.0F, 0.0F, 11.0F, 12.0F, new CubeDeformation(0.0F)),
