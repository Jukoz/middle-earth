...
public class DGRaiderHelmetModel extends HelmetAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        addons.addChild("lower_extension", ModelPartBuilder.create()
                        .uv(0, 23).cuboid(-4.0F, 0.90F, -4.0F, 8.0F, 8.0F, 8.0F, new Dilation(0.55F)),
                ModelTransform.origin(0.0F, 0.0F, 0.0F));

        addons.addChild("kettle", ModelPartBuilder.create()
                .uv(0, 39).cuboid(-7.0F, -8.15F, -7.0F, 14.0F, 1.0F, 14.0F, new Dilation(0.0F)),
                ModelTransform.origin(0.0F, 2.766F, 0.0F));
