...
public class BlackCastellanChestplateModel extends ChestplateAddonModel {
    ...
    public static MeshDefinition getModelData() {
        ...
        body.addOrReplaceChild("chest_extension", CubeListBuilder.create()
                .texOffs(42, 39).addBox(-4.5F, -1.125F, -2.3F, 9.0F, 12.0F, 0.0F, new CubeDeformation(0.51F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        right_arm.addOrReplaceChild("right_halt", CubeListBuilder.create()
                .texOffs(0, 32).addBox(-1.0F, -6.25F, -3.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        left_arm.addOrReplaceChild("left_halt", CubeListBuilder.create()
                .texOffs(0, 39).addBox(11.0F, -6.5F, -3.5F, 0.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
