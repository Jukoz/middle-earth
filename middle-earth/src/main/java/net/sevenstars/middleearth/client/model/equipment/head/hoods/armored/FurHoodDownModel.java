...
public class FurHoodDownModel extends CloakHoodModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData hood = hat.addChild("hood", ModelPartBuilder.create().uv(0, 73).cuboid(-4.0F, -9.0F, -4.376F, 8.0F, 5.0F, 2.0F, new Dilation(0.1F)), ModelTransform.origin(0.0F, -0.0F, 0.0F));
