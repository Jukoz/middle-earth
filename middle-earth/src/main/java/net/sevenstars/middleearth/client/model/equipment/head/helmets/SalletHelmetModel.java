...
public class SalletHelmetModel extends HelmetAddonModel {

    public SalletHelmetModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("sallet", CubeListBuilder.create()
                .texOffs(0, 0).addBox(-4.0F, -2.95F, 4.654F, 8.0F, 1.0F, 2.0F, new CubeDeformation(0.22F)),
