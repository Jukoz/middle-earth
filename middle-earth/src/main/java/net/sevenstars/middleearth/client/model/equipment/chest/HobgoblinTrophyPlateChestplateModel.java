...
public class HobgoblinTrophyPlateChestplateModel extends ChestplateAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData spears = body.addChild("spears", ModelPartBuilder.create(), ModelTransform.origin(0.0F, 4.0F, -0.5F));
        ...
        rightspear.addChild("skull_right_0", ModelPartBuilder.create().uv(40, 0).cuboid(-3.0F, -41.0F, -3.0F, 6.0F, 7.0F, 6.0F, new Dilation(0.0F))
                .uv(40, 13).cuboid(-3.0F, -41.0F, -3.0F, 6.0F, 10.0F, 6.0F, new Dilation(0.2F)), ModelTransform.origin(0.0F, 10.0F, -0.2F));
        ...
        ModelPartData spears2 = rightspear.addChild("right_spear_1", ModelPartBuilder.create(), ModelTransform.origin(-2.5F, -0.5F, -3.7F));
        ...
        leftspear.addChild("rib_left", ModelPartBuilder.create().uv(39, 51).cuboid(-4.0F, -5.4F, -2.0F, 8.0F, 9.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -18.5F, -0.2F));
        ...
        ModelPartData spears6 = leftspear.addChild("left_spear_1", ModelPartBuilder.create(), ModelTransform.origin(-2.5F, -0.5F, -3.7F));
        ...
        centrespear.addChild("skull_center", ModelPartBuilder.create().uv(40, 0).cuboid(-3.0F, -41.0F, -3.0F, 6.0F, 7.0F, 6.0F, new Dilation(0.0F))
                .uv(40, 13).cuboid(-3.0F, -41.0F, -3.0F, 6.0F, 10.0F, 6.0F, new Dilation(0.2F)), ModelTransform.origin(0.0F, 10.0F, -0.2F));
        centrespear.addChild("rib_center", ModelPartBuilder.create().uv(36, 38).cuboid(-5.0F, -5.4F, -1.0F, 10.0F, 9.0F, 4.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, -18.5F, -0.2F));
