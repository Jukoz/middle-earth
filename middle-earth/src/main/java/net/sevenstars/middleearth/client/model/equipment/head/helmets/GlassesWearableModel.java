...
public class GlassesWearableModel extends HelmetAddonModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("googles", CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-3.0F, -5.125F, -5.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.3F))
                        .texOffs(0, 0).addBox(1.0F, -5.0F, -5.0F, 2.0F, 2.0F, 1.0F,
