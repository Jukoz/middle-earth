...
public class HobgoblinScreecherHelmetModel extends HelmetAddonModel {

    public HobgoblinScreecherHelmetModel(ModelPart root) {
        super(root);
    }
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("screecher", CubeListBuilder.create()
                .texOffs(20, 12).mirror().addBox(-11.0F, -20.75F, 0.0F, 22.0F, 18.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
