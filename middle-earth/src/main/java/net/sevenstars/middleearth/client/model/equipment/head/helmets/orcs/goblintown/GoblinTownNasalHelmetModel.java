...
public class GoblinTownNasalHelmetModel extends FlapHelmetModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("nasal", CubeListBuilder.create()
                .texOffs(9, 9).addBox(-0.5F, -10.25F, -5.5F, 1.0F, 12.0F, 7.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        head.addOrReplaceChild("eye_cover", CubeListBuilder.create()
                .texOffs(11, 60).addBox(-4.5F, -4.55F, -4.5F, 9.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));
