...
public class MordorBNChestplateModel extends ChestplateAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        body.addChild("chest_addon", ModelPartBuilder.create().uv(0, 41).cuboid(-4.5F, -1.0F, -2.3F, 9.0F, 12.0F, 4.0F, new Dilation(0.51F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
