...
public class HatArmorAddonModel extends HelmetAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        head.addChild("hat", ModelPartBuilder.create().uv(-6, 0).cuboid(-8.0F, -4.2F, -8.0F, 16.0F, 0.0F, 16.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
