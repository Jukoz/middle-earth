...
public class KettleHelmetModel extends HelmetAddonModel {

    public KettleHelmetModel(ModelPart root) {
        super(root);
    }
    ...
    public static ModelData getModelData() {
        ...
        head.addChild("kettle", ModelPartBuilder.create()
                .uv(0, 0).cuboid(-7.0F, -5.384F, -7.0F, 14.0F, 1.0F, 14.0F, new Dilation(0.0F)),
