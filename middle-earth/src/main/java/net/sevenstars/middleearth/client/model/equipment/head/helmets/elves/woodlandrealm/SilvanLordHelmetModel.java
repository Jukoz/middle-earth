...
public class SilvanLordHelmetModel extends HelmetAddonModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        PartDefinition crest_left = crest.addOrReplaceChild("crest_left", CubeListBuilder.create().texOffs(46, 51)
                .addBox(-3.0F, -6.0F + Y_OFFSET, 0.0F, 9.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(2.654F, -15.0819F, -2.0603F, -0.4363F, -0.6109F, 0.2094F));

        PartDefinition crest_right = crest.addOrReplaceChild("crest_right", CubeListBuilder.create().texOffs(46, 51)
                .mirror().addBox(-5.0F, -6.0F + Y_OFFSET, 0.0F, 9.0F, 12.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false),
                PartPose.offsetAndRotation(-3.404F, -14.8899F, -1.4963F, -0.4363F, 0.6109F, -0.2094F));

        PartDefinition fin = addon.addOrReplaceChild("fin", CubeListBuilder.create(), PartPose.offset(0.0F, -0.5F, 1.08F));

        PartDefinition fin_1 = fin.addOrReplaceChild("fin_1", CubeListBuilder.create().texOffs(0, 0)
                .addBox(-11.0F, -2.0F + Y_OFFSET, -3.75F, 21.0F, 0.0F, 11.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.5F, -7.25F, -0.968F, 0.6021F, 0.0F, 0.0F));
