...
public class FurHoodModel extends CloakHoodModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData hood = hat.addChild("helmetAttachment", ModelPartBuilder.create(), ModelTransform.of(-0.14F, 2.65F, -0.0F, -0.0F, 0.0F, 0.0F));

        hood.addChild("top", ModelPartBuilder.create()
                .uv(112, 29).cuboid(-2.872F, -11.2857F, -5.3F, 6.0F, 1.0F, 2.0F, new Dilation(0.6F))
                .uv(112, 26).cuboid(-2.856F, -11.2857F, -5.3F, 6.0F, 1.0F, 2.0F, new Dilation(0.7F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));

        hood.addChild("bottom", ModelPartBuilder.create()
                .uv(112, 20).cuboid(-2.75F, -2.2857F, -5.3F, 6.0F, 1.0F, 2.0F, new Dilation(0.6F))
                .uv(112, 23).cuboid(-2.718F, -2.2857F, -5.3F, 6.0F, 1.0F, 2.0F, new Dilation(0.7F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));

        hood.addChild("left", ModelPartBuilder.create()
                .uv(100, 20).cuboid(3.6F, -11.2857F, -5.3F, 1.0F, 10.0F, 2.0F, new Dilation(0.6F))
                .uv(94, 20).cuboid(3.6F, -11.2857F, -5.3F, 1.0F, 10.0F, 2.0F, new Dilation(0.69F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
        ...
        hood.addChild("right", ModelPartBuilder.create()
                ...
                .uv(106, 20).cuboid(-4.35F, -11.2857F, -5.3F, 1.0F, 10.0F, 2.0F, new Dilation(0.69F)), ModelTransform.origin(-0.0F, 0.0F, 0.0F));
