...
public class EreborHornsHelmetModel extends HelmetAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData addon_swirl_horns = head.addChild("addon_swirl_horns", ModelPartBuilder.create(), ModelTransform.origin(-11.0F, -7.2F, -3.4645F));
        ...
        ModelPartData right_horns = horns.addChild("right_horns", ModelPartBuilder.create(), ModelTransform.origin(13.0F, -3.8284F, -0.4142F));
        ...
        ModelPartData left_horns = horns.addChild("left_horns", ModelPartBuilder.create(), ModelTransform.origin(11.0F, -3.8284F, -0.4142F));
