...
public class GoblinChestplateModel extends ChestplateAddonModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        right_arm.addOrReplaceChild("right_addon", CubeListBuilder.create()
                .texOffs(1, 0).addBox(-7.0F, -6.0F, 0.0F, 7.0F, 17.0F, 0.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        PartDefinition left_arm = modelPartData.addOrReplaceChild(PartNames.LEFT_ARM, CubeListBuilder.create(),
                PartPose.offset(0.0F, 0.0F, 0.0F));

        left_arm.addOrReplaceChild("left_addon", CubeListBuilder.create().
                texOffs(18, 0).addBox(0.0F, -6.0F, 0.0F, 7.0F, 17.0F, 0.0F, new CubeDeformation(0.0F)),
                PartPose.offset(0.0F, 0.0F, 0.0F));
