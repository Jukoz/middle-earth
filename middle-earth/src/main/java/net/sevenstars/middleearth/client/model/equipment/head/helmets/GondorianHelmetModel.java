...
public class GondorianHelmetModel extends HelmetAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData addons = head.addChild("addons", ModelPartBuilder.create().uv(0, 0).cuboid(-3.5F, -11.0F, -3.5F, 7.0F, 2.0F, 7.0F, new Dilation(0.0F))
                ...
                .uv(50, 16).cuboid(-9.0F, -19.8F, 0.0F, 7.0F, 16.0F, 0.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
