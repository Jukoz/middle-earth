...
public class WingedHelmetModel extends HelmetAddonModel {
    ...
    protected static ModelData getModelData() {
        ...
        ModelPartData addon = head.addChild("addon", ModelPartBuilder.create()
                .uv(0, 0).cuboid(-1.0F, -10.65F, -1.0F, 2.0F, 2.0F, 2.0F, new Dilation(0.0F)),
                ModelTransform.origin(0.0F, 0.0F, 0.0F));

        addon.addChild("wing_right", ModelPartBuilder.create()
                .uv(0, 0).mirrored().cuboid(0.0F, -9.25F, -1.0F, 0.0F, 12.0F, 8.0F, new Dilation(0.0F)).mirrored(false),
                ModelTransform.of(-5.0F, -6.0F, 0.0F, 0.0117F, -0.3229F, 0.0047F));

        addon.addChild("wing_left", ModelPartBuilder.create()
                .uv(0, 0).cuboid(0.0F, -9.25F, -1.0F, 0.0F, 12.0F, 8.0F, new Dilation(0.0F)),
                ModelTransform.of(5.0F, -6.0F, 0.0F, 0.0117F, 0.3229F, -0.0047F));
