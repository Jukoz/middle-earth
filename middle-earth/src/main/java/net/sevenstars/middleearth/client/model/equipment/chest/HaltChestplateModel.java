...
public class HaltChestplateModel extends ChestplateAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        right_arm.addChild("right_pauldron", ModelPartBuilder.create().uv(0, 38).cuboid(-3.0F, -2.0F, -1.92F, 4.0F, 12.0F, 4.0F, new Dilation(1.3F)), ModelTransform.origin(-0.58F, -1.0F, 0.0F));
        right_arm.addChild("right_halt", ModelPartBuilder.create().uv(0, 50).cuboid(-1.0F, -6.25F, -3.5F, 0.0F, 7.0F, 7.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
        ...
        left_arm.addChild("left_pauldron", ModelPartBuilder.create().uv(16, 38).mirrored().cuboid(-1.0F, -2.0F, -1.92F, 4.0F, 12.0F, 4.0F, new Dilation(1.3F)).mirrored(false), ModelTransform.origin(0.5F, -1.0F, 0.0F));
        left_arm.addChild("left_halt", ModelPartBuilder.create().uv(17, 50).cuboid(11.0F, -6.25F, -3.5F, 0.0F, 7.0F, 7.0F, new Dilation(0.0F)), ModelTransform.origin(-10.0F, 0.0F, 0.0F));
