...
public class MordorOrcHelmetModel extends HelmetAddonModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        head.addChild("pikes", ModelPartBuilder.create().uv(34, -2).cuboid(0.0F, -14.6F, -8.5F, 0.0F, 12.0F, 15.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
        head.addChild("forward_extension", ModelPartBuilder.create().uv(40, 0).cuboid(-4.0F, -8.2F, -7.8F, 8.0F, 9.0F, 4.0F, new Dilation(0.5F)), ModelTransform.origin(0.0F, 0.0F, 0.0F));
        head.addChild("down_hat_extension", ModelPartBuilder.create().uv(46, 35).cuboid(-4.0F, -8.4F, -4.0F, 8.0F, 8.0F, 1.0F, new Dilation(0.9F)), ModelTransform.origin(0.0F, 10.0F, 0.0F));
