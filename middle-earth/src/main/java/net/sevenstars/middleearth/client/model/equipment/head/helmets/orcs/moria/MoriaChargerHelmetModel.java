...
public class MoriaChargerHelmetModel extends HelmetAddonModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        head.addOrReplaceChild("grate", CubeListBuilder.create()
                .texOffs(22, 40).addBox(-3.0F, -10.25F, -3.0F, 6.0F, 11.0F, 6.0F, new CubeDeformation(0.0F)),
                PartPose.offsetAndRotation(0.0F, 0.0F, -4.0F, 0.0F, 0.7854F, 0.0F));
