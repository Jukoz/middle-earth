...
public class WallCrudeLanternBlock extends DwarvenLanternBlock {
    private static final EnumProperty<Direction> FACING;
    private static final VoxelShape WALL_SHAPE;

    public WallCrudeLanternBlock(Settings settings) {
        super(settings);
    ...
    public VoxelShape getOutlineShape(BlockState state, BlockView world, BlockPos pos, ShapeContext context) {
        switch (state.get(FACING)){
            case SOUTH -> {
                return Block.createCuboidShape(4, 0, 8, 12, 14, 16);
            }
            case EAST -> {
                return Block.createCuboidShape(8, 0, 4, 16, 14, 12);
            }
            case WEST -> {
                return Block.createCuboidShape(0, 0, 4, 8, 14, 12);
            }
            default -> {
                return Block.createCuboidShape(4, 0, 0, 12, 14, 8);
            }
        }
    }
