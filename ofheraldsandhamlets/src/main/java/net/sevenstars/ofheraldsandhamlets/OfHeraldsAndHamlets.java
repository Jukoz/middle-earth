package net.sevenstars.ofheraldsandhamlets;
...
import net.sevenstars.ofheraldsandhamlets.registries.RegistriesHH;

public class OfHeraldsAndHamlets implements ModInitializer {
	public static final String MOD_ID = "heraldhamlets";
