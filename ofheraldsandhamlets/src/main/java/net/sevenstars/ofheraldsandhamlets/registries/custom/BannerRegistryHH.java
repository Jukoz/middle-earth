...
import net.sevenstars.ofheraldsandhamlets.content.banners.BannerDefault;
...
public class BannerRegistryHH extends DynamicRegistriesAPI<Banner> {
    ...
    public static final RegistryKey<Banner> NONE = of(BANNER_KEY, OfHeraldsAndHamlets.id("none"));
