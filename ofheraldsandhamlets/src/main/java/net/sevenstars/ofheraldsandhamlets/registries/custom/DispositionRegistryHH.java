...
import net.sevenstars.ofheraldsandhamlets.content.dispositions.DispositionDefault;
...
public class DispositionRegistryHH extends DynamicRegistriesAPI<Disposition> {
    ...
    public static final RegistryKey<Disposition> NONE = of(DISPOSITION_KEY, OfHeraldsAndHamlets.id("none"));
