...
import net.sevenstars.ofheraldsandhamlets.content.spawns.SpawnDefault;
...
public class SpawnRegistryHH extends DynamicRegistriesAPI<Spawn> {
    ...
    public static final RegistryKey<Spawn> TEST = of(SPAWN_KEY, OfHeraldsAndHamlets.id("test"));
